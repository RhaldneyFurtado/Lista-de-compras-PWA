 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const K1=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],Q1=Or("user",K1);function Y1({estabelecimento:i,aoDefinirEstabelecimento:e,aoLimpar:t,usuario:s,aoLogout:o}){return U.jsx("header",{className:"bg-emerald-600 text-white shadow-lg",children:U.jsxs("div",{className:"mx-auto max-w-4xl px-4 py-4",children:[U.jsxs("div",{className:"mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",children:[U.jsxs("div",{className:"flex items-center gap-3",children:[U.jsx("div",{className:"rounded-lg bg-white p-2",children:U.jsx(sE,{className:"text-emerald-600",size:28})}),U.jsxs("div",{children:[U.jsx("h1",{className:"text-2xl font-bold",children:"Lista de Compras"}),U.jsx("p",{className:"text-sm text-emerald-100",children:"Organize suas compras"})]})]}),U.jsxs("div",{className:"flex items-center gap-3 sm:ml-auto",children:[U.jsx("div",{className:"flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-white bg-emerald-700",children:s!=null&&s.photoURL?U.jsx("img",{src:s.photoURL,alt:"Usuário",className:"h-full w-full object-cover",referrerPolicy:"no-referrer"}):U.jsx(Q1,{size:20})}),U.jsx("button",{onClick:o,className:"rounded-lg bg-emerald-700 p-2 hover:bg-emerald-800",title:"Sair",children:U.jsx($1,{size:20})}),U.jsx("button",{onClick:t,className:"rounded-lg bg-emerald-700 p-2 hover:bg-emerald-800",title:"Limpar lista",children:U.jsx(Ic,{size:20})})]})]}),U.jsx("input",{type:"text",value:i,onChange:u=>e(u.target.value),placeholder:"Nome do mercado...",className:"w-full rounded-lg bg-emerald-700 px-3 py-2 text-white placeholder-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-300"})]})})}function J1({modo:i,aoAlternar:e}){return U.jsx("div",{className:"bg-white rounded-xl shadow-md p-2 mb-4",children:U.jsxs("div",{className:"flex gap-2",children:[U.jsxs("button",{onClick:()=>e("planejamento"),className:`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${i==="planejamento"?"bg-emerald-500 text-white shadow-md":"bg-gray-100 text-gray-600 hover:bg-gray-200"}`,children:[U.jsx(z1,{size:20})," ",U.jsx("span",{children:"Planejamento"})," "]}),U.jsxs("button",{onClick:()=>e("feira"),className:`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${i==="feira"?"bg-emerald-500 text-white shadow-md":"bg-gray-100 text-gray-600 hover:bg-gray-200"}`,children:[U.jsx(sE,{size:20})," ",U.jsx("span",{children:"Na Feira"})," "]})]})})}function X1({aoAdicionar:i}){const[e,t]=rt.useState(""),[s,o]=rt.useState(1);function u(h){h.preventDefault(),e.trim()&&(i({nome:e,quantidade:s}),t(""),o(1))}return U.jsxs("form",{onSubmit:u,className:"flex gap-2 mb-4",children:[U.jsx("input",{value:e,onChange:h=>t(h.target.value),placeholder:"Produto",className:"flex-1 border p-2 rounded"}),U.jsx("input",{type:"number",value:s,onChange:h=>o(h.target.value),className:"w-20 border p-2 rounded"}),U.jsx("button",{className:"bg-green-500 text-white px-4 rounded",children:"+"})]})}function Z1({item:i,onAtualizar:e,onRemover:t,onToggleComprado:s}){const[o,u]=rt.useState(i.quantidade||1),[h,m]=rt.useState("");rt.useEffect(()=>{i.quantidade!==void 0&&u(i.quantidade),i.precoUnitario!==void 0&&i.precoUnitario!==null&&m(String(Math.round(i.precoUnitario*100)))},[i.quantidade,i.precoUnitario]);const y=Q=>(Number(Q||0)/100).toLocaleString("pt-BR",{minimumFractionDigits:2}),_=Q=>{const G=Q.target.value.replace(/\D/g,"");m(G)},w=()=>{const Q=Number(h||0);e(i.id,{precoUnitario:Q/100})},A=Q=>{const G=Number(Q.target.value);u(G),e(i.id,{quantidade:G||1})},V=Number(h||0)/100,K=(o*V).toLocaleString("pt-BR",{minimumFractionDigits:2});return U.jsx("div",{className:"rounded-lg border p-4 shadow-sm transition-all",children:U.jsxs("div",{className:"flex flex-wrap items-center gap-3 md:flex-nowrap",children:[U.jsx("input",{type:"checkbox",checked:i.comprado,onChange:()=>s(i.id),className:"h-5 w-5 accent-emerald-500"}),U.jsx("span",{className:"flex-1 font-medium",children:i.nome}),U.jsxs("div",{className:"flex items-center gap-2",children:[U.jsx("input",{type:"number",min:"1",value:o,onChange:A,className:"w-16 rounded border px-2 py-1 text-center"}),U.jsx("span",{children:"×"}),U.jsx("span",{children:"R$"}),U.jsx("input",{type:"text",inputMode:"numeric",value:h?y(h):"",onChange:_,onBlur:w,className:"w-24 rounded border px-2 py-1 text-right",placeholder:"0,00"})]}),U.jsxs("div",{className:"min-w-[110px] text-right",children:[U.jsx("span",{className:"block text-xs text-gray-500",children:"Total"}),U.jsxs("span",{className:"font-bold",children:["R$ ",K]})]}),U.jsx("button",{onClick:()=>t(i.id),className:"text-red-500",children:U.jsx(Ic,{size:18})})]})})}function eC({itens:i,modo:e,aoRemover:t,aoAtualizar:s,aoAlternarComprado:o}){return i.length?U.jsx("div",{className:"space-y-4",children:i.map(u=>U.jsx("div",{children:e==="feira"?U.jsx(Z1,{item:u,onAtualizar:s,onRemover:t,onToggleComprado:o}):U.jsx("div",{className:"rounded-lg border border-gray-200 bg-white p-4 shadow-sm",children:U.jsxs("div",{className:"flex items-center justify-between gap-3",children:[U.jsxs("div",{className:"flex flex-1 items-center gap-3",children:[U.jsxs("div",{className:"flex items-center gap-3",children:[U.jsx("input",{type:"checkbox",checked:u.comprado,onChange:()=>o(u.id),className:"h-5 w-5 accent-emerald-500"}),U.jsx("p",{className:`font-medium ${u.comprado?"text-gray-400 line-through":"text-gray-800"}`,children:u.nome})]}),U.jsxs("div",{className:"ml-6 flex items-center gap-2",children:[U.jsx("label",{className:"text-sm text-gray-500",children:"Quantidade:"}),U.jsx("input",{type:"number",min:"1",value:u.quantidade,onChange:h=>s(u.id,{quantidade:Number(h.target.value)||1}),className:"w-20 rounded border border-gray-300 px-2 py-1 text-center focus:border-emerald-500 focus:outline-none"})]})]}),U.jsx("button",{onClick:()=>t(u.id),className:"rounded-lg p-2 text-red-500 transition-colors hover:bg-red-50 hover:text-red-700",title:"Remover item",children:U.jsx(Ic,{size:18})})]})})},u.id))}):U.jsx("div",{className:"rounded-lg bg-white p-6 text-center shadow",children:U.jsx("p",{className:"text-gray-500",children:"Nenhum item adicionado ainda."})})}function tC(i){return Number(i||0).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function nC({totais:i,modo:e}){const{total:t=0,quantidadeItens:s=0,itensComprados:o=0}=i||{},u=s>0?o/s*100:0;return U.jsxs("div",{className:"bg-white rounded-xl shadow-md p-4 mt-4",children:[U.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-5 gap-4",children:[U.jsxs("div",{className:"bg-emerald-50 rounded-lg p-3 col-span-2 md:col-span-1",children:[U.jsxs("div",{className:"flex items-center gap-2 text-emerald-600 mb-1",children:[U.jsx(U1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Total"})]}),U.jsx("p",{className:"text-2xl font-bold text-emerald-700",children:tC(t)}),U.jsx("p",{className:"text-xs text-emerald-500 mt-1",children:"Valor total da compra"})]}),U.jsxs("div",{className:"bg-blue-50 rounded-lg p-3",children:[U.jsxs("div",{className:"flex items-center gap-2 text-blue-600 mb-1",children:[U.jsx(H1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Itens"})]}),U.jsx("p",{className:"text-2xl font-bold text-blue-700",children:s})]}),U.jsxs("div",{className:"bg-green-50 rounded-lg p-3",children:[U.jsxs("div",{className:"flex items-center gap-2 text-green-600 mb-1",children:[U.jsx(L1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Comprados"})]}),U.jsx("p",{className:"text-2xl font-bold text-green-700",children:o})]}),U.jsxs("div",{className:"bg-orange-50 rounded-lg p-3",children:[U.jsxs("div",{className:"flex items-center gap-2 text-orange-600 mb-1",children:[U.jsx(b1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Restantes"})]}),U.jsx("p",{className:"text-2xl font-bold text-orange-700",children:s-o})]})]}),s>0&&U.jsxs("div",{className:"mt-4",children:[U.jsxs("div",{className:"flex justify-between text-sm text-gray-600 mb-2",children:[U.jsx("span",{children:"Progresso"}),U.jsxs("span",{children:[Math.round(u),"%"]})]}),U.jsx("div",{className:"w-full bg-gray-200 rounded-full h-3",children:U.jsx("div",{className:"bg-emerald-500 h-3 rounded-full transition-all duration-500",style:{width:`${u}%`}})}),U.jsxs("p",{className:"text-xs text-gray-500 mt-2 text-center",children:[o," de ",s," itens"]})]})]})}function rC(){const{usuario:i,entrarComGoogle:e,sair:t}=rE();return i?U.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-500 to-green-700 p-4",children:U.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm text-center",children:[U.jsx("img",{src:i.photoURL,alt:"Usuário",className:"w-20 h-20 rounded-full mx-auto border-4 border-emerald-500"}),U.jsx("h2",{className:"mt-4 text-lg font-bold text-gray-800",children:i.displayName}),U.jsx("p",{className:"text-sm text-gray-500",children:"Bem-vindo de volta 👋"}),U.jsx("button",{onClick:t,className:"mt-6 w-full bg-red-500 hover:bg-red-600 text-white py-2 rounded-xl transition",children:"Sair"})]})}):U.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-500 to-green-700 p-4",children:U.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm text-center",children:[U.jsx("div",{className:"text-5xl mb-4",children:"🛒"}),U.jsx("h1",{className:"text-2xl font-bold text-gray-800",children:"Lista de Compras"}),U.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Organize suas compras com facilidade"}),U.jsxs("button",{onClick:e,className:"mt-6 w-full flex items-center justify-center gap-2 bg-white border hover:bg-gray-50 text-gray-700 font-medium py-2 rounded-xl shadow transition",children:[U.jsx("img",{src:"https://www.svgrepo.com/show/475656/google-color.svg",className:"w-5 h-5",alt:"Google"}),"Entrar com Google"]})]})})}function iC({historico:i,carregando:e,deletarCompra:t}){const[s,o]=rt.useState(null);return e?U.jsx("div",{className:"mt-6 text-center text-gray-600",children:"Carregando histórico..."}):i!=null&&i.length?U.jsx("div",{className:"mt-6 space-y-4",children:i.map(u=>{var m;const h=Number(u.total||0);return U.jsxs("div",{className:"rounded-xl bg-white p-4 shadow",children:[U.jsxs("div",{className:"flex items-start justify-between",children:[U.jsxs("div",{className:"flex-1 cursor-pointer",onClick:()=>o(s===u.id?null:u.id),children:[U.jsx("h3",{className:"font-bold",children:u.estabelecimento}),U.jsx("p",{className:"text-sm text-gray-500",children:new Date(u.data).toLocaleDateString("pt-BR")}),U.jsxs("p",{className:"font-bold text-green-600",children:["R$ ",h.toFixed(2)]}),U.jsx("p",{className:"mt-1 text-xs text-gray-400",children:"Clique para ver os detalhes"})]}),U.jsx("button",{onClick:()=>t(u.id),className:"text-red-500 hover:text-red-700",children:U.jsx(Ic,{size:18})})]}),s===u.id&&U.jsxs("div",{className:"mt-3 space-y-2 border-t pt-3",children:[U.jsxs("div",{className:"flex justify-between text-xs text-gray-500",children:[U.jsx("span",{children:"Item"}),U.jsx("span",{children:"Total"})]}),(m=u.itens)==null?void 0:m.map(y=>{const _=Number(y.quantidade||0)*Number(y.precoUnitario||0);return U.jsxs("div",{className:"flex justify-between text-sm",children:[U.jsxs("span",{children:[y.quantidade,"x ",y.nome]}),U.jsxs("span",{children:["R$ ",_.toFixed(2)]})]},y.id)}),U.jsxs("div",{className:"flex justify-between border-t pt-2 font-bold",children:[U.jsx("span",{children:"Total"}),U.jsxs("span",{children:["R$ ",h.toFixed(2)]})]})]})]},u.id)})}):U.jsx("div",{className:"mt-6 text-center text-gray-500",children:"Nenhuma compra encontrada"})}function sC(i){return i?i.trim().toLowerCase().replace(/(^|\s)\S/g,e=>e.toUpperCase()):""}function oC(){const{usuario:i,loading:e}=rE(),t=C1(i),s=t==null?void 0:t.lista,o=t==null?void 0:t.setLista,{historico:u,carregando:h,deletarCompra:m}=P1(i),[y,_]=rt.useState("compras");if(e)return U.jsx("div",{className:"flex min-h-screen items-center justify-center",children:U.jsx("p",{children:"Carregando..."})});if(!i)return U.jsx(rC,{});if(!s||!o)return U.jsx("div",{className:"flex min-h-screen items-center justify-center",children:U.jsx("p",{children:"Carregando lista..."})});const w=s.itens||[],A=async()=>{await e_(mo)},V=async()=>{if(!w.length)return;const z=w.reduce((Te,Ne)=>Te+(Ne.quantidade||0)*(Ne.precoUnitario||0),0),K=Date.now().toString(),Q={id:K,estabelecimento:s.estabelecimento,itens:w,total:z,data:new Date().toISOString()},{doc:G,setDoc:_e}=await Km(async()=>{const{doc:Te,setDoc:Ne}=await Promise.resolve().then(()=>T1);return{doc:Te,setDoc:Ne}},void 0),{db:ve}=await Km(async()=>{const{db:Te}=await Promise.resolve().then(()=>R1);return{db:Te}},void 0);await _e(G(ve,"users",i.uid,"compras",K),Q),await _e(G(ve,"users",i.uid,"lista","dados"),{modo:"planejamento",estabelecimento:"",itens:[]}),o({modo:"planejamento",estabelecimento:"",itens:[]}),_("historico")};return U.jsxs("div",{className:"min-h-screen bg-gray-50",children:[U.jsx(Y1,{usuario:i,estabelecimento:s.estabelecimento||"",aoDefinirEstabelecimento:z=>o(K=>({...K,estabelecimento:z})),aoLimpar:()=>o(z=>({...z,itens:[]})),aoLogout:A}),U.jsxs("main",{className:"mx-auto max-w-4xl space-y-6 px-4 py-6",children:[U.jsxs("div",{className:"flex gap-2",children:[U.jsx("button",{onClick:()=>_("compras"),className:`flex-1 p-3 rounded-lg font-semibold ${y==="compras"?"bg-emerald-600 text-white":"bg-white text-gray-700"}`,children:"Compras"}),U.jsx("button",{onClick:()=>_("historico"),className:`flex-1 p-3 rounded-lg font-semibold ${y==="historico"?"bg-emerald-600 text-white":"bg-white text-gray-700"}`,children:"Histórico"})]}),y==="compras"&&U.jsxs(U.Fragment,{children:[U.jsx(J1,{modo:s.modo,aoAlternar:z=>o(K=>({...K,modo:z}))}),U.jsx(X1,{aoAdicionar:z=>o(K=>({...K,itens:[...K.itens,{id:Date.now().toString(),nome:sC(z.nome),quantidade:z.quantidade,precoUnitario:0,comprado:!1}]}))}),U.jsx(eC,{itens:w,modo:s.modo,aoAtualizar:(z,K)=>o(Q=>({...Q,itens:Q.itens.map(G=>G.id===z?{...G,...K}:G)})),aoRemover:z=>o(K=>({...K,itens:K.itens.filter(Q=>Q.id!==z)})),aoAlternarComprado:z=>o(K=>({...K,itens:K.itens.map(Q=>Q.id===z?{...Q,comprado:!Q.comprado}:Q)}))}),U.jsx(nC,{totais:{total:w.reduce((z,K)=>z+(K.quantidade||0)*(K.precoUnitario||0),0),quantidadeItens:w.length,itensComprados:w.filter(z=>z.comprado).length}}),w.length>0&&U.jsx("button",{onClick:V,className:"w-full bg-emerald-600 text-white p-4 rounded-lg",children:"Finalizar Compra"})]}),y==="historico"&&U.jsx(iC,{historico:u,carregando:h,deletarCompra:m})]})]})}const oE=document.getElementById("root");if(!oE)throw new Error("Elemento #root não encontrado no index.html");const aC=Iw.createRoot(oE);aC.render(U.jsx(oC,{}));
//# sourceMappingURL=index-CpljT0AK.js.map
