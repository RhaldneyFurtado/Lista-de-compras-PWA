 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nm;function WE(){return Nm||(Nm=1,(function(i){function e(Z,le){var ne=Z.length;Z.push(le);e:for(;0<ne;){var D=ne-1>>>1,H=Z[D];if(0<o(H,le))Z[D]=le,Z[ne]=H,ne=D;else break e}}function t(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var le=Z[0],ne=Z.pop();if(ne!==le){Z[0]=ne;e:for(var D=0,H=Z.length,_e=H>>>1;D<_e;){var ve=2*(D+1)-1,Ie=Z[ve],Se=ve+1,Me=Z[Se];if(0>o(Ie,ne))Se<H&&0>o(Me,Ie)?(Z[D]=Me,Z[Se]=ne,D=Se):(Z[D]=Ie,Z[ve]=ne,D=ve);else if(Se<H&&0>o(Me,ne))Z[D]=Me,Z[Se]=ne,D=Se;else break e}}return le}function o(Z,le){var ne=Z.sortIndex-le.sortIndex;return ne!==0?ne:Z.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var y=[],v=[],w=1,R=null,M=3,z=!1,Y=!1,J=!1,K=typeof setTimeout=="function"?setTimeout:null,Ee=typeof clearTimeout=="function"?clearTimeout:null,we=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ke(Z){for(var le=t(v);le!==null;){if(le.callback===null)s(v);else if(le.startTime<=Z)s(v),le.sortIndex=le.expirationTime,e(y,le);else break;le=t(v)}}function Fe(Z){if(J=!1,ke(Z),!Y)if(t(y)!==null)Y=!0,Nt(je);else{var le=t(v);le!==null&&Je(Fe,le.startTime-Z)}}function je(Z,le){Y=!1,J&&(J=!1,Ee(I),I=-1),z=!0;var ne=M;try{for(ke(le),R=t(y);R!==null&&(!(R.expirationTime>le)||Z&&!k());){var D=R.callback;if(typeof D=="function"){R.callback=null,M=R.priorityLevel;var H=D(R.expirationTime<=le);le=i.unstable_now(),typeof H=="function"?R.callback=H:R===t(y)&&s(y),ke(le)}else s(y);R=t(y)}if(R!==null)var _e=!0;else{var ve=t(v);ve!==null&&Je(Fe,ve.startTime-le),_e=!1}return _e}finally{R=null,M=ne,z=!1}}var Ve=!1,P=null,I=-1,A=5,x=-1;function k(){return!(i.unstable_now()-x<A)}function V(){if(P!==null){var Z=i.unstable_now();x=Z;var le=!0;try{le=P(!0,Z)}finally{le?S():(Ve=!1,P=null)}}else Ve=!1}var S;if(typeof we=="function")S=function(){we(V)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,_t=$e.port2;$e.port1.onmessage=V,S=function(){_t.postMessage(null)}}else S=function(){K(V,0)};function Nt(Z){P=Z,Ve||(Ve=!0,S())}function Je(Z,le){I=K(function(){Z(i.unstable_now())},le)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(Z){Z.callback=null},i.unstable_continueExecution=function(){Y||z||(Y=!0,Nt(je))},i.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<Z?Math.floor(1e3/Z):5},i.unstable_getCurrentPriorityLevel=function(){return M},i.unstable_getFirstCallbackNode=function(){return t(y)},i.unstable_next=function(Z){switch(M){case 1:case 2:case 3:var le=3;break;default:le=M}var ne=M;M=le;try{return Z()}finally{M=ne}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(Z,le){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var ne=M;M=Z;try{return le()}finally{M=ne}},i.unstable_scheduleCallback=function(Z,le,ne){var D=i.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?D+ne:D):ne=D,Z){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=ne+H,Z={id:w++,callback:le,priorityLevel:Z,startTime:ne,expirationTime:H,sortIndex:-1},ne>D?(Z.sortIndex=ne,e(v,Z),t(y)===null&&Z===t(v)&&(J?(Ee(I),I=-1):J=!0,Je(Fe,ne-D))):(Z.sortIndex=H,e(y,Z),Y||z||(Y=!0,Nt(je))),Z},i.unstable_shouldYield=k,i.unstable_wrapCallback=function(Z){var le=M;return function(){var ne=M;M=le;try{return Z.apply(this,arguments)}finally{M=ne}}}})(Hh)),Hh}var xm;function GE(){return xm||(xm=1,$h.exports=WE()),$h.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr=new Pd("@firebase/app"),Gw="@firebase/app-compat",Kw="@firebase/analytics-compat",Qw="@firebase/analytics",Yw="@firebase/app-check-compat",Jw="@firebase/app-check",Xw="@firebase/auth",Zw="@firebase/auth-compat",e0="@firebase/database",t0="@firebase/data-connect",n0="@firebase/database-compat",r0="@firebase/functions",i0="@firebase/functions-compat",s0="@firebase/installations",o0="@firebase/installations-compat",a0="@firebase/messaging",l0="@firebase/messaging-compat",u0="@firebase/performance",c0="@firebase/performance-compat",h0="@firebase/remote-config",d0="@firebase/remote-config-compat",f0="@firebase/storage",p0="@firebase/storage-compat",m0="@firebase/firestore",g0="@firebase/ai",y0="@firebase/firestore-compat",_0="firebase",v0="12.12.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo=v0;function py(i,e={}){let t=i;typeof e!="object"&&(e={name:e});const s={name:od,automaticDataCollectionEnabled:!0,...e},o=s.name;if(typeof o!="string"||!o)throw mi.create("bad-app-name",{appName:String(o)});if(t||(t=uy()),!t)throw mi.create("no-options");const u=Du.get(o);if(u){if(is(t,u.options)&&is(s,u.config))return u;throw mi.create("duplicate-app",{appName:o})}const h=new kw(o);for(const y of ad.values())h.addComponent(y);const m=new I0(t,s,h);return Du.set(o,m),m}function my(i=od){const e=Du.get(i);if(!e&&i===od&&uy())return py();if(!e)throw mi.create("no-app",{appName:i});return e}function gi(i,e,t){let s=E0[i]??i;t&&(s+=`-${t}`);const o=s.match(/\s|\//),u=e.match(/\s|\//);if(o||u){const h=[`Unable to register library "${s}" with version "${e}":`];o&&h.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&u&&h.push("and"),u&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Cr.warn(h.join(" "));return}fo(new ss(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vu=new Pd("@firebase/auth");function L0(i,...e){Vu.logLevel<=Ae.WARN&&Vu.warn(`Auth (${Eo}): ${i}`,...e)}function wu(i,...e){Vu.logLevel<=Ae.ERROR&&Vu.error(`Auth (${Eo}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(e,t){this.shortDelay=e,this.longDelay=t,Pr(t>e,"Short delay should be less than long delay!"),this.isMobile=cw()||pw()}get(){return F0()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vd(i,e){Pr(i.emulator,"Emulator should always be set here");const{url:t}=i.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gm=new Map;function Ar(i){Pr(i instanceof Function,"Expected a class definition");let e=Gm.get(i);return e?(Pr(e instanceof i,"Instance stored in cache mismatched with class"),e):(e=new i,Gm.set(i,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tu(i,e,t){return`firebase:${i}:${e}:${t}`}class ao{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:o,name:u}=this.auth;this.fullUserKey=Tu(this.userKey,o.apiKey,u),this.fullPersistenceKey=Tu("persistence",o.apiKey,u),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Ou(this.auth,{idToken:e}).catch(()=>{});return t?Pn._fromGetAccountInfoResponse(this.auth,t,e):null}return Pn._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new ao(Ar(Km),e,s);const o=(await Promise.all(t.map(async v=>{if(await v._isAvailable())return v}))).filter(v=>v);let u=o[0]||Ar(Km);const h=Tu(s,e.config.apiKey,e.name);let m=null;for(const v of t)try{const w=await v._get(h);if(w){let R;if(typeof w=="string"){const M=await Ou(e,{idToken:w}).catch(()=>{});if(!M)break;R=await Pn._fromGetAccountInfoResponse(e,M,w)}else R=Pn._fromJSON(e,w);v!==u&&(m=R),u=v;break}}catch{}const y=o.filter(v=>v._shouldAllowMigration);return!u._shouldAllowMigration||!y.length?new ao(u,e,s):(u=y[0],m&&await u._set(h,m.toJSON()),await Promise.all(t.map(async v=>{if(v!==u)try{await v._remove(h)}catch{}})),new ao(u,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qm(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Py(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ay(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Ny(e))return"Blackberry";if(xy(e))return"Webos";if(Ry(e))return"Safari";if((e.includes("chrome/")||Cy(e))&&!e.includes("edge/"))return"Chrome";if(ky(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(t);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Ay(i=Ut()){return/firefox\//i.test(i)}function Ry(i=Ut()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Cy(i=Ut()){return/crios\//i.test(i)}function Py(i=Ut()){return/iemobile/i.test(i)}function ky(i=Ut()){return/android/i.test(i)}function Ny(i=Ut()){return/blackberry/i.test(i)}function xy(i=Ut()){return/webos/i.test(i)}function Md(i=Ut()){return/iphone|ipad|ipod/i.test(i)||/macintosh/i.test(i)&&/mobile/i.test(i)}function Z0(i=Ut()){var e;return Md(i)&&!!((e=window.navigator)!=null&&e.standalone)}function eT(){return mw()&&document.documentMode===10}function Dy(i=Ut()){return Md(i)||ky(i)||xy(i)||Ny(i)||/windows phone/i.test(i)||Py(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $y(){return typeof Jn().WorkerGlobalScope<"u"&&typeof Jn().importScripts=="function"}async function PT(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function kT(){var i;return((i=navigator==null?void 0:navigator.serviceWorker)==null?void 0:i.controller)||null}function NT(){return $y()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ky{constructor(e,t,s,o,u=!1){this.auth=e,this.resolver=s,this.user=o,this.bypassAuthState=u,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:s,postBody:o,tenantId:u,error:h,type:m}=e;if(h){this.reject(h);return}const y={auth:this.auth,requestUri:t,sessionId:s,tenantId:u||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(m)(y))}catch(v){this.reject(v)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return bT;case"linkViaPopup":case"linkViaRedirect":return UT;case"reauthViaPopup":case"reauthViaRedirect":return FT;default:nr(this.auth,"internal-error")}}resolve(e){Pr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Pr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jh="webStorageSupport";class SI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=By,this._completeRedirectFn=KT,this._overrideRedirectResult=qT}async _openPopup(e,t,s,o){var h;Pr((h=this.eventManagers[e._key()])==null?void 0:h.manager,"_initialize() not called before _openPopup()");const u=await ig(e,t,s,ld(),o);return _I(e,u,Ud())}async _openRedirect(e,t,s,o){await this._originValidation(e);const u=await ig(e,t,s,ld(),o);return CT(u),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:u}=this.eventManagers[t];return o?Promise.resolve(o):(Pr(u,"If manager is not set, promise should be"),u)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await dI(e),s=new YT(e);return t.register("authEvent",o=>(pe(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:s.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Jh,{type:Jh},o=>{var h;const u=(h=o==null?void 0:o[0])==null?void 0:h[Jh];u!==void 0&&t(!!u),nr(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=tI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Dy()||Ry()||Md()}}const AI=SI;var sg="@firebase/auth",og="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CI(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function PI(i){fo(new ss("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:h,authDomain:m}=s.options;pe(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const y={apiKey:h,authDomain:m,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vy(i)},v=new sT(s,o,u,y);return hT(v,t),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),fo(new ss("auth-internal",e=>{const t=Zu(e.getProvider("auth").getImmediate());return(s=>new RI(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),gi(sg,og,CI(i)),gi(sg,og,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var yi,Yy;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(P,I){function A(){}A.prototype=I.prototype,P.F=I.prototype,P.prototype=new A,P.prototype.constructor=P,P.D=function(x,k,V){for(var S=Array(arguments.length-2),$e=2;$e<arguments.length;$e++)S[$e-2]=arguments[$e];return I.prototype[k].apply(x,S)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,t),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(P,I,A){A||(A=0);const x=Array(16);if(typeof I=="string")for(var k=0;k<16;++k)x[k]=I.charCodeAt(A++)|I.charCodeAt(A++)<<8|I.charCodeAt(A++)<<16|I.charCodeAt(A++)<<24;else for(k=0;k<16;++k)x[k]=I[A++]|I[A++]<<8|I[A++]<<16|I[A++]<<24;I=P.g[0],A=P.g[1],k=P.g[2];let V=P.g[3],S;S=I+(V^A&(k^V))+x[0]+3614090360&4294967295,I=A+(S<<7&4294967295|S>>>25),S=V+(k^I&(A^k))+x[1]+3905402710&4294967295,V=I+(S<<12&4294967295|S>>>20),S=k+(A^V&(I^A))+x[2]+606105819&4294967295,k=V+(S<<17&4294967295|S>>>15),S=A+(I^k&(V^I))+x[3]+3250441966&4294967295,A=k+(S<<22&4294967295|S>>>10),S=I+(V^A&(k^V))+x[4]+4118548399&4294967295,I=A+(S<<7&4294967295|S>>>25),S=V+(k^I&(A^k))+x[5]+1200080426&4294967295,V=I+(S<<12&4294967295|S>>>20),S=k+(A^V&(I^A))+x[6]+2821735955&4294967295,k=V+(S<<17&4294967295|S>>>15),S=A+(I^k&(V^I))+x[7]+4249261313&4294967295,A=k+(S<<22&4294967295|S>>>10),S=I+(V^A&(k^V))+x[8]+1770035416&4294967295,I=A+(S<<7&4294967295|S>>>25),S=V+(k^I&(A^k))+x[9]+2336552879&4294967295,V=I+(S<<12&4294967295|S>>>20),S=k+(A^V&(I^A))+x[10]+4294925233&4294967295,k=V+(S<<17&4294967295|S>>>15),S=A+(I^k&(V^I))+x[11]+2304563134&4294967295,A=k+(S<<22&4294967295|S>>>10),S=I+(V^A&(k^V))+x[12]+1804603682&4294967295,I=A+(S<<7&4294967295|S>>>25),S=V+(k^I&(A^k))+x[13]+4254626195&4294967295,V=I+(S<<12&4294967295|S>>>20),S=k+(A^V&(I^A))+x[14]+2792965006&4294967295,k=V+(S<<17&4294967295|S>>>15),S=A+(I^k&(V^I))+x[15]+1236535329&4294967295,A=k+(S<<22&4294967295|S>>>10),S=I+(k^V&(A^k))+x[1]+4129170786&4294967295,I=A+(S<<5&4294967295|S>>>27),S=V+(A^k&(I^A))+x[6]+3225465664&4294967295,V=I+(S<<9&4294967295|S>>>23),S=k+(I^A&(V^I))+x[11]+643717713&4294967295,k=V+(S<<14&4294967295|S>>>18),S=A+(V^I&(k^V))+x[0]+3921069994&4294967295,A=k+(S<<20&4294967295|S>>>12),S=I+(k^V&(A^k))+x[5]+3593408605&4294967295,I=A+(S<<5&4294967295|S>>>27),S=V+(A^k&(I^A))+x[10]+38016083&4294967295,V=I+(S<<9&4294967295|S>>>23),S=k+(I^A&(V^I))+x[15]+3634488961&4294967295,k=V+(S<<14&4294967295|S>>>18),S=A+(V^I&(k^V))+x[4]+3889429448&4294967295,A=k+(S<<20&4294967295|S>>>12),S=I+(k^V&(A^k))+x[9]+568446438&4294967295,I=A+(S<<5&4294967295|S>>>27),S=V+(A^k&(I^A))+x[14]+3275163606&4294967295,V=I+(S<<9&4294967295|S>>>23),S=k+(I^A&(V^I))+x[3]+4107603335&4294967295,k=V+(S<<14&4294967295|S>>>18),S=A+(V^I&(k^V))+x[8]+1163531501&4294967295,A=k+(S<<20&4294967295|S>>>12),S=I+(k^V&(A^k))+x[13]+2850285829&4294967295,I=A+(S<<5&4294967295|S>>>27),S=V+(A^k&(I^A))+x[2]+4243563512&4294967295,V=I+(S<<9&4294967295|S>>>23),S=k+(I^A&(V^I))+x[7]+1735328473&4294967295,k=V+(S<<14&4294967295|S>>>18),S=A+(V^I&(k^V))+x[12]+2368359562&4294967295,A=k+(S<<20&4294967295|S>>>12),S=I+(A^k^V)+x[5]+4294588738&4294967295,I=A+(S<<4&4294967295|S>>>28),S=V+(I^A^k)+x[8]+2272392833&4294967295,V=I+(S<<11&4294967295|S>>>21),S=k+(V^I^A)+x[11]+1839030562&4294967295,k=V+(S<<16&4294967295|S>>>16),S=A+(k^V^I)+x[14]+4259657740&4294967295,A=k+(S<<23&4294967295|S>>>9),S=I+(A^k^V)+x[1]+2763975236&4294967295,I=A+(S<<4&4294967295|S>>>28),S=V+(I^A^k)+x[4]+1272893353&4294967295,V=I+(S<<11&4294967295|S>>>21),S=k+(V^I^A)+x[7]+4139469664&4294967295,k=V+(S<<16&4294967295|S>>>16),S=A+(k^V^I)+x[10]+3200236656&4294967295,A=k+(S<<23&4294967295|S>>>9),S=I+(A^k^V)+x[13]+681279174&4294967295,I=A+(S<<4&4294967295|S>>>28),S=V+(I^A^k)+x[0]+3936430074&4294967295,V=I+(S<<11&4294967295|S>>>21),S=k+(V^I^A)+x[3]+3572445317&4294967295,k=V+(S<<16&4294967295|S>>>16),S=A+(k^V^I)+x[6]+76029189&4294967295,A=k+(S<<23&4294967295|S>>>9),S=I+(A^k^V)+x[9]+3654602809&4294967295,I=A+(S<<4&4294967295|S>>>28),S=V+(I^A^k)+x[12]+3873151461&4294967295,V=I+(S<<11&4294967295|S>>>21),S=k+(V^I^A)+x[15]+530742520&4294967295,k=V+(S<<16&4294967295|S>>>16),S=A+(k^V^I)+x[2]+3299628645&4294967295,A=k+(S<<23&4294967295|S>>>9),S=I+(k^(A|~V))+x[0]+4096336452&4294967295,I=A+(S<<6&4294967295|S>>>26),S=V+(A^(I|~k))+x[7]+1126891415&4294967295,V=I+(S<<10&4294967295|S>>>22),S=k+(I^(V|~A))+x[14]+2878612391&4294967295,k=V+(S<<15&4294967295|S>>>17),S=A+(V^(k|~I))+x[5]+4237533241&4294967295,A=k+(S<<21&4294967295|S>>>11),S=I+(k^(A|~V))+x[12]+1700485571&4294967295,I=A+(S<<6&4294967295|S>>>26),S=V+(A^(I|~k))+x[3]+2399980690&4294967295,V=I+(S<<10&4294967295|S>>>22),S=k+(I^(V|~A))+x[10]+4293915773&4294967295,k=V+(S<<15&4294967295|S>>>17),S=A+(V^(k|~I))+x[1]+2240044497&4294967295,A=k+(S<<21&4294967295|S>>>11),S=I+(k^(A|~V))+x[8]+1873313359&4294967295,I=A+(S<<6&4294967295|S>>>26),S=V+(A^(I|~k))+x[15]+4264355552&4294967295,V=I+(S<<10&4294967295|S>>>22),S=k+(I^(V|~A))+x[6]+2734768916&4294967295,k=V+(S<<15&4294967295|S>>>17),S=A+(V^(k|~I))+x[13]+1309151649&4294967295,A=k+(S<<21&4294967295|S>>>11),S=I+(k^(A|~V))+x[4]+4149444226&4294967295,I=A+(S<<6&4294967295|S>>>26),S=V+(A^(I|~k))+x[11]+3174756917&4294967295,V=I+(S<<10&4294967295|S>>>22),S=k+(I^(V|~A))+x[2]+718787259&4294967295,k=V+(S<<15&4294967295|S>>>17),S=A+(V^(k|~I))+x[9]+3951481745&4294967295,P.g[0]=P.g[0]+I&4294967295,P.g[1]=P.g[1]+(k+(S<<21&4294967295|S>>>11))&4294967295,P.g[2]=P.g[2]+k&4294967295,P.g[3]=P.g[3]+V&4294967295}s.prototype.v=function(P,I){I===void 0&&(I=P.length);const A=I-this.blockSize,x=this.C;let k=this.h,V=0;for(;V<I;){if(k==0)for(;V<=A;)o(this,P,V),V+=this.blockSize;if(typeof P=="string"){for(;V<I;)if(x[k++]=P.charCodeAt(V++),k==this.blockSize){o(this,x),k=0;break}}else for(;V<I;)if(x[k++]=P[V++],k==this.blockSize){o(this,x),k=0;break}}this.h=k,this.o+=I},s.prototype.A=function(){var P=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);P[0]=128;for(var I=1;I<P.length-8;++I)P[I]=0;I=this.o*8;for(var A=P.length-8;A<P.length;++A)P[A]=I&255,I/=256;for(this.v(P),P=Array(16),I=0,A=0;A<4;++A)for(let x=0;x<32;x+=8)P[I++]=this.g[A]>>>x&255;return P};function u(P,I){var A=m;return Object.prototype.hasOwnProperty.call(A,P)?A[P]:A[P]=I(P)}function h(P,I){this.h=I;const A=[];let x=!0;for(let k=P.length-1;k>=0;k--){const V=P[k]|0;x&&V==I||(A[k]=V,x=!1)}this.g=A}var m={};function y(P){return-128<=P&&P<128?u(P,function(I){return new h([I|0],I<0?-1:0)}):new h([P|0],P<0?-1:0)}function v(P){if(isNaN(P)||!isFinite(P))return R;if(P<0)return K(v(-P));const I=[];let A=1;for(let x=0;P>=A;x++)I[x]=P/A|0,A*=4294967296;return new h(I,0)}function w(P,I){if(P.length==0)throw Error("number format error: empty string");if(I=I||10,I<2||36<I)throw Error("radix out of range: "+I);if(P.charAt(0)=="-")return K(w(P.substring(1),I));if(P.indexOf("-")>=0)throw Error('number format error: interior "-" character');const A=v(Math.pow(I,8));let x=R;for(let V=0;V<P.length;V+=8){var k=Math.min(8,P.length-V);const S=parseInt(P.substring(V,V+k),I);k<8?(k=v(Math.pow(I,k)),x=x.j(k).add(v(S))):(x=x.j(A),x=x.add(v(S)))}return x}var R=y(0),M=y(1),z=y(16777216);i=h.prototype,i.m=function(){if(J(this))return-K(this).m();let P=0,I=1;for(let A=0;A<this.g.length;A++){const x=this.i(A);P+=(x>=0?x:4294967296+x)*I,I*=4294967296}return P},i.toString=function(P){if(P=P||10,P<2||36<P)throw Error("radix out of range: "+P);if(Y(this))return"0";if(J(this))return"-"+K(this).toString(P);const I=v(Math.pow(P,6));var A=this;let x="";for(;;){const k=Fe(A,I).g;A=Ee(A,k.j(I));let V=((A.g.length>0?A.g[0]:A.h)>>>0).toString(P);if(A=k,Y(A))return V+x;for(;V.length<6;)V="0"+V;x=V+x}},i.i=function(P){return P<0?0:P<this.g.length?this.g[P]:this.h};function Y(P){if(P.h!=0)return!1;for(let I=0;I<P.g.length;I++)if(P.g[I]!=0)return!1;return!0}function J(P){return P.h==-1}i.l=function(P){return P=Ee(this,P),J(P)?-1:Y(P)?0:1};function K(P){const I=P.g.length,A=[];for(let x=0;x<I;x++)A[x]=~P.g[x];return new h(A,~P.h).add(M)}i.abs=function(){return J(this)?K(this):this},i.add=function(P){const I=Math.max(this.g.length,P.g.length),A=[];let x=0;for(let k=0;k<=I;k++){let V=x+(this.i(k)&65535)+(P.i(k)&65535),S=(V>>>16)+(this.i(k)>>>16)+(P.i(k)>>>16);x=S>>>16,V&=65535,S&=65535,A[k]=S<<16|V}return new h(A,A[A.length-1]&-2147483648?-1:0)};function Ee(P,I){return P.add(K(I))}i.j=function(P){if(Y(this)||Y(P))return R;if(J(this))return J(P)?K(this).j(K(P)):K(K(this).j(P));if(J(P))return K(this.j(K(P)));if(this.l(z)<0&&P.l(z)<0)return v(this.m()*P.m());const I=this.g.length+P.g.length,A=[];for(var x=0;x<2*I;x++)A[x]=0;for(x=0;x<this.g.length;x++)for(let k=0;k<P.g.length;k++){const V=this.i(x)>>>16,S=this.i(x)&65535,$e=P.i(k)>>>16,_t=P.i(k)&65535;A[2*x+2*k]+=S*_t,we(A,2*x+2*k),A[2*x+2*k+1]+=V*_t,we(A,2*x+2*k+1),A[2*x+2*k+1]+=S*$e,we(A,2*x+2*k+1),A[2*x+2*k+2]+=V*$e,we(A,2*x+2*k+2)}for(P=0;P<I;P++)A[P]=A[2*P+1]<<16|A[2*P];for(P=I;P<2*I;P++)A[P]=0;return new h(A,0)};function we(P,I){for(;(P[I]&65535)!=P[I];)P[I+1]+=P[I]>>>16,P[I]&=65535,I++}function ke(P,I){this.g=P,this.h=I}function Fe(P,I){if(Y(I))throw Error("division by zero");if(Y(P))return new ke(R,R);if(J(P))return I=Fe(K(P),I),new ke(K(I.g),K(I.h));if(J(I))return I=Fe(P,K(I)),new ke(K(I.g),I.h);if(P.g.length>30){if(J(P)||J(I))throw Error("slowDivide_ only works with positive integers.");for(var A=M,x=I;x.l(P)<=0;)A=je(A),x=je(x);var k=Ve(A,1),V=Ve(x,1);for(x=Ve(x,2),A=Ve(A,2);!Y(x);){var S=V.add(x);S.l(P)<=0&&(k=k.add(A),V=S),x=Ve(x,1),A=Ve(A,1)}return I=Ee(P,k.j(I)),new ke(k,I)}for(k=R;P.l(I)>=0;){for(A=Math.max(1,Math.floor(P.m()/I.m())),x=Math.ceil(Math.log(A)/Math.LN2),x=x<=48?1:Math.pow(2,x-48),V=v(A),S=V.j(I);J(S)||S.l(P)>0;)A-=x,V=v(A),S=V.j(I);Y(V)&&(V=M),k=k.add(V),P=Ee(P,S)}return new ke(k,P)}i.B=function(P){return Fe(this,P).h},i.and=function(P){const I=Math.max(this.g.length,P.g.length),A=[];for(let x=0;x<I;x++)A[x]=this.i(x)&P.i(x);return new h(A,this.h&P.h)},i.or=function(P){const I=Math.max(this.g.length,P.g.length),A=[];for(let x=0;x<I;x++)A[x]=this.i(x)|P.i(x);return new h(A,this.h|P.h)},i.xor=function(P){const I=Math.max(this.g.length,P.g.length),A=[];for(let x=0;x<I;x++)A[x]=this.i(x)^P.i(x);return new h(A,this.h^P.h)};function je(P){const I=P.g.length+1,A=[];for(let x=0;x<I;x++)A[x]=P.i(x)<<1|P.i(x-1)>>>31;return new h(A,P.h)}function Ve(P,I){const A=I>>5;I%=32;const x=P.g.length-A,k=[];for(let V=0;V<x;V++)k[V]=I>0?P.i(V+A)>>>I|P.i(V+A+1)<<32-I:P.i(V+A);return new h(k,P.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,Yy=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.B,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=v,h.fromString=w,yi=h}).apply(typeof lg<"u"?lg:typeof self<"u"?self:typeof window<"u"?window:{});var gu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as=new Pd("@firebase/firestore");function no(){return as.logLevel}function te(i,...e){if(as.logLevel<=Ae.DEBUG){const t=e.map(zd);as.debug(`Firestore (${To}): ${i}`,...t)}}function kr(i,...e){if(as.logLevel<=Ae.ERROR){const t=e.map(zd);as.error(`Firestore (${To}): ${i}`,...t)}}function ls(i,...e){if(as.logLevel<=Ae.WARN){const t=e.map(zd);as.warn(`Firestore (${To}): ${i}`,...t)}}function zd(i){if(typeof i=="string")return i;try{return(function(t){return JSON.stringify(t)})(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function de(i,e,t){let s="Unexpected state";typeof e=="string"?s=e:t=e,n_(i,s,t)}function n_(i,e,t){let s=`FIRESTORE (${To}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(t!==void 0)try{s+=" CONTEXT: "+JSON.stringify(t)}catch{s+=" CONTEXT: "+t}throw kr(s),new Error(s)}function be(i,e,t,s){let o="Unexpected state";typeof t=="string"?o=t:s=t,i||n_(e,o,s)}function ye(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kn{constructor(e){this.fields=e,e.sort(Pt.comparator)}static empty(){return new kn([])}unionWith(e){let t=new yt(Pt.comparator);for(const s of this.fields)t=t.add(s);for(const s of e)t=t.add(s);return new kn(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return mo(this.fields,e.fields,((t,s)=>t.isEqual(s)))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mn{constructor(e){this.value=e}static empty(){return new mn({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let s=0;s<e.length-1;++s)if(t=(t.mapValue.fields||{})[e.get(s)],!Cu(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ca(t)}setAll(e){let t=Pt.emptyPath(),s={},o=[];e.forEach(((h,m)=>{if(!t.isImmediateParentOf(m)){const y=this.getFieldsMap(t);this.applyChanges(y,s,o),s={},o=[],t=m.popLast()}h?s[m.lastSegment()]=Ca(h):o.push(m.lastSegment())}));const u=this.getFieldsMap(t);this.applyChanges(u,s,o)}delete(e){const t=this.field(e.popLast());Cu(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return rr(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let s=0;s<e.length;++s){let o=t.mapValue.fields[e.get(s)];Cu(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},t.mapValue.fields[e.get(s)]=o),t=o}return t.mapValue.fields}applyChanges(e,t,s){cs(t,((o,u)=>e[o]=u));for(const o of s)delete e[o]}clone(){return new mn(Ca(this.value))}}function m_(i){const e=[];return cs(i.fields,((t,s)=>{const o=new Pt([t]);if(Cu(s)){const u=m_(s.mapValue).fields;if(u.length===0)e.push(o);else for(const h of u)e.push(o.child(h))}else e.push(o)})),new kn(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IS=new tt(ue.comparator);function Nr(){return IS}const S_=new tt(ue.comparator);function Ia(...i){let e=S_;for(const t of i)e=e.insert(t.key,t);return e}function A_(i){let e=S_;return i.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function ts(){return ka()}function R_(){return ka()}function ka(){return new hs((i=>i.toString()),((i,e)=>i.isEqual(e)))}const SS=new tt(ue.comparator),AS=new yt(ue.comparator);function Ce(...i){let e=AS;for(const t of i)e=e.add(t);return e}const RS=new yt(Re);function CS(){return RS}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yd(i,e){if(i.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Uu(e)?"-0":e}}function C_(i){return{integerValue:""+i}}function PS(i,e){return XI(e)?C_(e):Yd(i,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lc{constructor(){this._=void 0}}function kS(i,e,t){return i instanceof Hu?(function(o,u){const h={fields:{[c_]:{stringValue:u_},[d_]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&qd(u)&&(u=ic(u)),u&&(h.fields[h_]=u),{mapValue:h}})(t,e):i instanceof Fa?k_(i,e):i instanceof Ua?N_(i,e):(function(o,u){const h=P_(o,u),m=Rg(h)+Rg(o.Ae);return pd(h)&&pd(o.Ae)?C_(m):Yd(o.serializer,m)})(i,e)}function NS(i,e,t){return i instanceof Fa?k_(i,e):i instanceof Ua?N_(i,e):t}function P_(i,e){return i instanceof qu?(function(s){return pd(s)||(function(u){return!!u&&"doubleValue"in u})(s)})(e)?e:{integerValue:0}:null}class Hu extends lc{}class Fa extends lc{constructor(e){super(),this.elements=e}}function k_(i,e){const t=x_(e);for(const s of i.elements)t.some((o=>rr(o,s)))||t.push(s);return{arrayValue:{values:t}}}class Ua extends lc{constructor(e){super(),this.elements=e}}function N_(i,e){let t=x_(e);for(const s of i.elements)t=t.filter((o=>!rr(o,s)));return{arrayValue:{values:t}}}class qu extends lc{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Rg(i){return at(i.integerValue||i.doubleValue)}function x_(i){return Wd(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}function xS(i,e){return i.field.isEqual(e.field)&&(function(s,o){return s instanceof Fa&&o instanceof Fa||s instanceof Ua&&o instanceof Ua?mo(s.elements,o.elements,rr):s instanceof qu&&o instanceof qu?rr(s.Ae,o.Ae):s instanceof Hu&&o instanceof Hu})(i.transform,e.transform)}class DS{constructor(e,t){this.version=e,this.transformResults=t}}class Zn{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Zn}static exists(e){return new Zn(void 0,e)}static updateTime(e){return new Zn(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Pu(i,e){return i.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(i.updateTime):i.exists===void 0||i.exists===e.isFoundDocument()}class uc{}function D_(i,e){if(!i.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return i.isNoDocument()?new Jd(i.key,Zn.none()):new Ka(i.key,i.data,Zn.none());{const t=i.data,s=mn.empty();let o=new yt(Pt.comparator);for(let u of e.fields)if(!o.has(u)){let h=t.field(u);h===null&&u.length>1&&(u=u.popLast(),h=t.field(u)),h===null?s.delete(u):s.set(u,h),o=o.add(u)}return new ds(i.key,s,new kn(o.toArray()),Zn.none())}}function VS(i,e,t){i instanceof Ka?(function(o,u,h){const m=o.value.clone(),y=Pg(o.fieldTransforms,u,h.transformResults);m.setAll(y),u.convertToFoundDocument(h.version,m).setHasCommittedMutations()})(i,e,t):i instanceof ds?(function(o,u,h){if(!Pu(o.precondition,u))return void u.convertToUnknownDocument(h.version);const m=Pg(o.fieldTransforms,u,h.transformResults),y=u.data;y.setAll(V_(o)),y.setAll(m),u.convertToFoundDocument(h.version,y).setHasCommittedMutations()})(i,e,t):(function(o,u,h){u.convertToNoDocument(h.version).setHasCommittedMutations()})(0,e,t)}function Na(i,e,t,s){return i instanceof Ka?(function(u,h,m,y){if(!Pu(u.precondition,h))return m;const v=u.value.clone(),w=kg(u.fieldTransforms,y,h);return v.setAll(w),h.convertToFoundDocument(h.version,v).setHasLocalMutations(),null})(i,e,t,s):i instanceof ds?(function(u,h,m,y){if(!Pu(u.precondition,h))return m;const v=kg(u.fieldTransforms,y,h),w=h.data;return w.setAll(V_(u)),w.setAll(v),h.convertToFoundDocument(h.version,w).setHasLocalMutations(),m===null?null:m.unionWith(u.fieldMask.fields).unionWith(u.fieldTransforms.map((R=>R.field)))})(i,e,t,s):(function(u,h,m){return Pu(u.precondition,h)?(h.convertToNoDocument(h.version).setHasLocalMutations(),null):m})(i,e,t)}function OS(i,e){let t=null;for(const s of i.fieldTransforms){const o=e.data.field(s.field),u=P_(s.transform,o||null);u!=null&&(t===null&&(t=mn.empty()),t.set(s.field,u))}return t||null}function Cg(i,e){return i.type===e.type&&!!i.key.isEqual(e.key)&&!!i.precondition.isEqual(e.precondition)&&!!(function(s,o){return s===void 0&&o===void 0||!(!s||!o)&&mo(s,o,((u,h)=>xS(u,h)))})(i.fieldTransforms,e.fieldTransforms)&&(i.type===0?i.value.isEqual(e.value):i.type!==1||i.data.isEqual(e.data)&&i.fieldMask.isEqual(e.fieldMask))}class Ka extends uc{constructor(e,t,s,o=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class ds extends uc{constructor(e,t,s,o,u=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=o,this.fieldTransforms=u,this.type=1}getFieldMask(){return this.fieldMask}}function V_(i){const e=new Map;return i.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const s=i.data.field(t);e.set(t,s)}})),e}function Pg(i,e,t){const s=new Map;be(i.length===t.length,32656,{Ve:t.length,de:i.length});for(let o=0;o<t.length;o++){const u=i[o],h=u.transform,m=e.data.field(u.field);s.set(u.field,NS(h,m,t[o]))}return s}function kg(i,e,t){const s=new Map;for(const o of i){const u=o.transform,h=t.data.field(o.field);s.set(o.field,kS(u,h,e))}return s}class Jd extends uc{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class LS extends uc{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pv{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):kr("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,t){setTimeout((()=>{this.muted||e(t)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new gn(kt.fromBase64String(e))}catch(t){throw new oe($.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new gn(kt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:gn._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Ga(e,gn._jsonSchema))return gn.fromBase64String(e.bytes)}}gn._jsonSchemaVersion="firestore/bytes/1.0",gn._jsonSchema={type:dt("string",gn._jsonSchemaVersion),bytes:dt("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vv{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new oe($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Pt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
