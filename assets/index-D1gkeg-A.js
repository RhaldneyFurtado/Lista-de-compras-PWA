 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt="WebChannelConnection",Pa=(i,e,t)=>{i.listen(e,(s=>{try{t(s)}catch(o){setTimeout((()=>{throw o}),0)}}))};class fo extends hR{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!fo.c_){const e=y_();Pa(e,g_.STAT_EVENT,(t=>{t.stat===_d.PROXY?ne(Mt,"STAT_EVENT: detected buffering proxy"):t.stat===_d.NOPROXY&&ne(Mt,"STAT_EVENT: detected no buffering proxy")})),fo.c_=!0}}zo(e,t,s,o,u){const h=xd();return new Promise(((m,y)=>{const _=new p_;_.setWithCredentials(!0),_.listenOnce(m_.COMPLETE,(()=>{try{switch(_.getLastErrorCode()){case Nu.NO_ERROR:const A=_.getResponseJson();ne(Mt,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(A)),m(A);break;case Nu.TIMEOUT:ne(Mt,`RPC '${e}' ${h} timed out`),y(new ee(B.DEADLINE_EXCEEDED,"Request time out"));break;case Nu.HTTP_ERROR:const V=_.getStatus();if(ne(Mt,`RPC '${e}' ${h} failed with status:`,V,"response text:",_.getResponseText()),V>0){let z=_.getResponseJson();Array.isArray(z)&&(z=z[0]);const W=z==null?void 0:z.error;if(W&&W.status&&W.message){const Y=(function(_e){const ve=_e.toLowerCase().replace(/_/g,"-");return Object.values(B).indexOf(ve)>=0?ve:B.UNKNOWN})(W.status);y(new ee(Y,W.message))}else y(new ee(B.UNKNOWN,"Server responded with status "+_.getStatus()))}else y(new ee(B.UNAVAILABLE,"Connection failed."));break;default:de(9055,{l_:e,streamId:h,h_:_.getLastErrorCode(),P_:_.getLastError()})}}finally{ne(Mt,`RPC '${e}' ${h} completed.`)}}));const w=JSON.stringify(o);ne(Mt,`RPC '${e}' ${h} sending request:`,o),_.send(t,"POST",w,s,15)}))}T_(e,t,s){const o=xd(),u=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=this.createWebChannelTransport(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},y=this.longPollingOptions.timeoutSeconds;y!==void 0&&(m.longPollingTimeout=Math.round(1e3*y)),this.useFetchStreams&&(m.useFetchStreams=!0),this.Go(m.initMessageHeaders,t,s),m.encodeInitMessageHeaders=!0;const _=u.join("");ne(Mt,`Creating RPC '${e}' stream ${o}: ${_}`,m);const w=h.createWebChannel(_,m);this.E_(w);let A=!1,V=!1;const z=new dR({Jo:W=>{V?ne(Mt,`Not sending because RPC '${e}' stream ${o} is closed:`,W):(A||(ne(Mt,`Opening RPC '${e}' stream ${o} transport.`),w.open(),A=!0),ne(Mt,`RPC '${e}' stream ${o} sending:`,W),w.send(W))},Ho:()=>w.close()});return Pa(w,ka.EventType.OPEN,(()=>{V||(ne(Mt,`RPC '${e}' stream ${o} transport opened.`),z.i_())})),Pa(w,ka.EventType.CLOSE,(()=>{V||(V=!0,ne(Mt,`RPC '${e}' stream ${o} transport closed`),z.o_(),this.I_(w))})),Pa(w,ka.EventType.ERROR,(W=>{V||(V=!0,wi(Mt,`RPC '${e}' stream ${o} transport errored. Name:`,W.name,"Message:",W.message),z.o_(new ee(B.UNAVAILABLE,"The operation could not be completed")))})),Pa(w,ka.EventType.MESSAGE,(W=>{var Y;if(!V){const Q=W.data[0];Fe(!!Q,16349);const _e=Q,ve=(_e==null?void 0:_e.error)||((Y=_e[0])==null?void 0:Y.error);if(ve){ne(Mt,`RPC '${e}' stream ${o} received error:`,ve);const Te=ve.status;let Ne=(function(P){const I=dt[P];if(I!==void 0)return ev(I)})(Te),je=ve.message;Te==="NOT_FOUND"&&je.includes("database")&&je.includes("does not exist")&&je.includes(this.databaseId.database)&&wi(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),Ne===void 0&&(Ne=B.INTERNAL,je="Unknown error status: "+Te+" with message "+ve.message),V=!0,z.o_(new ee(Ne,je)),w.close()}else ne(Mt,`RPC '${e}' stream ${o} received:`,Q),z.__(Q)}})),fo.u_(),setTimeout((()=>{z.s_()}),0),z}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,s){super.Go(e,t,s),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return __()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
