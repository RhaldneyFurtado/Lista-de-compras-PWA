 ...
 */var km;function BE(){if(km)return Te;km=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),A=Symbol.iterator;function b(D){return D===null||typeof D!="object"?null:(D=A&&D[A]||D["@@iterator"],typeof D=="function"?D:null)}var z={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,W={};function K(D,H,Ee){this.props=D,this.context=H,this.refs=W,this.updater=Ee||z}K.prototype.isReactComponent={},K.prototype.setState=function(D,H){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,H,"setState")},K.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function me(){}me.prototype=K.prototype;function ve(D,H,Ee){this.props=D,this.context=H,this.refs=W,this.updater=Ee||z}var Pe=ve.prototype=new me;Pe.constructor=ve,Q(Pe,K.prototype),Pe.isPureReactComponent=!0;var Fe=Array.isArray,je=Object.prototype.hasOwnProperty,Ve={current:null},C={key:!0,ref:!0,__self:!0,__source:!0};function I(D,H,Ee){var we,Ie={},Se=null,Me=null;if(H!=null)for(we in H.ref!==void 0&&(Me=H.ref),H.key!==void 0&&(Se=""+H.key),H)je.call(H,we)&&!C.hasOwnProperty(we)&&(Ie[we]=H[we]);var xe=arguments.length-2;if(xe===1)Ie.children=Ee;else if(1<xe){for(var ze=Array(xe),jt=0;jt<xe;jt++)ze[jt]=arguments[jt+2];Ie.children=ze}if(D&&D.defaultProps)for(we in xe=D.defaultProps,xe)Ie[we]===void 0&&(Ie[we]=xe[we]);return{$$typeof:i,type:D,key:Se,ref:Me,props:Ie,_owner:Ve.current}}function R(D,H){return{$$typeof:i,type:D.type,key:H,ref:D.ref,props:D.props,_owner:D._owner}}function x(D){return typeof D=="object"&&D!==null&&D.$$typeof===i}function P(D){var H={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(Ee){return H[Ee]})}var V=/\/+/g;function S(D,H){return typeof D=="object"&&D!==null&&D.key!=null?P(""+D.key):H.toString(36)}function $e(D,H,Ee,we,Ie){var Se=typeof D;(Se==="undefined"||Se==="boolean")&&(D=null);var Me=!1;if(D===null)Me=!0;else switch(Se){case"string":case"number":Me=!0;break;case"object":switch(D.$$typeof){case i:case e:Me=!0}}if(Me)return Me=D,Ie=Ie(Me),D=we===""?"."+S(Me,0):we,Fe(Ie)?(Ee="",D!=null&&(Ee=D.replace(V,"$&/")+"/"),$e(Ie,H,Ee,"",function(jt){return jt})):Ie!=null&&(x(Ie)&&(Ie=R(Ie,Ee+(!Ie.key||Me&&Me.key===Ie.key?"":(""+Ie.key).replace(V,"$&/")+"/")+D)),H.push(Ie)),1;if(Me=0,we=we===""?".":we+":",Fe(D))for(var xe=0;xe<D.length;xe++){Se=D[xe];var ze=we+S(Se,xe);Me+=$e(Se,H,Ee,ze,Ie)}else if(ze=b(D),typeof ze=="function")for(D=ze.call(D),xe=0;!(Se=D.next()).done;)Se=Se.value,ze=we+S(Se,xe++),Me+=$e(Se,H,Ee,ze,Ie);else if(Se==="object")throw H=String(D),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.");return Me}function _t(D,H,Ee){if(D==null)return D;var we=[],Ie=0;return $e(D,we,"","",function(Se){return H.call(Ee,Se,Ie++)}),we}function Nt(D){if(D._status===-1){var H=D._result;H=H(),H.then(function(Ee){(D._status===0||D._status===-1)&&(D._status=1,D._result=Ee)},function(Ee){(D._status===0||D._status===-1)&&(D._status=2,D._result=Ee)}),D._status===-1&&(D._status=0,D._result=H)}if(D._status===1)return D._result.default;throw D._result}var Je={current:null},Z={transition:null},le={ReactCurrentDispatcher:Je,ReactCurrentBatchConfig:Z,ReactCurrentOwner:Ve};function ne(){throw Error("act(...) is not supported in production builds of React.")}return Te.Children={map:_t,forEach:function(D,H,Ee){_t(D,function(){H.apply(this,arguments)},Ee)},count:function(D){var H=0;return _t(D,function(){H++}),H},toArray:function(D){return _t(D,function(H){return H})||[]},only:function(D){if(!x(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},Te.Component=K,Te.Fragment=t,Te.Profiler=o,Te.PureComponent=ve,Te.StrictMode=s,Te.Suspense=y,Te.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=le,Te.act=ne,Te.cloneElement=function(D,H,Ee){if(D==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+D+".");var we=Q({},D.props),Ie=D.key,Se=D.ref,Me=D._owner;if(H!=null){if(H.ref!==void 0&&(Se=H.ref,Me=Ve.current),H.key!==void 0&&(Ie=""+H.key),D.type&&D.type.defaultProps)var xe=D.type.defaultProps;for(ze in H)je.call(H,ze)&&!C.hasOwnProperty(ze)&&(we[ze]=H[ze]===void 0&&xe!==void 0?xe[ze]:H[ze])}var ze=arguments.length-2;if(ze===1)we.children=Ee;else if(1<ze){xe=Array(ze);for(var jt=0;jt<ze;jt++)xe[jt]=arguments[jt+2];we.children=xe}return{$$typeof:i,type:D.type,key:Ie,ref:Se,props:we,_owner:Me}},Te.createContext=function(D){return D={$$typeof:h,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},D.Provider={$$typeof:u,_context:D},D.Consumer=D},Te.createElement=I,Te.createFactory=function(D){var H=I.bind(null,D);return H.type=D,H},Te.createRef=function(){return{current:null}},Te.forwardRef=function(D){return{$$typeof:m,render:D}},Te.isValidElement=x,Te.lazy=function(D){return{$$typeof:w,_payload:{_status:-1,_result:D},_init:Nt}},Te.memo=function(D,H){return{$$typeof:v,type:D,compare:H===void 0?null:H}},Te.startTransition=function(D){var H=Z.transition;Z.transition={};try{D()}finally{Z.transition=H}},Te.unstable_act=ne,Te.useCallback=function(D,H){return Je.current.useCallback(D,H)},Te.useContext=function(D){return Je.current.useContext(D)},Te.useDebugValue=function(){},Te.useDeferredValue=function(D){return Je.current.useDeferredValue(D)},Te.useEffect=function(D,H){return Je.current.useEffect(D,H)},Te.useId=function(){return Je.current.useId()},Te.useImperativeHandle=function(D,H,Ee){return Je.current.useImperativeHandle(D,H,Ee)},Te.useInsertionEffect=function(D,H){return Je.current.useInsertionEffect(D,H)},Te.useLayoutEffect=function(D,H){return Je.current.useLayoutEffect(D,H)},Te.useMemo=function(D,H){return Je.current.useMemo(D,H)},Te.useReducer=function(D,H,Ee){return Je.current.useReducer(D,H,Ee)},Te.useRef=function(D){return Je.current.useRef(D)},Te.useState=function(D){return Je.current.useState(D)},Te.useSyncExternalStore=function(D,H,Ee){return Je.current.useSyncExternalStore(D,H,Ee)},Te.useTransition=function(){return Je.current.useTransition()},Te.version="18.3.1",Te}var Cm;function Cd(){return Cm||(Cm=1,Bh.exports=BE()),Bh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var xm;function qE(){return xm||(xm=1,(function(i){function e(Z,le){var ne=Z.length;Z.push(le);e:for(;0<ne;){var D=ne-1>>>1,H=Z[D];if(0<o(H,le))Z[D]=le,Z[ne]=H,ne=D;else break e}}function t(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var le=Z[0],ne=Z.pop();if(ne!==le){Z[0]=ne;e:for(var D=0,H=Z.length,Ee=H>>>1;D<Ee;){var we=2*(D+1)-1,Ie=Z[we],Se=we+1,Me=Z[Se];if(0>o(Ie,ne))Se<H&&0>o(Me,Ie)?(Z[D]=Me,Z[Se]=ne,D=Se):(Z[D]=Ie,Z[we]=ne,D=we);else if(Se<H&&0>o(Me,ne))Z[D]=Me,Z[Se]=ne,D=Se;else break e}}return le}function o(Z,le){var ne=Z.sortIndex-le.sortIndex;return ne!==0?ne:Z.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var y=[],v=[],w=1,A=null,b=3,z=!1,Q=!1,W=!1,K=typeof setTimeout=="function"?setTimeout:null,me=typeof clearTimeout=="function"?clearTimeout:null,ve=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function Pe(Z){for(var le=t(v);le!==null;){if(le.callback===null)s(v);else if(le.startTime<=Z)s(v),le.sortIndex=le.expirationTime,e(y,le);else break;le=t(v)}}function Fe(Z){if(W=!1,Pe(Z),!Q)if(t(y)!==null)Q=!0,Nt(je);else{var le=t(v);le!==null&&Je(Fe,le.startTime-Z)}}function je(Z,le){Q=!1,W&&(W=!1,me(I),I=-1),z=!0;var ne=b;try{for(Pe(le),A=t(y);A!==null&&(!(A.expirationTime>le)||Z&&!P());){var D=A.callback;if(typeof D=="function"){A.callback=null,b=A.priorityLevel;var H=D(A.expirationTime<=le);le=i.unstable_now(),typeof H=="function"?A.callback=H:A===t(y)&&s(y),Pe(le)}else s(y);A=t(y)}if(A!==null)var Ee=!0;else{var we=t(v);we!==null&&Je(Fe,we.startTime-le),Ee=!1}return Ee}finally{A=null,b=ne,z=!1}}var Ve=!1,C=null,I=-1,R=5,x=-1;function P(){return!(i.unstable_now()-x<R)}function V(){if(C!==null){var Z=i.unstable_now();x=Z;var le=!0;try{le=C(!0,Z)}finally{le?S():(Ve=!1,C=null)}}else Ve=!1}var S;if(typeof ve=="function")S=function(){ve(V)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,_t=$e.port2;$e.port1.onmessage=V,S=function(){_t.postMessage(null)}}else S=function(){K(V,0)};function Nt(Z){C=Z,Ve||(Ve=!0,S())}function Je(Z,le){I=K(function(){Z(i.unstable_now())},le)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(Z){Z.callback=null},i.unstable_continueExecution=function(){Q||z||(Q=!0,Nt(je))},i.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<Z?Math.floor(1e3/Z):5},i.unstable_getCurrentPriorityLevel=function(){return b},i.unstable_getFirstCallbackNode=function(){return t(y)},i.unstable_next=function(Z){switch(b){case 1:case 2:case 3:var le=3;break;default:le=b}var ne=b;b=le;try{return Z()}finally{b=ne}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(Z,le){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var ne=b;b=Z;try{return le()}finally{b=ne}},i.unstable_scheduleCallback=function(Z,le,ne){var D=i.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?D+ne:D):ne=D,Z){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=ne+H,Z={id:w++,callback:le,priorityLevel:Z,startTime:ne,expirationTime:H,sortIndex:-1},ne>D?(Z.sortIndex=ne,e(v,Z),t(y)===null&&Z===t(v)&&(W?(me(I),I=-1):W=!0,Je(Fe,ne-D))):(Z.sortIndex=H,e(y,Z),Q||z||(Q=!0,Nt(je))),Z},i.unstable_shouldYield=P,i.unstable_wrapCallback=function(Z){var le=b;return function(){var ne=b;b=le;try{return Z.apply(this,arguments)}finally{b=ne}}}})(qh)),qh}var Dm;function WE(){return Dm||(Dm=1,Hh.exports=qE()),Hh.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rw=()=>nw().__FIREBASE_DEFAULTS__,iw=()=>{if(typeof process>"u"||typeof Mm>"u")return;const i=Mm.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},sw=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&ly(i[1]);return e&&JSON.parse(e)},Zu=()=>{try{return XE()||rw()||iw()||sw()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},uy=i=>{var e,t;return(t=(e=Zu())==null?void 0:e.emulatorHosts)==null?void 0:t[i]},ow=i=>{const e=uy(i);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const s=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),s]:[e.substring(0,t),s]},cy=()=>{var i;return(i=Zu())==null?void 0:i.config},hy=i=>{var e;return(e=Zu())==null?void 0:e[`_${i}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function uw(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ut())}function cw(){var e;const i=(e=Zu())==null?void 0:e.forceEnvironment;if(i==="node")return!0;if(i==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function hw(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function dw(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function fw(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function pw(){const i=Ut();return i.indexOf("MSIE ")>=0||i.indexOf("Trident/")>=0}function mw(){return!cw()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function gw(){try{return typeof indexedDB=="object"}catch{return!1}}function yw(){return new Promise((i,e)=>{try{let t=!0;const s="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(s);o.onsuccess=()=>{o.result.close(),t||self.indexedDB.deleteDatabase(s),i(!0)},o.onupgradeneeded=()=>{t=!1},o.onerror=()=>{var u;e(((u=o.error)==null?void 0:u.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _w="FirebaseError";class xr extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=_w,Object.setPrototypeOf(this,xr.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ba.prototype.create)}}class Ba{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},o=`${this.service}/${e}`,u=this.errors[e],h=u?vw(u,s):"Error",m=`${this.serviceName}: ${h} (${o}).`;return new xr(o,m,s)}}function vw(i,e){return i.replace(Ew,(t,s)=>{const o=e[s];return o!=null?String(o):`<${s}?>`})}const Ew=/\{\$([^}]+)}/g;function ww(i){for(const e in i)if(Object.prototype.hasOwnProperty.call(i,e))return!1;return!0}function is(i,e){if(i===e)return!0;const t=Object.keys(i),s=Object.keys(e);for(const o of t){if(!s.includes(o))return!1;const u=i[o],h=e[o];if(bm(u)&&bm(h)){if(!is(u,h))return!1}else if(u!==h)return!1}for(const o of s)if(!t.includes(o))return!1;return!0}function bm(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ae;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(Ae||(Ae={}));const Pw={debug:Ae.DEBUG,verbose:Ae.VERBOSE,info:Ae.INFO,warn:Ae.WARN,error:Ae.ERROR,silent:Ae.SILENT},Nw=Ae.INFO,xw={[Ae.DEBUG]:"log",[Ae.VERBOSE]:"log",[Ae.INFO]:"info",[Ae.WARN]:"warn",[Ae.ERROR]:"error"},Dw=(i,e,...t)=>{if(e<i.logLevel)return;const s=new Date().toISOString(),o=xw[e];if(o)console[o](`[${s}]  ${i.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Pd{constructor(e){this.name=e,this._logLevel=Nw,this._logHandler=Dw,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Ae))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Pw[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Ae.DEBUG,...e),this._logHandler(this,Ae.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Ae.VERBOSE,...e),this._logHandler(this,Ae.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Ae.INFO,...e),this._logHandler(this,Ae.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Ae.WARN,...e),this._logHandler(this,Ae.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Ae.ERROR,...e),this._logHandler(this,Ae.ERROR,...e)}}const Vw=(i,e)=>e.some(t=>i instanceof t);let Fm,Um;function Ow(){return Fm||(Fm=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Lw(){return Um||(Um=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const fy=new WeakMap,id=new WeakMap,py=new WeakMap,Kh=new WeakMap,Nd=new WeakMap;function Mw(i){const e=new Promise((t,s)=>{const o=()=>{i.removeEventListener("success",u),i.removeEventListener("error",h)},u=()=>{t(pi(i.result)),o()},h=()=>{s(i.error),o()};i.addEventListener("success",u),i.addEventListener("error",h)});return e.then(t=>{t instanceof IDBCursor&&fy.set(t,i)}).catch(()=>{}),Nd.set(e,i),e}function bw(i){if(id.has(i))return;const e=new Promise((t,s)=>{const o=()=>{i.removeEventListener("complete",u),i.removeEventListener("error",h),i.removeEventListener("abort",h)},u=()=>{t(),o()},h=()=>{s(i.error||new DOMException("AbortError","AbortError")),o()};i.addEventListener("complete",u),i.addEventListener("error",h),i.addEventListener("abort",h)});id.set(i,e)}let sd={get(i,e,t){if(i instanceof IDBTransaction){if(e==="done")return id.get(i);if(e==="objectStoreNames")return i.objectStoreNames||py.get(i);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return pi(i[e])},set(i,e,t){return i[e]=t,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function Fw(i){sd=i(sd)}function Uw(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=i.call(Gh(this),e,...t);return py.set(s,e.sort?e.sort():[e]),pi(s)}:Lw().includes(i)?function(...e){return i.apply(Gh(this),e),pi(fy.get(this))}:function(...e){return pi(i.apply(Gh(this),e))}}function jw(i){return typeof i=="function"?Uw(i):(i instanceof IDBTransaction&&bw(i),Vw(i,Ow())?new Proxy(i,sd):i)}function pi(i){if(i instanceof IDBRequest)return Mw(i);if(Kh.has(i))return Kh.get(i);const e=jw(i);return e!==i&&(Kh.set(i,e),Nd.set(e,i)),e}const Gh=i=>Nd.get(i);function zw(i,e,{blocked:t,upgrade:s,blocking:o,terminated:u}={}){const h=indexedDB.open(i,e),m=pi(h);return s&&h.addEventListener("upgradeneeded",y=>{s(pi(h.result),y.oldVersion,y.newVersion,pi(h.transaction),y)}),t&&h.addEventListener("blocked",y=>t(y.oldVersion,y.newVersion,y)),m.then(y=>{u&&y.addEventListener("close",()=>u()),o&&y.addEventListener("versionchange",v=>o(v.oldVersion,v.newVersion,v))}).catch(()=>{}),m}const Bw=["get","getKey","getAll","getAllKeys","count"],$w=["put","add","delete","clear"],Qh=new Map;function jm(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(Qh.get(e))return Qh.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,o=$w.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(o||Bw.includes(t)))return;const u=async function(h,...m){const y=this.transaction(h,o?"readwrite":"readonly");let v=y.store;return s&&(v=v.index(m.shift())),(await Promise.all([v[t](...m),o&&y.done]))[0]};return Qh.set(e,u),u}Fw(i=>({...i,get:(e,t,s)=>jm(e,t)||i.get(e,t,s),has:(e,t)=>!!jm(e,t)||i.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hw{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(qw(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function qw(i){const e=i.getComponent();return(e==null?void 0:e.type)==="VERSION"}const od="@firebase/app",zm="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kr=new Pd("@firebase/app"),Ww="@firebase/app-compat",Kw="@firebase/analytics-compat",Gw="@firebase/analytics",Qw="@firebase/app-check-compat",Yw="@firebase/app-check",Jw="@firebase/auth",Xw="@firebase/auth-compat",Zw="@firebase/database",e0="@firebase/data-connect",t0="@firebase/database-compat",n0="@firebase/functions",r0="@firebase/functions-compat",i0="@firebase/installations",s0="@firebase/installations-compat",o0="@firebase/messaging",a0="@firebase/messaging-compat",l0="@firebase/performance",u0="@firebase/performance-compat",c0="@firebase/remote-config",h0="@firebase/remote-config-compat",d0="@firebase/storage",f0="@firebase/storage-compat",p0="@firebase/firestore",m0="@firebase/ai",g0="@firebase/firestore-compat",y0="firebase",_0="12.12.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ad="[DEFAULT]",v0={[od]:"fire-core",[Ww]:"fire-core-compat",[Gw]:"fire-analytics",[Kw]:"fire-analytics-compat",[Yw]:"fire-app-check",[Qw]:"fire-app-check-compat",[Jw]:"fire-auth",[Xw]:"fire-auth-compat",[Zw]:"fire-rtdb",[e0]:"fire-data-connect",[t0]:"fire-rtdb-compat",[n0]:"fire-fn",[r0]:"fire-fn-compat",[i0]:"fire-iid",[s0]:"fire-iid-compat",[o0]:"fire-fcm",[a0]:"fire-fcm-compat",[l0]:"fire-perf",[u0]:"fire-perf-compat",[c0]:"fire-rc",[h0]:"fire-rc-compat",[d0]:"fire-gcs",[f0]:"fire-gcs-compat",[p0]:"fire-fst",[g0]:"fire-fst-compat",[m0]:"fire-vertex","fire-js":"fire-js",[y0]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const To=_0;function my(i,e={}){let t=i;typeof e!="object"&&(e={name:e});const s={name:ad,automaticDataCollectionEnabled:!0,...e},o=s.name;if(typeof o!="string"||!o)throw mi.create("bad-app-name",{appName:String(o)});if(t||(t=cy()),!t)throw mi.create("no-options");const u=Vu.get(o);if(u){if(is(t,u.options)&&is(s,u.config))return u;throw mi.create("duplicate-app",{appName:o})}const h=new Cw(o);for(const y of ld.values())h.addComponent(y);const m=new T0(t,s,h);return Vu.set(o,m),m}function gy(i=ad){const e=Vu.get(i);if(!e&&i===ad&&cy())return my();if(!e)throw mi.create("no-app",{appName:i});return e}function gi(i,e,t){let s=v0[i]??i;t&&(s+=`-${t}`);const o=s.match(/\s|\//),u=e.match(/\s|\//);if(o||u){const h=[`Unable to register library "${s}" with version "${e}":`];o&&h.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&u&&h.push("and"),u&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),kr.warn(h.join(" "));return}po(new ss(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R0=1024,k0=30;class C0{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new N0(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;try{const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),u=Hm();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===u||this._heartbeatsCache.heartbeats.some(h=>h.date===u))return;if(this._heartbeatsCache.heartbeats.push({date:u,agent:o}),this._heartbeatsCache.heartbeats.length>k0){const h=x0(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(h,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(s){kr.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Hm(),{heartbeatsToSend:s,unsentEntries:o}=P0(this._heartbeatsCache.heartbeats),u=Du(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,o.length>0?(this._heartbeatsCache.heartbeats=o,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),u}catch(t){return kr.warn(t),""}}}function Hm(){return new Date().toISOString().substring(0,10)}function P0(i,e=R0){const t=[];let s=i.slice();for(const o of i){const u=t.find(h=>h.agent===o.agent);if(u){if(u.dates.push(o.date),qm(t)>e){u.dates.pop();break}}else if(t.push({agent:o.agent,dates:[o.date]}),qm(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class N0{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return gw()?yw().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await A0(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return $m(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return $m(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function qm(i){return Du(JSON.stringify({version:2,heartbeats:i})).length}function x0(i){if(i.length===0)return-1;let e=0,t=i[0].date;for(let s=1;s<i.length;s++)i[s].date<t&&(t=i[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D0(i){po(new ss("platform-logger",e=>new Hw(e),"PRIVATE")),po(new ss("heartbeat",e=>new C0(e),"PRIVATE")),gi(od,zm,i),gi(od,zm,"esm2020"),gi("fire-js","")}D0("");function vy(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const V0=vy,Ey=new Ba("auth","Firebase",vy());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ou=new Pd("@firebase/auth");function O0(i,...e){Ou.logLevel<=Ae.WARN&&Ou.warn(`Auth (${To}): ${i}`,...e)}function Tu(i,...e){Ou.logLevel<=Ae.ERROR&&Ou.error(`Auth (${To}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ud(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.href)||""}function M0(){return Wm()==="http:"||Wm()==="https:"}function Wm(){var i;return typeof self<"u"&&((i=self.location)==null?void 0:i.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b0(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(M0()||dw()||"connection"in navigator)?navigator.onLine:!0}function F0(){if(typeof navigator>"u")return null;const i=navigator;return i.languages&&i.languages[0]||i.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qa{constructor(e,t){this.shortDelay=e,this.longDelay=t,Cr(t>e,"Short delay should be less than long delay!"),this.isMobile=uw()||fw()}get(){return b0()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j0=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],z0=new qa(3e4,6e4);function Ld(i,e){return i.tenantId&&!e.tenantId?{...e,tenantId:i.tenantId}:e}async function Io(i,e,t,s,o={}){return Ty(i,o,async()=>{let u={},h={};s&&(e==="GET"?h=s:u={body:JSON.stringify(s)});const m=$a({key:i.config.apiKey,...h}).slice(1),y=await i._getAdditionalHeaders();y["Content-Type"]="application/json",i.languageCode&&(y["X-Firebase-Locale"]=i.languageCode);const v={method:e,headers:y,...u};return hw()||(v.referrerPolicy="no-referrer"),i.emulatorConfig&&Ha(i.emulatorConfig.host)&&(v.credentials="include"),wy.fetch()(await Iy(i,i.config.apiHost,t,m),v)})}async function Ty(i,e,t){i._canInitEmulator=!1;const s={...U0,...e};try{const o=new $0(i),u=await Promise.race([t(),o.promise]);o.clearNetworkTimeout();const h=await u.json();if("needConfirmation"in h)throw gu(i,"account-exists-with-different-credential",h);if(u.ok&&!("errorMessage"in h))return h;{const m=u.ok?h.errorMessage:h.error.message,[y,v]=m.split(" : ");if(y==="FEDERATED_USER_ID_ALREADY_LINKED")throw gu(i,"credential-already-in-use",h);if(y==="EMAIL_EXISTS")throw gu(i,"email-already-in-use",h);if(y==="USER_DISABLED")throw gu(i,"user-disabled",h);const w=s[y]||y.toLowerCase().replace(/[_\s]+/g,"-");if(v)throw Dd(i,w,v);nr(i,w)}}catch(o){if(o instanceof xr)throw o;nr(i,"network-request-failed",{message:String(o)})}}async function B0(i,e,t,s,o={}){const u=await Io(i,e,t,s,o);return"mfaPendingCredential"in u&&nr(i,"multi-factor-auth-required",{_serverResponse:u}),u}async function Iy(i,e,t,s){const o=`${e}${t}?${s}`,u=i,h=u.config.emulator?Od(i.config,o):`${i.config.apiScheme}://${o}`;return j0.includes(t)&&(await u._persistenceManagerAvailable,u._getPersistenceType()==="COOKIE")?u._getPersistence()._getFinalTarget(h).toString():h}class $0{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(Nn(this.auth,"network-request-failed")),z0.get())})}}function gu(i,e,t){const s={appName:i.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const o=Nn(i,e,s);return o.customData._tokenResponse=t,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function H0(i,e){return Io(i,"POST","/v1/accounts:delete",e)}async function Lu(i,e){return Io(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function La(i,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof xr&&W0(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function W0({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Y0(i,e){const t=await Ty(i,{},async()=>{const s=$a({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:o,apiKey:u}=i.config,h=await Iy(i,o,"/v1/token",`key=${u}`),m=await i._getAdditionalHeaders();m["Content-Type"]="application/x-www-form-urlencoded";const y={method:"POST",headers:m,body:s};return i.emulatorConfig&&Ha(i.emulatorConfig.host)&&(y.credentials="include"),wy.fetch()(h,y)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function J0(i,e){return Io(i,"POST","/v2/accounts:revokeToken",Ld(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uT(i,e){const t=xd(i,"auth");if(t.isInitialized()){const o=t.getImmediate(),u=t.getOptions();if(is(u,e??{}))return o;nr(o,"already-initialized")}return t.initialize({options:e})}function cT(i,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(Ar);e!=null&&e.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function hT(i,e,t){const s=ec(i);pe(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const o=!1,u=Ly(e),{host:h,port:m}=dT(e),y=m===null?"":`:${m}`,v={url:`${u}//${h}${y}/`},w=Object.freeze({host:h,port:m,protocol:u.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!s._canInitEmulator){pe(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),pe(is(v,s.config.emulator)&&is(w,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=v,s.emulatorConfig=w,s.settings.appVerificationDisabledForTesting=!0,Ha(h)?dy(`${u}//${h}${y}`):fT()}function Ly(i){const e=i.indexOf(":");return e<0?"":i.substr(0,e+1)}function dT(i){const e=Ly(i),t=/(\/\/)?([^?#/]+)/.exec(i.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(s);if(o){const u=o[1];return{host:u,port:Xm(s.substr(u.length+1))}}else{const[u,h]=s.split(":");return{host:u,port:Xm(h)}}}function Xm(i){if(!i)return null;const e=Number(i);return isNaN(e)?null:e}function fT(){function i(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",i):i())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uo(i,e){return B0(i,"POST","/v1/accounts:signInWithIdp",Ld(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RI(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function kI(i){po(new ss("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:h,authDomain:m}=s.options;pe(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const y={apiKey:h,authDomain:m,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Oy(i)},v=new iT(s,o,u,y);return cT(v,t),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),po(new ss("auth-internal",e=>{const t=ec(e.getProvider("auth").getImmediate());return(s=>new AI(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),gi(og,ag,RI(i)),gi(og,ag,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt="WebChannelConnection",Ia=(i,e,t)=>{i.listen(e,(s=>{try{t(s)}catch(o){setTimeout((()=>{throw o}),0)}}))};class co extends UA{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!co.c_){const e=t_();Ia(e,e_.STAT_EVENT,(t=>{t.stat===dd.PROXY?te(Mt,"STAT_EVENT: detected buffering proxy"):t.stat===dd.NOPROXY&&te(Mt,"STAT_EVENT: detected no buffering proxy")})),co.c_=!0}}zo(e,t,s,o,u){const h=Sd();return new Promise(((m,y)=>{const v=new Xy;v.setWithCredentials(!0),v.listenOnce(Zy.COMPLETE,(()=>{try{switch(v.getLastErrorCode()){case Ru.NO_ERROR:const A=v.getResponseJson();te(Mt,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(A)),m(A);break;case Ru.TIMEOUT:te(Mt,`RPC '${e}' ${h} timed out`),y(new oe($.DEADLINE_EXCEEDED,"Request time out"));break;case Ru.HTTP_ERROR:const b=v.getStatus();if(te(Mt,`RPC '${e}' ${h} failed with status:`,b,"response text:",v.getResponseText()),b>0){let z=v.getResponseJson();Array.isArray(z)&&(z=z[0]);const Q=z==null?void 0:z.error;if(Q&&Q.status&&Q.message){const W=(function(me){const ve=me.toLowerCase().replace(/_/g,"-");return Object.values($).indexOf(ve)>=0?ve:$.UNKNOWN})(Q.status);y(new oe(W,Q.message))}else y(new oe($.UNKNOWN,"Server responded with status "+v.getStatus()))}else y(new oe($.UNAVAILABLE,"Connection failed."));break;default:de(9055,{l_:e,streamId:h,h_:v.getLastErrorCode(),P_:v.getLastError()})}}finally{te(Mt,`RPC '${e}' ${h} completed.`)}}));const w=JSON.stringify(o);te(Mt,`RPC '${e}' ${h} sending request:`,o),v.send(t,"POST",w,s,15)}))}T_(e,t,s){const o=Sd(),u=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=this.createWebChannelTransport(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},y=this.longPollingOptions.timeoutSeconds;y!==void 0&&(m.longPollingTimeout=Math.round(1e3*y)),this.useFetchStreams&&(m.useFetchStreams=!0),this.Go(m.initMessageHeaders,t,s),m.encodeInitMessageHeaders=!0;const v=u.join("");te(Mt,`Creating RPC '${e}' stream ${o}: ${v}`,m);const w=h.createWebChannel(v,m);this.E_(w);let A=!1,b=!1;const z=new jA({Jo:Q=>{b?te(Mt,`Not sending because RPC '${e}' stream ${o} is closed:`,Q):(A||(te(Mt,`Opening RPC '${e}' stream ${o} transport.`),w.open(),A=!0),te(Mt,`RPC '${e}' stream ${o} sending:`,Q),w.send(Q))},Ho:()=>w.close()});return Ia(w,Sa.EventType.OPEN,(()=>{b||(te(Mt,`RPC '${e}' stream ${o} transport opened.`),z.i_())})),Ia(w,Sa.EventType.CLOSE,(()=>{b||(b=!0,te(Mt,`RPC '${e}' stream ${o} transport closed`),z.o_(),this.I_(w))})),Ia(w,Sa.EventType.ERROR,(Q=>{b||(b=!0,ls(Mt,`RPC '${e}' stream ${o} transport errored. Name:`,Q.name,"Message:",Q.message),z.o_(new oe($.UNAVAILABLE,"The operation could not be completed")))})),Ia(w,Sa.EventType.MESSAGE,(Q=>{var W;if(!b){const K=Q.data[0];be(!!K,16349);const me=K,ve=(me==null?void 0:me.error)||((W=me[0])==null?void 0:W.error);if(ve){te(Mt,`RPC '${e}' stream ${o} received error:`,ve);const Pe=ve.status;let Fe=(function(C){const I=ht[C];if(I!==void 0)return L_(I)})(Pe),je=ve.message;Pe==="NOT_FOUND"&&je.includes("database")&&je.includes("does not exist")&&je.includes(this.databaseId.database)&&ls(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),Fe===void 0&&(Fe=$.INTERNAL,je="Unknown error status: "+Pe+" with message "+ve.message),b=!0,z.o_(new oe(Fe,je)),w.close()}else te(Mt,`RPC '${e}' stream ${o} received:`,K),z.__(K)}})),co.u_(),setTimeout((()=>{z.s_()}),0),z}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,s){super.Go(e,t,s),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return n_()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qg{constructor(){this.ga=new tt(ue.comparator)}track(e){const t=e.doc.key,s=this.ga.get(t);s?e.type!==0&&s.type===3?this.ga=this.ga.insert(t,e):e.type===3&&s.type!==1?this.ga=this.ga.insert(t,{type:s.type,doc:e.doc}):e.type===2&&s.type===2?this.ga=this.ga.insert(t,{type:2,doc:e.doc}):e.type===2&&s.type===0?this.ga=this.ga.insert(t,{type:0,doc:e.doc}):e.type===1&&s.type===0?this.ga=this.ga.remove(t):e.type===1&&s.type===2?this.ga=this.ga.insert(t,{type:1,doc:s.doc}):e.type===0&&s.type===1?this.ga=this.ga.insert(t,{type:2,doc:e.doc}):de(63341,{Vt:e,pa:s}):this.ga=this.ga.insert(t,e)}ya(){const e=[];return this.ga.inorderTraversal(((t,s)=>{e.push(s)})),e}}class Eo{constructor(e,t,s,o,u,h,m,y,v){this.query=e,this.docs=t,this.oldDocs=s,this.docChanges=o,this.mutatedKeys=u,this.fromCache=h,this.syncStateChanged=m,this.excludesMetadataChanges=y,this.hasCachedResults=v}static fromInitialDocuments(e,t,s,o,u){const h=[];return t.forEach((m=>{h.push({type:0,doc:m})})),new Eo(e,t,ho.emptySet(t),h,s,o,!0,!1,u)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&ac(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,s=e.docChanges;if(t.length!==s.length)return!1;for(let o=0;o<t.length;o++)if(t[o].type!==s[o].type||!t[o].doc.isEqual(s[o].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ev{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new oe($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ct(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gi(rR,iR,"app");const sR={apiKey:"AIzaSyBN-jgFWi10Onb0atB7ty24IhfRSMMxulU",authDomain:"lista-de-compras-pwa-64fac.firebaseapp.com",projectId:"lista-de-compras-pwa-64fac",storageBucket:"lista-de-compras-pwa-64fac.appspot.com",messagingSenderId:"922020197463",appId:"1:922020197463:web:41e9aa3c04bf76c7941f12"},Nv=my(sR),Va=xI(Nv);_T(Va,zy);const xv=new Ir;xv.setCustomParameters({prompt:"select_account"});const cs=F1(Nv);function oR(){const[i,e]=Ye.useState(null),[t,s]=Ye.useState(!0),o=async m=>{if(m)try{await Xu(wo(cs,"users",m.uid),{nome:m.displayName||"Usuário",email:m.email||"",foto:m.photoURL||"",ultimoLogin:new Date().toISOString()},{merge:!0})}catch(y){console.error("Erro ao salvar usuário:",y)}};return Ye.useEffect(()=>{let m=!0;const y=wT(Va,v=>{if(!m)return;e(v||null),(async()=>{if(!v){s(!1);return}try{await o(v)}catch(A){console.error(A)}m&&s(!1)})()});return()=>{m=!1,y()}},[]),{usuario:i,loading:t,entrarComGoogle:async()=>{try{await jT(Va,xv)}catch(m){console.error("Erro login Google:",m)}},sair:async()=>{try{await Fy(Va)}catch(m){console.error("Erro logout:",m)}}}}function aR(i){const[e,t]=Ye.useState(null),[s,o]=Ye.useState(!0),u=i==null?void 0:i.uid;return Ye.useEffect(()=>{let h=!0;if(!u){t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]}),o(!1);return}return(async()=>{try{const y=wo(cs,"users",u,"lista","dados"),v=await Z1(y);if(!h)return;if(v.exists()){const w=v.data();t({modo:String(w.modo||"planejamento").toLowerCase(),estabelecimento:w.estabelecimento||"",tema:w.tema||"claro",itens:(w.itens||[]).map(A=>({...A,precoUnitario:Number(A.precoUnitario||0),quantidade:Number(A.quantidade||1)}))})}else t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]})}catch(y){if(console.error(y),!h)return;t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]})}finally{h&&o(!1)}})(),()=>{h=!1}},[u]),Ye.useEffect(()=>{if(!u||!e||s)return;const h=setTimeout(async()=>{try{await Xu(wo(cs,"users",u,"lista","dados"),{modo:e.modo,estabelecimento:e.estabelecimento,itens:e.itens,tema:e.tema||"claro"})}catch(m){console.error(m)}},400);return()=>clearTimeout(h)},[e,u,s]),{lista:e,setLista:t,loading:s}}function lR(i){const[e,t]=Ye.useState([]),[s,o]=Ye.useState(!0);return Ye.useEffect(()=>{if(!(i!=null&&i.uid))return;(async()=>{try{o(!0);const m=b1(cs,"users",i.uid,"compras"),v=(await eR(m)).docs.map(w=>({id:w.id,...w.data()}));v.sort((w,A)=>new Date(A.data)-new Date(w.data)),t(v)}catch(m){console.error("Erro histórico:",m)}finally{o(!1)}})()},[i==null?void 0:i.uid]),{historico:e,carregando:s,deletarCompra:async h=>{try{await tR(wo(cs,"users",i.uid,"compras",h)),t(m=>m.filter(y=>y.id!==h))}catch(m){console.error("Erro ao deletar compra:",m)}}}}/**
