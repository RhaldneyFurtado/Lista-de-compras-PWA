 ...
 */var km;function BE(){if(km)return Ie;km=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),A=Symbol.iterator;function b(D){return D===null||typeof D!="object"?null:(D=A&&D[A]||D["@@iterator"],typeof D=="function"?D:null)}var z={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,Y={};function G(D,H,we){this.props=D,this.context=H,this.refs=Y,this.updater=we||z}G.prototype.isReactComponent={},G.prototype.setState=function(D,H){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,H,"setState")},G.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function ie(){}ie.prototype=G.prototype;function oe(D,H,we){this.props=D,this.context=H,this.refs=Y,this.updater=we||z}var ye=oe.prototype=new ie;ye.constructor=oe,Z(ye,G.prototype),ye.isPureReactComponent=!0;var Pe=Array.isArray,Me=Object.prototype.hasOwnProperty,Oe={current:null},C={key:!0,ref:!0,__self:!0,__source:!0};function I(D,H,we){var Te,Se={},Ae=null,Fe=null;if(H!=null)for(Te in H.ref!==void 0&&(Fe=H.ref),H.key!==void 0&&(Ae=""+H.key),H)Me.call(H,Te)&&!C.hasOwnProperty(Te)&&(Se[Te]=H[Te]);var De=arguments.length-2;if(De===1)Se.children=we;else if(1<De){for(var ze=Array(De),jt=0;jt<De;jt++)ze[jt]=arguments[jt+2];Se.children=ze}if(D&&D.defaultProps)for(Te in De=D.defaultProps,De)Se[Te]===void 0&&(Se[Te]=De[Te]);return{$$typeof:i,type:D,key:Ae,ref:Fe,props:Se,_owner:Oe.current}}function R(D,H){return{$$typeof:i,type:D.type,key:H,ref:D.ref,props:D.props,_owner:D._owner}}function x(D){return typeof D=="object"&&D!==null&&D.$$typeof===i}function P(D){var H={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(we){return H[we]})}var V=/\/+/g;function S(D,H){return typeof D=="object"&&D!==null&&D.key!=null?P(""+D.key):H.toString(36)}function $e(D,H,we,Te,Se){var Ae=typeof D;(Ae==="undefined"||Ae==="boolean")&&(D=null);var Fe=!1;if(D===null)Fe=!0;else switch(Ae){case"string":case"number":Fe=!0;break;case"object":switch(D.$$typeof){case i:case e:Fe=!0}}if(Fe)return Fe=D,Se=Se(Fe),D=Te===""?"."+S(Fe,0):Te,Pe(Se)?(we="",D!=null&&(we=D.replace(V,"$&/")+"/"),$e(Se,H,we,"",function(jt){return jt})):Se!=null&&(x(Se)&&(Se=R(Se,we+(!Se.key||Fe&&Fe.key===Se.key?"":(""+Se.key).replace(V,"$&/")+"/")+D)),H.push(Se)),1;if(Fe=0,Te=Te===""?".":Te+":",Pe(D))for(var De=0;De<D.length;De++){Ae=D[De];var ze=Te+S(Ae,De);Fe+=$e(Ae,H,we,ze,Se)}else if(ze=b(D),typeof ze=="function")for(D=ze.call(D),De=0;!(Ae=D.next()).done;)Ae=Ae.value,ze=Te+S(Ae,De++),Fe+=$e(Ae,H,we,ze,Se);else if(Ae==="object")throw H=String(D),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.");return Fe}function _t(D,H,we){if(D==null)return D;var Te=[],Se=0;return $e(D,Te,"","",function(Ae){return H.call(we,Ae,Se++)}),Te}function Nt(D){if(D._status===-1){var H=D._result;H=H(),H.then(function(we){(D._status===0||D._status===-1)&&(D._status=1,D._result=we)},function(we){(D._status===0||D._status===-1)&&(D._status=2,D._result=we)}),D._status===-1&&(D._status=0,D._result=H)}if(D._status===1)return D._result.default;throw D._result}var Je={current:null},X={transition:null},ce={ReactCurrentDispatcher:Je,ReactCurrentBatchConfig:X,ReactCurrentOwner:Oe};function ne(){throw Error("act(...) is not supported in production builds of React.")}return Ie.Children={map:_t,forEach:function(D,H,we){_t(D,function(){H.apply(this,arguments)},we)},count:function(D){var H=0;return _t(D,function(){H++}),H},toArray:function(D){return _t(D,function(H){return H})||[]},only:function(D){if(!x(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},Ie.Component=G,Ie.Fragment=t,Ie.Profiler=o,Ie.PureComponent=oe,Ie.StrictMode=s,Ie.Suspense=y,Ie.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ce,Ie.act=ne,Ie.cloneElement=function(D,H,we){if(D==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+D+".");var Te=Z({},D.props),Se=D.key,Ae=D.ref,Fe=D._owner;if(H!=null){if(H.ref!==void 0&&(Ae=H.ref,Fe=Oe.current),H.key!==void 0&&(Se=""+H.key),D.type&&D.type.defaultProps)var De=D.type.defaultProps;for(ze in H)Me.call(H,ze)&&!C.hasOwnProperty(ze)&&(Te[ze]=H[ze]===void 0&&De!==void 0?De[ze]:H[ze])}var ze=arguments.length-2;if(ze===1)Te.children=we;else if(1<ze){De=Array(ze);for(var jt=0;jt<ze;jt++)De[jt]=arguments[jt+2];Te.children=De}return{$$typeof:i,type:D.type,key:Se,ref:Ae,props:Te,_owner:Fe}},Ie.createContext=function(D){return D={$$typeof:h,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},D.Provider={$$typeof:u,_context:D},D.Consumer=D},Ie.createElement=I,Ie.createFactory=function(D){var H=I.bind(null,D);return H.type=D,H},Ie.createRef=function(){return{current:null}},Ie.forwardRef=function(D){return{$$typeof:m,render:D}},Ie.isValidElement=x,Ie.lazy=function(D){return{$$typeof:w,_payload:{_status:-1,_result:D},_init:Nt}},Ie.memo=function(D,H){return{$$typeof:v,type:D,compare:H===void 0?null:H}},Ie.startTransition=function(D){var H=X.transition;X.transition={};try{D()}finally{X.transition=H}},Ie.unstable_act=ne,Ie.useCallback=function(D,H){return Je.current.useCallback(D,H)},Ie.useContext=function(D){return Je.current.useContext(D)},Ie.useDebugValue=function(){},Ie.useDeferredValue=function(D){return Je.current.useDeferredValue(D)},Ie.useEffect=function(D,H){return Je.current.useEffect(D,H)},Ie.useId=function(){return Je.current.useId()},Ie.useImperativeHandle=function(D,H,we){return Je.current.useImperativeHandle(D,H,we)},Ie.useInsertionEffect=function(D,H){return Je.current.useInsertionEffect(D,H)},Ie.useLayoutEffect=function(D,H){return Je.current.useLayoutEffect(D,H)},Ie.useMemo=function(D,H){return Je.current.useMemo(D,H)},Ie.useReducer=function(D,H,we){return Je.current.useReducer(D,H,we)},Ie.useRef=function(D){return Je.current.useRef(D)},Ie.useState=function(D){return Je.current.useState(D)},Ie.useSyncExternalStore=function(D,H,we){return Je.current.useSyncExternalStore(D,H,we)},Ie.useTransition=function(){return Je.current.useTransition()},Ie.version="18.3.1",Ie}var Cm;function Cd(){return Cm||(Cm=1,Bh.exports=BE()),Bh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var xm;function qE(){return xm||(xm=1,(function(i){function e(X,ce){var ne=X.length;X.push(ce);e:for(;0<ne;){var D=ne-1>>>1,H=X[D];if(0<o(H,ce))X[D]=ce,X[ne]=H,ne=D;else break e}}function t(X){return X.length===0?null:X[0]}function s(X){if(X.length===0)return null;var ce=X[0],ne=X.pop();if(ne!==ce){X[0]=ne;e:for(var D=0,H=X.length,we=H>>>1;D<we;){var Te=2*(D+1)-1,Se=X[Te],Ae=Te+1,Fe=X[Ae];if(0>o(Se,ne))Ae<H&&0>o(Fe,Se)?(X[D]=Fe,X[Ae]=ne,D=Ae):(X[D]=Se,X[Te]=ne,D=Te);else if(Ae<H&&0>o(Fe,ne))X[D]=Fe,X[Ae]=ne,D=Ae;else break e}}return ce}function o(X,ce){var ne=X.sortIndex-ce.sortIndex;return ne!==0?ne:X.id-ce.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var y=[],v=[],w=1,A=null,b=3,z=!1,Z=!1,Y=!1,G=typeof setTimeout=="function"?setTimeout:null,ie=typeof clearTimeout=="function"?clearTimeout:null,oe=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ye(X){for(var ce=t(v);ce!==null;){if(ce.callback===null)s(v);else if(ce.startTime<=X)s(v),ce.sortIndex=ce.expirationTime,e(y,ce);else break;ce=t(v)}}function Pe(X){if(Y=!1,ye(X),!Z)if(t(y)!==null)Z=!0,Nt(Me);else{var ce=t(v);ce!==null&&Je(Pe,ce.startTime-X)}}function Me(X,ce){Z=!1,Y&&(Y=!1,ie(I),I=-1),z=!0;var ne=b;try{for(ye(ce),A=t(y);A!==null&&(!(A.expirationTime>ce)||X&&!P());){var D=A.callback;if(typeof D=="function"){A.callback=null,b=A.priorityLevel;var H=D(A.expirationTime<=ce);ce=i.unstable_now(),typeof H=="function"?A.callback=H:A===t(y)&&s(y),ye(ce)}else s(y);A=t(y)}if(A!==null)var we=!0;else{var Te=t(v);Te!==null&&Je(Pe,Te.startTime-ce),we=!1}return we}finally{A=null,b=ne,z=!1}}var Oe=!1,C=null,I=-1,R=5,x=-1;function P(){return!(i.unstable_now()-x<R)}function V(){if(C!==null){var X=i.unstable_now();x=X;var ce=!0;try{ce=C(!0,X)}finally{ce?S():(Oe=!1,C=null)}}else Oe=!1}var S;if(typeof oe=="function")S=function(){oe(V)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,_t=$e.port2;$e.port1.onmessage=V,S=function(){_t.postMessage(null)}}else S=function(){G(V,0)};function Nt(X){C=X,Oe||(Oe=!0,S())}function Je(X,ce){I=G(function(){X(i.unstable_now())},ce)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(X){X.callback=null},i.unstable_continueExecution=function(){Z||z||(Z=!0,Nt(Me))},i.unstable_forceFrameRate=function(X){0>X||125<X?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<X?Math.floor(1e3/X):5},i.unstable_getCurrentPriorityLevel=function(){return b},i.unstable_getFirstCallbackNode=function(){return t(y)},i.unstable_next=function(X){switch(b){case 1:case 2:case 3:var ce=3;break;default:ce=b}var ne=b;b=ce;try{return X()}finally{b=ne}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(X,ce){switch(X){case 1:case 2:case 3:case 4:case 5:break;default:X=3}var ne=b;b=X;try{return ce()}finally{b=ne}},i.unstable_scheduleCallback=function(X,ce,ne){var D=i.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?D+ne:D):ne=D,X){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=ne+H,X={id:w++,callback:ce,priorityLevel:X,startTime:ne,expirationTime:H,sortIndex:-1},ne>D?(X.sortIndex=ne,e(v,X),t(y)===null&&X===t(v)&&(Y?(ie(I),I=-1):Y=!0,Je(Pe,ne-D))):(X.sortIndex=H,e(y,X),Z||z||(Z=!0,Nt(Me))),X},i.unstable_shouldYield=P,i.unstable_wrapCallback=function(X){var ce=b;return function(){var ne=b;b=ce;try{return X.apply(this,arguments)}finally{b=ne}}}})(qh)),qh}var Dm;function WE(){return Dm||(Dm=1,Hh.exports=qE()),Hh.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ou=new Pd("@firebase/auth");function Ow(i,...e){Ou.logLevel<=Re.WARN&&Ou.warn(`Auth (${To}): ${i}`,...e)}function Tu(i,...e){Ou.logLevel<=Re.ERROR&&Ou.error(`Auth (${To}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as=new Pd("@firebase/firestore");function ro(){return as.logLevel}function te(i,...e){if(as.logLevel<=Re.DEBUG){const t=e.map(Bd);as.debug(`Firestore (${So}): ${i}`,...t)}}function Pr(i,...e){if(as.logLevel<=Re.ERROR){const t=e.map(Bd);as.error(`Firestore (${So}): ${i}`,...t)}}function ls(i,...e){if(as.logLevel<=Re.WARN){const t=e.map(Bd);as.warn(`Firestore (${So}): ${i}`,...t)}}function Bd(i){if(typeof i=="string")return i;try{return(function(t){return JSON.stringify(t)})(i)}catch{return i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let s="";for(;s.length<20;){const o=jI(40);for(let u=0;u<o.length;++u)s.length<20&&o[u]<t&&(s+=e.charAt(o[u]%62))}return s}}function ke(i,e){return i<e?-1:i>e?1:0}function fd(i,e){const t=Math.min(i.length,e.length);for(let s=0;s<t;s++){const o=i.charAt(s),u=e.charAt(s);if(o!==u)return Zh(o)===Zh(u)?ke(o,u):Zh(o)?1:-1}return ke(i.length,e.length)}const zI=55296,BI=57343;function Zh(i){const e=i.charCodeAt(0);return e>=zI&&e<=BI}function go(i,e,t){return i.length===e.length&&i.every(((s,o)=>t(s,e[o])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pt{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(o){try{return atob(o)}catch(u){throw typeof DOMException<"u"&&u instanceof DOMException?new u_("Invalid base64 string: "+u):u}})(e);return new Pt(t)}static fromUint8Array(e){const t=(function(o){let u="";for(let h=0;h<o.length;++h)u+=String.fromCharCode(o[h]);return u})(e);return new Pt(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const s=new Uint8Array(t.length);for(let o=0;o<t.length;o++)s[o]=t.charCodeAt(o);return s})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ke(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Pt.EMPTY_BYTE_STRING=new Pt("");const eS=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function wi(i){if(Ue(!!i,39018),typeof i=="string"){let e=0;const t=eS.exec(i);if(Ue(!!t,46558,{timestamp:i}),t[1]){let o=t[1];o=(o+"000000000").substr(0,9),e=Number(o)}const s=new Date(i);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:at(i.seconds),nanos:at(i.nanos)}}function at(i){return typeof i=="number"?i:typeof i=="string"?Number(i):0}function Ti(i){return typeof i=="string"?Pt.fromBase64String(i):Pt.fromUint8Array(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hc{constructor(e,t,s,o,u){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const o=new Map;return o.set(e,Ya.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new hc(_e.min(),o,new tt(ke),Nr(),Ce())}}class Ya{constructor(e,t,s,o,u){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new Ya(s,t,Ce(),Ce(),Ce())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sf{constructor(e,t,s,o){this.targetId=e,this.fromCache=t,this.Ts=s,this.Es=o}static Is(e,t){let s=Ce(),o=Ce();for(const u of t.docChanges)switch(u.type){case 0:s=s.add(u.doc.key);break;case 1:o=o.add(u.doc.key)}return new sf(e,t.fromCache,s,o)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RA{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return m0()?8:YI(Ut())>0?6:4})()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,s,o){const u={result:null};return this.gs(e,t).next((h=>{u.result=h})).next((()=>{if(!u.result)return this.ps(e,t,o,s).next((h=>{u.result=h}))})).next((()=>{if(u.result)return;const h=new AA;return this.ys(e,t,h).next((m=>{if(u.result=m,this.As)return this.ws(e,t,h,m.size)}))})).next((()=>u.result))}ws(e,t,s,o){return s.documentReadCount<this.Vs?(ro()<=Re.DEBUG&&te("QueryEngine","SDK will not create cache indexes for query:",io(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),B.resolve()):(ro()<=Re.DEBUG&&te("QueryEngine","Query:",io(t),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.ds*o?(ro()<=Re.DEBUG&&te("QueryEngine","The SDK decides to create cache indexes for query:",io(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Xn(t))):B.resolve())}gs(e,t){if(Rg(t))return B.resolve(null);let s=Xn(t);return this.indexManager.getIndexType(e,s).next((o=>o===0?null:(t.limit!==null&&o===1&&(t=_d(t,null,"F"),s=Xn(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next((u=>{const h=Ce(...u);return this.fs.getDocuments(e,h).next((m=>this.indexManager.getMinOffset(e,s).next((y=>{const v=this.Ss(t,m);return this.bs(t,v,h,y.readTime)?this.gs(e,_d(t,null,"F")):this.Ds(e,v,t,y)}))))})))))}ps(e,t,s,o){return Rg(t)||o.isEqual(_e.min())?B.resolve(null):this.fs.getDocuments(e,s).next((u=>{const h=this.Ss(t,u);return this.bs(t,h,s,o)?B.resolve(null):(ro()<=Re.DEBUG&&te("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),io(t)),this.Ds(e,h,t,qI(o,Ma)).next((m=>m)))}))}Ss(e,t){let s=new yt(S_(e));return t.forEach(((o,u)=>{lc(e,u)&&(s=s.add(u))})),s}bs(e,t,s,o){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const u=e.limitType==="F"?t.last():t.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}ys(e,t,s){return ro()<=Re.DEBUG&&te("QueryEngine","Using full collection scan to execute query:",io(t)),this.fs.getDocumentsMatchingQuery(e,t,Ei.min(),s)}Ds(e,t,s,o){return this.fs.getDocumentsMatchingQuery(e,s,o).next((u=>(t.forEach((h=>{u=u.insert(h.key,h)})),u)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt="WebChannelConnection",Ia=(i,e,t)=>{i.listen(e,(s=>{try{t(s)}catch(o){setTimeout((()=>{throw o}),0)}}))};class co extends UA{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!co.c_){const e=t_();Ia(e,e_.STAT_EVENT,(t=>{t.stat===dd.PROXY?te(Mt,"STAT_EVENT: detected buffering proxy"):t.stat===dd.NOPROXY&&te(Mt,"STAT_EVENT: detected no buffering proxy")})),co.c_=!0}}zo(e,t,s,o,u){const h=Sd();return new Promise(((m,y)=>{const v=new Xy;v.setWithCredentials(!0),v.listenOnce(Zy.COMPLETE,(()=>{try{switch(v.getLastErrorCode()){case Ru.NO_ERROR:const A=v.getResponseJson();te(Mt,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(A)),m(A);break;case Ru.TIMEOUT:te(Mt,`RPC '${e}' ${h} timed out`),y(new le($.DEADLINE_EXCEEDED,"Request time out"));break;case Ru.HTTP_ERROR:const b=v.getStatus();if(te(Mt,`RPC '${e}' ${h} failed with status:`,b,"response text:",v.getResponseText()),b>0){let z=v.getResponseJson();Array.isArray(z)&&(z=z[0]);const Z=z==null?void 0:z.error;if(Z&&Z.status&&Z.message){const Y=(function(ie){const oe=ie.toLowerCase().replace(/_/g,"-");return Object.values($).indexOf(oe)>=0?oe:$.UNKNOWN})(Z.status);y(new le(Y,Z.message))}else y(new le($.UNKNOWN,"Server responded with status "+v.getStatus()))}else y(new le($.UNAVAILABLE,"Connection failed."));break;default:pe(9055,{l_:e,streamId:h,h_:v.getLastErrorCode(),P_:v.getLastError()})}}finally{te(Mt,`RPC '${e}' ${h} completed.`)}}));const w=JSON.stringify(o);te(Mt,`RPC '${e}' ${h} sending request:`,o),v.send(t,"POST",w,s,15)}))}T_(e,t,s){const o=Sd(),u=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=this.createWebChannelTransport(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},y=this.longPollingOptions.timeoutSeconds;y!==void 0&&(m.longPollingTimeout=Math.round(1e3*y)),this.useFetchStreams&&(m.useFetchStreams=!0),this.Go(m.initMessageHeaders,t,s),m.encodeInitMessageHeaders=!0;const v=u.join("");te(Mt,`Creating RPC '${e}' stream ${o}: ${v}`,m);const w=h.createWebChannel(v,m);this.E_(w);let A=!1,b=!1;const z=new jA({Jo:Z=>{b?te(Mt,`Not sending because RPC '${e}' stream ${o} is closed:`,Z):(A||(te(Mt,`Opening RPC '${e}' stream ${o} transport.`),w.open(),A=!0),te(Mt,`RPC '${e}' stream ${o} sending:`,Z),w.send(Z))},Ho:()=>w.close()});return Ia(w,Sa.EventType.OPEN,(()=>{b||(te(Mt,`RPC '${e}' stream ${o} transport opened.`),z.i_())})),Ia(w,Sa.EventType.CLOSE,(()=>{b||(b=!0,te(Mt,`RPC '${e}' stream ${o} transport closed`),z.o_(),this.I_(w))})),Ia(w,Sa.EventType.ERROR,(Z=>{b||(b=!0,ls(Mt,`RPC '${e}' stream ${o} transport errored. Name:`,Z.name,"Message:",Z.message),z.o_(new le($.UNAVAILABLE,"The operation could not be completed")))})),Ia(w,Sa.EventType.MESSAGE,(Z=>{var Y;if(!b){const G=Z.data[0];Ue(!!G,16349);const ie=G,oe=(ie==null?void 0:ie.error)||((Y=ie[0])==null?void 0:Y.error);if(oe){te(Mt,`RPC '${e}' stream ${o} received error:`,oe);const ye=oe.status;let Pe=(function(C){const I=ht[C];if(I!==void 0)return L_(I)})(ye),Me=oe.message;ye==="NOT_FOUND"&&Me.includes("database")&&Me.includes("does not exist")&&Me.includes(this.databaseId.database)&&ls(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),Pe===void 0&&(Pe=$.INTERNAL,Me="Unknown error status: "+ye+" with message "+oe.message),b=!0,z.o_(new le(Pe,Me)),w.close()}else te(Mt,`RPC '${e}' stream ${o} received:`,G),z.__(G)}})),co.u_(),setTimeout((()=>{z.s_()}),0),z}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,s){super.Go(e,t,s),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return n_()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class av{constructor(e){this.key=e}}class lv{constructor(e){this.key=e}}class cR{constructor(e,t){this.query=e,this.Za=t,this.Xa=null,this.hasCachedResults=!1,this.current=!1,this.Ya=Ce(),this.mutatedKeys=Ce(),this.eu=S_(e),this.tu=new ho(this.eu)}get nu(){return this.Za}ru(e,t){const s=t?t.iu:new qg,o=t?t.tu:this.tu;let u=t?t.mutatedKeys:this.mutatedKeys,h=o,m=!1;const y=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,v=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(e.inorderTraversal(((w,A)=>{const b=o.get(w),z=lc(this.query,A)?A:null,Z=!!b&&this.mutatedKeys.has(b.key),Y=!!z&&(z.hasLocalMutations||this.mutatedKeys.has(z.key)&&z.hasCommittedMutations);let G=!1;b&&z?b.data.isEqual(z.data)?Z!==Y&&(s.track({type:3,doc:z}),G=!0):this.su(b,z)||(s.track({type:2,doc:z}),G=!0,(y&&this.eu(z,y)>0||v&&this.eu(z,v)<0)&&(m=!0)):!b&&z?(s.track({type:0,doc:z}),G=!0):b&&!z&&(s.track({type:1,doc:b}),G=!0,(y||v)&&(m=!0)),G&&(z?(h=h.add(z),u=Y?u.add(w):u.delete(w)):(h=h.delete(w),u=u.delete(w)))})),this.query.limit!==null)for(;h.size>this.query.limit;){const w=this.query.limitType==="F"?h.last():h.first();h=h.delete(w.key),u=u.delete(w.key),s.track({type:1,doc:w})}return{tu:h,iu:s,bs:m,mutatedKeys:u}}su(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,s,o){const u=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const h=e.iu.ya();h.sort(((w,A)=>(function(z,Z){const Y=G=>{switch(G){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return pe(20277,{Vt:G})}};return Y(z)-Y(Z)})(w.type,A.type)||this.eu(w.doc,A.doc))),this.ou(s),o=o??!1;const m=t&&!o?this._u():[],y=this.Ya.size===0&&this.current&&!o?1:0,v=y!==this.Xa;return this.Xa=y,h.length!==0||v?{snapshot:new Eo(this.query,e.tu,u,h,e.mutatedKeys,y===0,v,!1,!!s&&s.resumeToken.approximateByteSize()>0),au:m}:{au:m}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new qg,mutatedKeys:this.mutatedKeys,bs:!1},!1)):{au:[]}}uu(e){return!this.Za.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach((t=>this.Za=this.Za.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Za=this.Za.delete(t))),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Ya;this.Ya=Ce(),this.tu.forEach((s=>{this.uu(s.key)&&(this.Ya=this.Ya.add(s.key))}));const t=[];return e.forEach((s=>{this.Ya.has(s)||t.push(new lv(s))})),this.Ya.forEach((s=>{e.has(s)||t.push(new av(s))})),t}cu(e){this.Za=e.ks,this.Ya=Ce();const t=this.ru(e.documents);return this.applyChanges(t,!0)}lu(){return Eo.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Xa===0,this.hasCachedResults)}}const pf="SyncEngine";class hR{constructor(e,t,s){this.query=e,this.targetId=t,this.view=s}}class dR{constructor(e){this.key=e,this.hu=!1}}class fR{constructor(e,t,s,o,u,h){this.localStore=e,this.remoteStore=t,this.eventManager=s,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=h,this.Pu={},this.Tu=new ds((m=>I_(m)),ac),this.Eu=new Map,this.Iu=new Set,this.Ru=new tt(he.comparator),this.Au=new Map,this.Vu=new nf,this.du={},this.mu=new Map,this.fu=vo.ar(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function pR(i,e,t=!0){const s=pv(i);let o;const u=s.Tu.get(e);return u?(s.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.lu()):o=await uv(s,e,t,!0),o}async function mR(i,e){const t=pv(i);await uv(t,e,!0,!1)}async function uv(i,e,t,s){const o=await OA(i.localStore,Xn(e)),u=o.targetId,h=i.sharedClientState.addLocalQueryTarget(u,t);let m;return s&&(m=await gR(i,e,u,h==="current",o.resumeToken)),i.isPrimaryClient&&t&&X_(i.remoteStore,o),m}async function gR(i,e,t,s,o){i.pu=(A,b,z)=>(async function(Y,G,ie,oe){let ye=G.view.ru(ie);ye.bs&&(ye=await Ug(Y.localStore,G.query,!1).then((({documents:C})=>G.view.ru(C,ye))));const Pe=oe&&oe.targetChanges.get(G.targetId),Me=oe&&oe.targetMismatches.get(G.targetId)!=null,Oe=G.view.applyChanges(ye,Y.isPrimaryClient,Pe,Me);return Qg(Y,G.targetId,Oe.au),Oe.snapshot})(i,A,b,z);const u=await Ug(i.localStore,e,!0),h=new cR(e,u.ks),m=h.ru(u.documents),y=Ya.createSynthesizedTargetChangeForCurrentChange(t,s&&i.onlineState!=="Offline",o),v=h.applyChanges(m,i.isPrimaryClient,y);Qg(i,t,v.au);const w=new hR(e,t,h);return i.Tu.set(e,w),i.Eu.has(t)?i.Eu.get(t).push(e):i.Eu.set(t,[e]),v.snapshot}async function yR(i,e,t){const s=Ee(i),o=s.Tu.get(e),u=s.Eu.get(o.targetId);if(u.length>1)return s.Eu.set(o.targetId,u.filter((h=>!ac(h,e)))),void s.Tu.delete(e);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(o.targetId),s.sharedClientState.isActiveQueryTarget(o.targetId)||await Id(s.localStore,o.targetId,!1).then((()=>{s.sharedClientState.clearQueryState(o.targetId),t&&af(s.remoteStore,o.targetId),Rd(s,o.targetId)})).catch(Ao)):(Rd(s,o.targetId),await Id(s.localStore,o.targetId,!0))}async function _R(i,e){const t=Ee(i),s=t.Tu.get(e),o=t.Eu.get(s.targetId);t.isPrimaryClient&&o.length===1&&(t.sharedClientState.removeLocalQueryTarget(s.targetId),af(t.remoteStore,s.targetId))}async function vR(i,e,t){const s=RR(i);try{const o=await(function(h,m){const y=Ee(h),v=Qe.now(),w=m.reduce(((z,Z)=>z.add(Z.key)),Ce());let A,b;return y.persistence.runTransaction("Locally write mutations","readwrite",(z=>{let Z=Nr(),Y=Ce();return y.xs.getEntries(z,w).next((G=>{Z=G,Z.forEach(((ie,oe)=>{oe.isValidDocument()||(Y=Y.add(ie))}))})).next((()=>y.localDocuments.getOverlayedDocuments(z,Z))).next((G=>{A=G;const ie=[];for(const oe of m){const ye=VS(oe,A.get(oe.key).overlayedDocument);ye!=null&&ie.push(new fs(oe.key,ye,g_(ye.value.mapValue),Zn.exists(!0)))}return y.mutationQueue.addMutationBatch(z,v,ie,m)})).next((G=>{b=G;const ie=G.applyToLocalDocumentSet(A,Y);return y.documentOverlayCache.saveOverlays(z,G.batchId,ie)}))})).then((()=>({batchId:b.batchId,changes:R_(A)})))})(s.localStore,e);s.sharedClientState.addPendingMutation(o.batchId),(function(h,m,y){let v=h.du[h.currentUser.toKey()];v||(v=new tt(ke)),v=v.insert(m,y),h.du[h.currentUser.toKey()]=v})(s,o.batchId,t),await Xa(s,o.changes),await pc(s.remoteStore)}catch(o){const u=df(o,"Failed to persist write");t.reject(u)}}async function cv(i,e){const t=Ee(i);try{const s=await xA(t.localStore,e);e.targetChanges.forEach(((o,u)=>{const h=t.Au.get(u);h&&(Ue(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?h.hu=!0:o.modifiedDocuments.size>0?Ue(h.hu,14607):o.removedDocuments.size>0&&(Ue(h.hu,42227),h.hu=!1))})),await Xa(t,s,e)}catch(s){await Ao(s)}}function Gg(i,e,t){const s=Ee(i);if(s.isPrimaryClient&&t===0||!s.isPrimaryClient&&t===1){const o=[];s.Tu.forEach(((u,h)=>{const m=h.view.va(e);m.snapshot&&o.push(m.snapshot)})),(function(h,m){const y=Ee(h);y.onlineState=m;let v=!1;y.queries.forEach(((w,A)=>{for(const b of A.Sa)b.va(m)&&(v=!0)})),v&&ff(y)})(s.eventManager,e),o.length&&s.Pu.H_(o),s.onlineState=e,s.isPrimaryClient&&s.sharedClientState.setOnlineState(e)}}async function ER(i,e,t){const s=Ee(i);s.sharedClientState.updateQueryState(e,"rejected",t);const o=s.Au.get(e),u=o&&o.key;if(u){let h=new tt(he.comparator);h=h.insert(u,Ft.newNoDocument(u,_e.min()));const m=Ce().add(u),y=new hc(_e.min(),new Map,new tt(ke),h,m);await cv(s,y),s.Ru=s.Ru.remove(u),s.Au.delete(e),mf(s)}else await Id(s.localStore,e,!1).then((()=>Rd(s,e,t))).catch(Ao)}async function wR(i,e){const t=Ee(i),s=e.batch.batchId;try{const o=await NA(t.localStore,e);dv(t,s,null),hv(t,s),t.sharedClientState.updateMutationState(s,"acknowledged"),await Xa(t,o)}catch(o){await Ao(o)}}async function TR(i,e,t){const s=Ee(i);try{const o=await(function(h,m){const y=Ee(h);return y.persistence.runTransaction("Reject batch","readwrite-primary",(v=>{let w;return y.mutationQueue.lookupMutationBatch(v,m).next((A=>(Ue(A!==null,37113),w=A.keys(),y.mutationQueue.removeMutationBatch(v,A)))).next((()=>y.mutationQueue.performConsistencyCheck(v))).next((()=>y.documentOverlayCache.removeOverlaysForBatchId(v,w,m))).next((()=>y.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(v,w))).next((()=>y.localDocuments.getDocuments(v,w)))}))})(s.localStore,e);dv(s,e,t),hv(s,e),s.sharedClientState.updateMutationState(e,"rejected",t),await Xa(s,o)}catch(o){await Ao(o)}}function hv(i,e){(i.mu.get(e)||[]).forEach((t=>{t.resolve()})),i.mu.delete(e)}function dv(i,e,t){const s=Ee(i);let o=s.du[s.currentUser.toKey()];if(o){const u=o.get(e);u&&(t?u.reject(t):u.resolve(),o=o.remove(e)),s.du[s.currentUser.toKey()]=o}}function Rd(i,e,t=null){i.sharedClientState.removeLocalQueryTarget(e);for(const s of i.Eu.get(e))i.Tu.delete(s),t&&i.Pu.yu(s,t);i.Eu.delete(e),i.isPrimaryClient&&i.Vu.Gr(e).forEach((s=>{i.Vu.containsKey(s)||fv(i,s)}))}function fv(i,e){i.Iu.delete(e.path.canonicalString());const t=i.Ru.get(e);t!==null&&(af(i.remoteStore,t),i.Ru=i.Ru.remove(e),i.Au.delete(t),mf(i))}function Qg(i,e,t){for(const s of t)s instanceof av?(i.Vu.addReference(s.key,e),IR(i,s)):s instanceof lv?(te(pf,"Document no longer in limbo: "+s.key),i.Vu.removeReference(s.key,e),i.Vu.containsKey(s.key)||fv(i,s.key)):pe(19791,{wu:s})}function IR(i,e){const t=e.key,s=t.path.canonicalString();i.Ru.get(t)||i.Iu.has(s)||(te(pf,"New document in limbo: "+t),i.Iu.add(s),mf(i))}function mf(i){for(;i.Iu.size>0&&i.Ru.size<i.maxConcurrentLimboResolutions;){const e=i.Iu.values().next().value;i.Iu.delete(e);const t=new he(Ge.fromString(e)),s=i.fu.next();i.Au.set(s,new dR(t)),i.Ru=i.Ru.insert(t,s),X_(i.remoteStore,new fi(Xn(Yd(t.path)),s,"TargetPurposeLimboResolution",rc.ce))}}async function Xa(i,e,t){const s=Ee(i),o=[],u=[],h=[];s.Tu.isEmpty()||(s.Tu.forEach(((m,y)=>{h.push(s.pu(y,e,t).then((v=>{var w;if((v||t)&&s.isPrimaryClient){const A=v?!v.fromCache:(w=t==null?void 0:t.targetChanges.get(y.targetId))==null?void 0:w.current;s.sharedClientState.updateQueryState(y.targetId,A?"current":"not-current")}if(v){o.push(v);const A=sf.Is(y.targetId,v);u.push(A)}})))})),await Promise.all(h),s.Pu.H_(o),await(async function(y,v){const w=Ee(y);try{await w.persistence.runTransaction("notifyLocalViewChanges","readwrite",(A=>B.forEach(v,(b=>B.forEach(b.Ts,(z=>w.persistence.referenceDelegate.addReference(A,b.targetId,z))).next((()=>B.forEach(b.Es,(z=>w.persistence.referenceDelegate.removeReference(A,b.targetId,z)))))))))}catch(A){if(!Ro(A))throw A;te(of,"Failed to update sequence numbers: "+A)}for(const A of v){const b=A.targetId;if(!A.fromCache){const z=w.vs.get(b),Z=z.snapshotVersion,Y=z.withLastLimboFreeSnapshotVersion(Z);w.vs=w.vs.insert(b,Y)}}})(s.localStore,u))}async function SR(i,e){const t=Ee(i);if(!t.currentUser.isEqual(e)){te(pf,"User change. New user:",e.toKey());const s=await G_(t.localStore,e);t.currentUser=e,(function(u,h){u.mu.forEach((m=>{m.forEach((y=>{y.reject(new le($.CANCELLED,h))}))})),u.mu.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,s.removedBatchIds,s.addedBatchIds),await Xa(t,s.Ns)}}function AR(i,e){const t=Ee(i),s=t.Au.get(e);if(s&&s.hu)return Ce().add(s.key);{let o=Ce();const u=t.Eu.get(e);if(!u)return o;for(const h of u){const m=t.Tu.get(h);o=o.unionWith(m.view.nu)}return o}}function pv(i){const e=Ee(i);return e.remoteStore.remoteSyncer.applyRemoteEvent=cv.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=AR.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=ER.bind(null,e),e.Pu.H_=lR.bind(null,e.eventManager),e.Pu.yu=uR.bind(null,e.eventManager),e}function RR(i){const e=Ee(i);return e.remoteStore.remoteSyncer.applySuccessfulWrite=wR.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=TR.bind(null,e),e}class Yu{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=dc(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,t){return null}Mu(e,t){return null}vu(e){return PA(this.persistence,new RA,e.initialUser,this.serializer)}Cu(e){return new K_(rf.Vi,this.serializer)}Du(e){return new MA}async terminate(){var e,t;(e=this.gcScheduler)==null||e.stop(),(t=this.indexBackfillerScheduler)==null||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Yu.provider={build:()=>new Yu};class kR extends Yu{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,t){Ue(this.persistence.referenceDelegate instanceof Gu,46915);const s=this.persistence.referenceDelegate.garbageCollector;return new hA(s,e.asyncQueue,t)}Cu(e){const t=this.cacheSizeBytes!==void 0?Qt.withCacheSize(this.cacheSizeBytes):Qt.DEFAULT;return new K_((s=>Gu.Vi(s,t)),this.serializer)}}class kd{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>Gg(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=SR.bind(null,this.syncEngine),await sR(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new aR})()}createDatastore(e){const t=dc(e.databaseInfo.databaseId),s=zA(e.databaseInfo);return WA(e.authCredentials,e.appCheckCredentials,s,t)}createRemoteStore(e){return(function(s,o,u,h,m){return new GA(s,o,u,h,m)})(this.localStore,this.datastore,e.asyncQueue,(t=>Gg(this.syncEngine,t,0)),(function(){return Bg.v()?new Bg:new bA})())}createSyncEngine(e,t){return(function(o,u,h,m,y,v,w){const A=new fR(o,u,h,m,y,v);return w&&(A.gu=!0),A})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await(async function(o){const u=Ee(o);te(us,"RemoteStore shutting down."),u.Ia.add(5),await Ja(u),u.Aa.shutdown(),u.Va.set("Unknown")})(this.remoteStore),(e=this.datastore)==null||e.terminate(),(t=this.eventManager)==null||t.terminate()}}kd.provider={build:()=>new kd};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OR="ComponentProvider",Jg=new Map;function LR(i,e,t,s,o){return new tS(i,e,t,o.host,o.ssl,o.experimentalForceLongPolling,o.experimentalAutoDetectLongPolling,_v(o.experimentalLongPollingOptions),o.useFetchStreams,o.isUsingEmulator,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+i.stack),e}class Za extends mc{constructor(e,t,s,o){super(e,t,s,o),this.type="firestore",this._queue=new ty,this._persistenceKey=(o==null?void 0:o.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new ty(e),this._firestoreClient=void 0,await e}}}function FR(i,e){const t=typeof i=="object"?i:gy(),s=typeof i=="string"?i:zu,o=xd(t,"firestore").getImmediate({identifier:s});if(!o._initialized){const u=o0("firestore");u&&MR(o,...u)}return o}function gf(i){if(i._terminated)throw new le($.FAILED_PRECONDITION,"The client has already been terminated.");return i._firestoreClient||UR(i),i._firestoreClient}function UR(i){var s,o,u,h;const e=i._freezeSettings(),t=LR(i._databaseId,((s=i._app)==null?void 0:s.options.appId)||"",i._persistenceKey,(o=i._app)==null?void 0:o.options.apiKey,e);i._componentsProvider||(u=e.localCache)!=null&&u._offlineComponentProvider&&((h=e.localCache)!=null&&h._onlineComponentProvider)&&(i._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),i._firestoreClient=new CR(i._authCredentials,i._appCheckCredentials,i._queue,t,i._componentsProvider&&(function(y){const v=y==null?void 0:y._online.build();return{_offline:y==null?void 0:y._offline.build(v),_online:v}})(i._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tr{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new le($.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new le($.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return ke(this._lat,e._lat)||ke(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:tr._jsonSchemaVersion}}static fromJSON(e){if(Ga(e,tr._jsonSchema))return new tr(e.latitude,e.longitude)}}tr._jsonSchemaVersion="firestore/geoPoint/1.0",tr._jsonSchema={type:dt("string",tr._jsonSchemaVersion),latitude:dt("number"),longitude:dt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jR=/^__.*__$/;class zR{constructor(e,t,s){this.data=e,this.fieldMask=t,this.fieldTransforms=s}toMutation(e,t){return this.fieldMask!==null?new fs(e,this.data,this.fieldMask,t,this.fieldTransforms):new Qa(e,this.data,t,this.fieldTransforms)}}function Tv(i){switch(i){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw pe(40011,{dataSource:i})}}class yf{constructor(e,t,s,o,u,h){this.settings=e,this.databaseId=t,this.serializer=s,this.ignoreUndefinedProperties=o,u===void 0&&this.Ac(),this.fieldTransforms=u||[],this.fieldMask=h||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new yf({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),s=this.i({path:t,arrayElement:!1});return s.mc(e),s}fc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),s=this.i({path:t,arrayElement:!1});return s.Ac(),s}gc(e){return this.i({path:void 0,arrayElement:!0})}yc(e){return Ju(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.mc(this.path.get(e))}mc(e){if(e.length===0)throw this.yc("Document fields must not be empty");if(Tv(this.dataSource)&&jR.test(e))throw this.yc('Document fields cannot begin and end with "__"')}}class BR{constructor(e,t,s){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=s||dc(e)}I(e,t,s,o=!1){return new yf({dataSource:e,methodName:t,targetDoc:s,path:Ct.emptyPath(),arrayElement:!1,hasConverter:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function $R(i){const e=i._freezeSettings(),t=dc(i._databaseId);return new BR(i._databaseId,!!e.ignoreUndefinedProperties,t)}function HR(i,e,t,s,o,u={}){const h=i.I(u.merge||u.mergeFields?2:0,e,t,o);Rv("Data must be an object, but it was:",h,s);const m=Sv(s,h);let y,v;if(u.merge)y=new Pn(h.fieldMask),v=h.fieldTransforms;else if(u.mergeFields){const w=[];for(const A of u.mergeFields){const b=_f(e,A,t);if(!h.contains(b))throw new le($.INVALID_ARGUMENT,`Field '${b}' is specified in your field mask but missing from your input data.`);KR(w,b)||w.push(b)}y=new Pn(w),v=h.fieldTransforms.filter((A=>y.covers(A.field)))}else y=null,v=h.fieldTransforms;return new zR(new mn(m),y,v)}function Iv(i,e){if(Av(i=Yt(i)))return Rv("Unsupported field value:",e,i),Sv(i,e);if(i instanceof wv)return(function(s,o){if(!Tv(o.dataSource))throw o.yc(`${s._methodName}() can only be used with update() and set()`);if(!o.path)throw o.yc(`${s._methodName}() is not currently supported inside arrays`);const u=s._toFieldTransform(o);u&&o.fieldTransforms.push(u)})(i,e),null;if(i===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),i instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.yc("Nested arrays are not supported");return(function(s,o){const u=[];let h=0;for(const m of s){let y=Iv(m,o.gc(h));y==null&&(y={nullValue:"NULL_VALUE"}),u.push(y),h++}return{arrayValue:{values:u}}})(i,e)}return(function(s,o){if((s=Yt(s))===null)return{nullValue:"NULL_VALUE"};if(typeof s=="number")return kS(o.serializer,s);if(typeof s=="boolean")return{booleanValue:s};if(typeof s=="string")return{stringValue:s};if(s instanceof Date){const u=Qe.fromDate(s);return{timestampValue:Ku(o.serializer,u)}}if(s instanceof Qe){const u=new Qe(s.seconds,1e3*Math.floor(s.nanoseconds/1e3));return{timestampValue:Ku(o.serializer,u)}}if(s instanceof tr)return{geoPointValue:{latitude:s.latitude,longitude:s.longitude}};if(s instanceof gn)return{bytesValue:F_(o.serializer,s._byteString)};if(s instanceof gt){const u=o.databaseId,h=s.firestore._databaseId;if(!h.isEqual(u))throw o.yc(`Document reference is for database ${h.projectId}/${h.database} but should be for database ${u.projectId}/${u.database}`);return{referenceValue:tf(s.firestore._databaseId||o.databaseId,s._key.path)}}if(s instanceof xn)return(function(h,m){const y=h instanceof xn?h.toArray():h;return{mapValue:{fields:{[p_]:{stringValue:m_},[Bu]:{arrayValue:{values:y.map((w=>{if(typeof w!="number")throw m.yc("VectorValues must only contain numeric values.");return Jd(m.serializer,w)}))}}}}}})(s,o);if(q_(s))return s._toProto(o.serializer);throw o.yc(`Unsupported field value: ${Hd(s)}`)})(i,e)}function Sv(i,e){const t={};return l_(i)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):hs(i,((s,o)=>{const u=Iv(o,e.dc(s));u!=null&&(t[s]=u)})),{mapValue:{fields:t}}}function Av(i){return!(typeof i!="object"||i===null||i instanceof Array||i instanceof Date||i instanceof Qe||i instanceof tr||i instanceof gn||i instanceof gt||i instanceof wv||i instanceof xn||q_(i))}function Rv(i,e,t){if(!Av(t)||!o_(t)){const s=Hd(t);throw s==="an object"?e.yc(i+" a custom object"):e.yc(i+" "+s)}}function _f(i,e,t){if((e=Yt(e))instanceof Ev)return e._internalPath;if(typeof e=="string")return WR(i,e);throw Ju("Field path arguments must be of type string or ",i,!1,void 0,t)}const qR=new RegExp("[~\\*/\\[\\]]");function WR(i,e,t){if(e.search(qR)>=0)throw Ju(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,i,!1,void 0,t);try{return new Ev(...e.split("."))._internalPath}catch{throw Ju(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i,!1,void 0,t)}}function Ju(i,e,t,s,o){const u=s&&!s.isEmpty(),h=o!==void 0;let m=`Function ${e}() called with invalid data`;t&&(m+=" (via `toFirestore()`)"),m+=". ";let y="";return(u||h)&&(y+=" (found",u&&(y+=` in field ${s}`),h&&(y+=` in document ${o}`),y+=")"),new le($.INVALID_ARGUMENT,m+i+y)}function KR(i,e){return i.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kv extends GR{constructor(e){super(),this.firestore=e}convertBytes(e){return new gn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new gt(this.firestore,null,t)}}const ry="@firebase/firestore",iy="4.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZR(i){i=vi(i,gt);const e=vi(i.firestore,Za),t=gf(e);return xR(t,i._key).then((s=>n1(e,i,s)))}function e1(i){i=vi(i,gc);const e=vi(i.firestore,Za),t=gf(e),s=new kv(e);return YR(i._query),DR(t,i._query).then((o=>new fo(e,s,i,o)))}function Xu(i,e,t){i=vi(i,gt);const s=vi(i.firestore,Za),o=JR(i.converter,e,t),u=$R(s);return Pv(s,[HR(u,"setDoc",i._key,o,i.converter!==null,t).toMutation(i._key,Zn.none())])}function t1(i){return Pv(vi(i.firestore,Za),[new Xd(i._key,Zn.none())])}function Pv(i,e){const t=gf(i);return VR(t,e)}function n1(i,e,t){const s=t.docs.get(e._key),o=new kv(i);return new rs(i,o,e._key,s,new ka(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){VI(To),po(new ss("firestore",((s,{instanceIdentifier:o,options:u})=>{const h=s.getProvider("app").getImmediate(),m=new Za(new MI(s.getProvider("auth-internal")),new UI(h,s.getProvider("app-check-internal")),nS(h,o),h);return u={useFetchStreams:t,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),gi(ry,iy,e),gi(ry,iy,"esm2020")})();var r1="firebase",i1="12.12.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gi(r1,i1,"app");const s1={apiKey:"AIzaSyBN-jgFWi10Onb0atB7ty24IhfRSMMxulU",authDomain:"lista-de-compras-pwa-64fac.firebaseapp.com",projectId:"lista-de-compras-pwa-64fac",storageBucket:"lista-de-compras-pwa-64fac.appspot.com",messagingSenderId:"922020197463",appId:"1:922020197463:web:41e9aa3c04bf76c7941f12"},Nv=my(s1),Va=xI(Nv);_T(Va,zy);const xv=new Ir;xv.setCustomParameters({prompt:"select_account"});const cs=FR(Nv);function o1(){const[i,e]=Ye.useState(null),[t,s]=Ye.useState(!0),o=async m=>{if(m)try{await Xu(wo(cs,"users",m.uid),{nome:m.displayName||"Usuário",email:m.email||"",foto:m.photoURL||"",ultimoLogin:new Date().toISOString()},{merge:!0})}catch(y){console.error("Erro ao salvar usuário:",y)}};return Ye.useEffect(()=>{const m=wT(Va,async y=>{e(y||null),y&&await o(y),s(!1)});return()=>m()},[]),{usuario:i,loading:t,entrarComGoogle:async()=>{try{await jT(Va,xv)}catch(m){console.error("Erro login Google:",m)}},sair:async()=>{try{await Fy(Va)}catch(m){console.error("Erro logout:",m)}}}}function a1(i){const[e,t]=Ye.useState(null),[s,o]=Ye.useState(!0),u=i==null?void 0:i.uid;return Ye.useEffect(()=>{if(!u){t(null),o(!1);return}(async()=>{o(!0);try{const m=wo(cs,"users",u,"lista","dados"),y=await ZR(m);if(y.exists()){const v=y.data();t({modo:String(v.modo||"planejamento").toLowerCase().trim(),estabelecimento:v.estabelecimento||"",tema:v.tema||"claro",itens:(v.itens||[]).map(w=>({...w,precoUnitario:Number(w.precoUnitario||0),quantidade:Number(w.quantidade||1)}))})}else t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]})}catch(m){console.error(m),t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]})}finally{o(!1)}})()},[u]),Ye.useEffect(()=>{if(!u||!e||s)return;const h=setTimeout(async()=>{try{const m=wo(cs,"users",u,"lista","dados");await Xu(m,{modo:e.modo,estabelecimento:e.estabelecimento,itens:e.itens,tema:e.tema||"claro"})}catch(m){console.error(m)}},300);return()=>clearTimeout(h)},[e,u,s]),{lista:e,setLista:t,loading:s}}function l1(i){const[e,t]=Ye.useState([]),[s,o]=Ye.useState(!0);return Ye.useEffect(()=>{if(!(i!=null&&i.uid))return;(async()=>{try{o(!0);const m=bR(cs,"users",i.uid,"compras"),v=(await e1(m)).docs.map(w=>({id:w.id,...w.data()}));v.sort((w,A)=>new Date(A.data)-new Date(w.data)),t(v)}catch(m){console.error("Erro histórico:",m)}finally{o(!1)}})()},[i==null?void 0:i.uid]),{historico:e,carregando:s,deletarCompra:async h=>{try{await t1(wo(cs,"users",i.uid,"compras",h)),t(m=>m.filter(y=>y.id!==h))}catch(m){console.error("Erro ao deletar compra:",m)}}}}/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u1=i=>i.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),c1=i=>i.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,s)=>s?s.toUpperCase():t.toLowerCase()),sy=i=>{const e=c1(i);return e.charAt(0).toUpperCase()+e.slice(1)},Dv=(...i)=>i.filter((e,t,s)=>!!e&&e.trim()!==""&&s.indexOf(e)===t).join(" ").trim(),h1=i=>{for(const e in i)if(e.startsWith("aria-")||e==="role"||e==="title")return!0};/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f1=Ye.forwardRef(({color:i="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:s,className:o="",children:u,iconNode:h,...m},y)=>Ye.createElement("svg",{ref:y,...d1,width:e,height:e,stroke:i,strokeWidth:s?Number(t)*24/Number(e):t,className:Dv("lucide",o),...!u&&!h1(m)&&{"aria-hidden":"true"},...m},[...h.map(([v,w])=>Ye.createElement(v,w)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dr=(i,e)=>{const t=Ye.forwardRef(({className:s,...o},u)=>Ye.createElement(f1,{ref:u,iconNode:e,className:Dv(`lucide-${u1(sy(i))}`,`lucide-${i}`,s),...o}));return t.displayName=sy(i),t};/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R1=[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]],Vv=Dr("shopping-cart",R1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k1=[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]],yc=Dr("trash-2",k1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C1=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],P1=Dr("user",C1);function N1({estabelecimento:i,aoDefinirEstabelecimento:e,aoLimpar:t,usuario:s,aoLogout:o,tema:u,aoDefinirTema:h}){const m=u||"claro";return j.jsx("header",{className:"w-full bg-emerald-600 text-white shadow-lg",children:j.jsx("div",{className:"w-full px-4 pt-6 pb-6",children:j.jsxs("div",{className:"mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",children:[j.jsxs("div",{className:"flex items-center gap-3",children:[j.jsx("div",{className:"rounded-2xl bg-emerald-700 p-3 shadow-md",children:j.jsx(Vv,{className:"text-white",size:30})}),j.jsxs("div",{children:[j.jsx("h1",{className:"text-2xl sm:text-3xl font-bold leading-tight",children:"Lista de Compras"}),j.jsx("p",{className:"text-xs sm:text-sm text-emerald-100",children:"Organize suas compras"})]})]}),j.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-3 sm:ml-auto",children:[j.jsx("button",{onClick:()=>{const y=m==="escuro"?"claro":"escuro";h==null||h(y)},className:"rounded-xl bg-emerald-700 p-3 transition hover:bg-emerald-800",title:"Tema",children:m==="escuro"?"☀️":"🌙"}),j.jsx("div",{className:"flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-white bg-emerald-700 shadow",children:s!=null&&s.photoURL?j.jsx("img",{src:s.photoURL,alt:"Usuário",className:"h-full w-full object-cover",referrerPolicy:"no-referrer"}):j.jsx(P1,{size:20})}),j.jsx("button",{onClick:o,className:"rounded-xl bg-emerald-700 p-3 transition hover:bg-emerald-800",title:"Sair",children:j.jsx(I1,{size:20})}),j.jsx("button",{onClick:t,className:"rounded-xl bg-emerald-700 p-3 transition hover:bg-emerald-800",title:"Limpar lista",children:j.jsx(yc,{size:20})})]})]})})})}function x1({modo:i,aoAlternar:e}){return j.jsx("div",{className:"rounded-xl shadow-md p-2 mb-4 bg-white dark:bg-slate-800",children:j.jsxs("div",{className:"flex gap-2",children:[j.jsxs("button",{onClick:()=>e("planejamento"),className:`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${i==="planejamento"?"bg-emerald-500 text-white shadow-md":"bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-slate-600"}`,children:[j.jsx(w1,{size:20}),j.jsx("span",{children:"Planejamento"})]}),j.jsxs("button",{onClick:()=>e("feira"),className:`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${i==="feira"?"bg-emerald-500 text-white shadow-md":"bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-slate-600"}`,children:[j.jsx(Vv,{size:20}),j.jsx("span",{children:"Na Feira"})]})]})})}function D1({aoAdicionar:i}){const[e,t]=Ye.useState(""),[s,o]=Ye.useState(1);function u(h){h.preventDefault();const m=e.trim().slice(0,80),y=Math.max(1,Math.min(999,Number(s)||1));m&&(i({nome:m,quantidade:y}),t(""),o(1))}return j.jsxs("form",{onSubmit:u,className:"mb-4 flex gap-2",children:[j.jsx("input",{type:"text",maxLength:80,value:e,onChange:h=>t(h.target.value),placeholder:"Produto",className:"flex-1 rounded border p-2"}),j.jsx("input",{type:"number",min:"1",max:"999",value:s,onChange:h=>o(h.target.value),className:"w-20 rounded border p-2"}),j.jsx("button",{className:"rounded bg-green-500 px-4 text-white",children:"+"})]})}function V1({item:i,onAtualizar:e,onRemover:t,onToggleComprado:s}){const[o,u]=Ye.useState(i.quantidade||1),[h,m]=Ye.useState("");Ye.useEffect(()=>{u(i.quantidade||1),m(i.precoUnitario!=null?String(Math.round(i.precoUnitario*100)):"")},[i.quantidade,i.precoUnitario]);const y=Y=>(Number(Y||0)/100).toLocaleString("pt-BR",{minimumFractionDigits:2}),v=Y=>{const G=Y.target.value.replace(/\D/g,"");m(G)},w=()=>{const Y=Number(h||0);e(i.id||i._id,{precoUnitario:Y/100})},A=Y=>{const G=Number(Y.target.value);u(G),e(i.id||i._id,{quantidade:G||1})},b=Number(h||0)/100,Z=(o*b).toLocaleString("pt-BR",{minimumFractionDigits:2});return j.jsx("div",{className:"rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm",children:j.jsxs("div",{className:"flex flex-wrap items-center gap-3 md:flex-nowrap",children:[j.jsx("input",{type:"checkbox",checked:i.comprado,onChange:()=>s(i.id||i._id),className:"h-5 w-5 accent-emerald-500"}),j.jsx("span",{className:"flex-1 font-medium text-gray-800 dark:text-gray-100",children:i.nome}),j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsx("input",{type:"number",min:"1",value:o,onChange:A,className:"w-16 rounded border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-2 py-1 text-center text-gray-900 dark:text-white"}),j.jsx("span",{className:"text-gray-600 dark:text-gray-300",children:"×"}),j.jsx("span",{className:"text-gray-600 dark:text-gray-300",children:"R$"}),j.jsx("input",{type:"text",inputMode:"numeric",value:h?y(h):"",onChange:v,onBlur:w,className:"w-24 rounded border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-2 py-1 text-right text-gray-900 dark:text-white",placeholder:"0,00"})]}),j.jsxs("div",{className:"min-w-[110px] text-right",children:[j.jsx("span",{className:"block text-xs text-gray-500 dark:text-gray-400",children:"Total"}),j.jsxs("span",{className:"font-bold text-gray-900 dark:text-white",children:["R$ ",Z]})]}),j.jsx("button",{onClick:()=>t(i.id||i._id),className:"text-red-500 hover:text-red-700 p-2",title:"Remover item",children:j.jsx(yc,{size:18})})]})})}function O1({itens:i,modo:e,aoRemover:t,aoAtualizar:s,aoAlternarComprado:o}){return i.length?j.jsx("div",{className:"space-y-4",children:i.map(u=>j.jsx("div",{children:e==="feira"?j.jsx(V1,{item:u,onAtualizar:s,onRemover:t,onToggleComprado:o}):j.jsx("div",{className:"rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm",children:j.jsxs("div",{className:"flex items-center justify-between gap-3",children:[j.jsxs("div",{className:"flex flex-1 items-center gap-3",children:[j.jsxs("div",{className:"flex items-center gap-3",children:[j.jsx("input",{type:"checkbox",checked:u.comprado,onChange:()=>o(u.id),className:"h-5 w-5 accent-emerald-500"}),j.jsx("p",{className:`font-medium ${u.comprado?"text-gray-400 dark:text-gray-500 line-through":"text-gray-800 dark:text-gray-100"}`,children:u.nome})]}),j.jsxs("div",{className:"ml-6 flex items-center gap-2",children:[j.jsx("label",{className:"text-sm text-gray-500 dark:text-gray-400",children:"Quantidade:"}),j.jsx("input",{type:"number",min:"1",value:u.quantidade,onChange:h=>s(u.id,{quantidade:Number(h.target.value)||1}),className:"w-20 rounded border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-2 py-1 text-center text-gray-900 dark:text-white focus:border-emerald-500 focus:outline-none"})]})]}),j.jsx("button",{onClick:()=>t(u.id),className:"rounded-lg p-2 text-red-500 transition-colors hover:bg-red-50 dark:hover:bg-slate-700 hover:text-red-700",title:"Remover item",children:j.jsx(yc,{size:18})})]})})},u.id))}):j.jsx("div",{className:"rounded-lg bg-white dark:bg-slate-800 p-6 text-center shadow",children:j.jsx("p",{className:"text-gray-500 dark:text-gray-300",children:"Nenhum item adicionado ainda."})})}function L1(i){return Number(i||0).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function M1({totais:i,modo:e}){const{total:t=0,quantidadeItens:s=0,itensComprados:o=0}=i||{},u=s>0?o/s*100:0;return j.jsxs("div",{className:"rounded-xl shadow-md p-4 mt-4 bg-white dark:bg-slate-800",children:[j.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-5 gap-4",children:[j.jsxs("div",{className:"rounded-lg p-3 col-span-2 md:col-span-1 bg-emerald-50 dark:bg-slate-700",children:[j.jsxs("div",{className:"flex items-center gap-2 text-emerald-600 dark:text-emerald-300 mb-1",children:[j.jsx(v1,{size:18}),j.jsx("span",{className:"text-sm font-medium",children:"Total"})]}),j.jsx("p",{className:"text-2xl font-bold text-emerald-700 dark:text-emerald-200",children:L1(t)}),j.jsx("p",{className:"text-xs text-emerald-500 dark:text-emerald-300 mt-1",children:"Valor total da compra"})]}),j.jsxs("div",{className:"rounded-lg p-3 bg-blue-50 dark:bg-slate-700",children:[j.jsxs("div",{className:"flex items-center gap-2 text-blue-600 dark:text-blue-300 mb-1",children:[j.jsx(A1,{size:18}),j.jsx("span",{className:"text-sm font-medium",children:"Itens"})]}),j.jsx("p",{className:"text-2xl font-bold text-blue-700 dark:text-blue-200",children:s})]}),j.jsxs("div",{className:"rounded-lg p-3 bg-green-50 dark:bg-slate-700",children:[j.jsxs("div",{className:"flex items-center gap-2 text-green-600 dark:text-green-300 mb-1",children:[j.jsx(m1,{size:18}),j.jsx("span",{className:"text-sm font-medium",children:"Comprados"})]}),j.jsx("p",{className:"text-2xl font-bold text-green-700 dark:text-green-200",children:o})]}),j.jsxs("div",{className:"rounded-lg p-3 bg-orange-50 dark:bg-slate-700",children:[j.jsxs("div",{className:"flex items-center gap-2 text-orange-600 dark:text-orange-300 mb-1",children:[j.jsx(y1,{size:18}),j.jsx("span",{className:"text-sm font-medium",children:"Restantes"})]}),j.jsx("p",{className:"text-2xl font-bold text-orange-700 dark:text-orange-200",children:s-o})]})]}),s>0&&j.jsxs("div",{className:"mt-4",children:[j.jsxs("div",{className:"flex justify-between text-sm text-gray-600 dark:text-gray-300 mb-2",children:[j.jsx("span",{children:"Progresso"}),j.jsxs("span",{children:[Math.round(u),"%"]})]}),j.jsx("div",{className:"w-full bg-gray-200 dark:bg-slate-700 rounded-full h-3",children:j.jsx("div",{className:"bg-emerald-500 h-3 rounded-full transition-all duration-500",style:{width:`${u}%`}})}),j.jsxs("p",{className:"text-xs text-gray-500 dark:text-gray-400 mt-2 text-center",children:[o," de ",s," itens"]})]})]})}function b1({historico:i,carregando:e,deletarCompra:t}){const[s,o]=Ye.useState(null);return e?j.jsx("div",{className:"mt-6 text-center text-gray-600 dark:text-gray-300",children:"Carregando histórico..."}):i!=null&&i.length?j.jsx("div",{className:"mt-6 space-y-4",children:i.map(u=>{var m;const h=Number(u.total||0);return j.jsxs("div",{className:"rounded-xl bg-white dark:bg-slate-800 p-4 shadow",children:[j.jsxs("div",{className:"flex items-start justify-between",children:[j.jsxs("div",{className:"flex-1 cursor-pointer",onClick:()=>o(s===u.id?null:u.id),children:[j.jsx("h3",{className:"font-bold text-gray-900 dark:text-white",children:u.estabelecimento}),j.jsx("p",{className:"text-sm text-gray-500 dark:text-gray-400",children:new Date(u.data).toLocaleDateString("pt-BR")}),j.jsxs("p",{className:"font-bold text-green-600 dark:text-green-400",children:["R$ ",h.toFixed(2)]}),j.jsx("p",{className:"mt-1 text-xs text-gray-400 dark:text-gray-500",children:"Clique para ver os detalhes"})]}),j.jsx("button",{onClick:()=>t(u.id),className:"text-red-500 hover:text-red-700",children:j.jsx(yc,{size:18})})]}),s===u.id&&j.jsxs("div",{className:"mt-3 space-y-2 border-t border-gray-200 dark:border-slate-700 pt-3",children:[j.jsxs("div",{className:"flex justify-between text-xs text-gray-500 dark:text-gray-400",children:[j.jsx("span",{children:"Item"}),j.jsx("span",{children:"Total"})]}),(m=u.itens)==null?void 0:m.map(y=>{const v=Number(y.quantidade||0)*Number(y.precoUnitario||0);return j.jsxs("div",{className:"flex justify-between text-sm text-gray-700 dark:text-gray-200",children:[j.jsxs("span",{children:[y.quantidade,"x ",y.nome]}),j.jsxs("span",{children:["R$ ",v.toFixed(2)]})]},y.id)}),j.jsxs("div",{className:"flex justify-between border-t border-gray-200 dark:border-slate-700 pt-2 font-bold text-gray-900 dark:text-white",children:[j.jsx("span",{children:"Total"}),j.jsxs("span",{children:["R$ ",h.toFixed(2)]})]})]})]},u.id)})}):j.jsx("div",{className:"mt-6 text-center text-gray-500 dark:text-gray-400",children:"Nenhuma compra encontrada"})}function F1(){const{usuario:i,loading:e}=o1(),{lista:t,setLista:s}=a1(i),{historico:o,carregando:u,deletarCompra:h}=l1(i),[m,y]=Ye.useState("compras"),[v,w]=Ye.useState("claro"),A=(t==null?void 0:t.itens)||[];Ye.useEffect(()=>{t!=null&&t.tema&&w(t.tema)},[t==null?void 0:t.tema]),Ye.useEffect(()=>{document.documentElement.classList.toggle("dark",v==="escuro")},[v]);const b=async()=>{await Fy(Va)},z=async()=>{if(!A.length)return;const ie=A.reduce((Pe,Me)=>Pe+(Me.quantidade||0)*(Me.precoUnitario||0),0),oe=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID()||Math.random().toString(36).substring(2),ye={id:oe,estabelecimento:t.estabelecimento,itens:A,total:ie,data:new Date().toISOString()};await Xu(wo(cs,"users",i.uid,"compras",oe),ye),await Xu(wo(cs,"users",i.uid,"lista","dados"),{modo:"planejamento",estabelecimento:"",tema:v,itens:[]}),s({modo:"planejamento",estabelecimento:"",tema:v,itens:[]}),y("historico")},Z=ie=>{s(oe=>({...oe,itens:oe.itens.filter(ye=>ye.id!==ie)}))},Y=(ie,oe)=>{s(ye=>({...ye,itens:ye.itens.map(Pe=>Pe.id===ie?{...Pe,...oe}:Pe)}))},G=ie=>{s(oe=>({...oe,itens:oe.itens.map(ye=>ye.id===ie?{...ye,comprado:!ye.comprado}:ye)}))};return e?j.jsx("div",{className:"flex min-h-screen items-center justify-center",children:j.jsx("p",{children:"Carregando..."})}):!i||!t?j.jsx("div",{className:"flex min-h-screen items-center justify-center",children:j.jsx("p",{children:"Carregando lista..."})}):j.jsxs("div",{className:"min-h-screen bg-gray-50 dark:bg-slate-900",children:[j.jsx(N1,{usuario:i,estabelecimento:t.estabelecimento||"",aoDefinirEstabelecimento:ie=>s(oe=>({...oe,estabelecimento:ie})),aoLimpar:()=>s(ie=>({...ie,itens:[]})),aoLogout:b,tema:v,aoDefinirTema:ie=>{w(ie),s(oe=>({...oe,tema:ie}))}}),j.jsxs("main",{className:"mx-auto max-w-4xl space-y-6 px-4 py-6",children:[j.jsxs("div",{className:"flex gap-2",children:[j.jsx("button",{onClick:()=>y("compras"),className:`flex-1 rounded-lg p-3 font-semibold ${m==="compras"?"bg-emerald-600 text-white":"bg-white text-gray-700 dark:bg-slate-800 dark:text-white"}`,children:"Compras"}),j.jsx("button",{onClick:()=>y("historico"),className:`flex-1 rounded-lg p-3 font-semibold ${m==="historico"?"bg-emerald-600 text-white":"bg-white text-gray-700 dark:bg-slate-800 dark:text-white"}`,children:"Histórico"})]}),m==="compras"&&j.jsxs(j.Fragment,{children:[j.jsx(x1,{modo:t.modo,aoAlternar:ie=>s(oe=>({...oe,modo:ie}))}),j.jsx(D1,{aoAdicionar:ie=>s(oe=>({...oe,itens:[...oe.itens,{id:typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID()||Math.random().toString(36).substring(2),nome:ie.nome,quantidade:ie.quantidade,precoUnitario:0,comprado:!1}]}))}),j.jsx(O1,{itens:A,modo:t.modo,aoRemover:Z,aoAtualizar:Y,aoAlternarComprado:G}),j.jsx(M1,{totais:{total:A.reduce((ie,oe)=>ie+(oe.quantidade||0)*(oe.precoUnitario||0),0),quantidadeItens:A.length,itensComprados:A.filter(ie=>ie.comprado).length}}),t.modo==="feira"&&A.length>0&&j.jsx("button",{onClick:z,className:"w-full rounded-lg bg-emerald-600 p-3 text-white font-semibold",children:"Finalizar compra"})]}),m==="historico"&&j.jsx(b1,{historico:o,carregando:u,deletarCompra:h})]})]})}const Ov=document.getElementById("root");if(!Ov)throw new Error("Elemento #root não encontrado no index.html");const U1=JE.createRoot(Ov);U1.render(j.jsx(F1,{}));
