 ...
 */var Rm;function $E(){if(Rm)return Ie;Rm=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),R=Symbol.iterator;function M(D){return D===null||typeof D!="object"?null:(D=R&&D[R]||D["@@iterator"],typeof D=="function"?D:null)}var B={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,Y={};function z(D,q,Ee){this.props=D,this.context=q,this.refs=Y,this.updater=Ee||B}z.prototype.isReactComponent={},z.prototype.setState=function(D,q){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,q,"setState")},z.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function ae(){}ae.prototype=z.prototype;function fe(D,q,Ee){this.props=D,this.context=q,this.refs=Y,this.updater=Ee||B}var Te=fe.prototype=new ae;Te.constructor=fe,Z(Te,z.prototype),Te.isPureReactComponent=!0;var Fe=Array.isArray,je=Object.prototype.hasOwnProperty,Ve={current:null},k={key:!0,ref:!0,__self:!0,__source:!0};function I(D,q,Ee){var we,Se={},Ae=null,Me=null;if(q!=null)for(we in q.ref!==void 0&&(Me=q.ref),q.key!==void 0&&(Ae=""+q.key),q)je.call(q,we)&&!k.hasOwnProperty(we)&&(Se[we]=q[we]);var xe=arguments.length-2;if(xe===1)Se.children=Ee;else if(1<xe){for(var ze=Array(xe),jt=0;jt<xe;jt++)ze[jt]=arguments[jt+2];Se.children=ze}if(D&&D.defaultProps)for(we in xe=D.defaultProps,xe)Se[we]===void 0&&(Se[we]=xe[we]);return{$$typeof:i,type:D,key:Ae,ref:Me,props:Se,_owner:Ve.current}}function A(D,q){return{$$typeof:i,type:D.type,key:q,ref:D.ref,props:D.props,_owner:D._owner}}function x(D){return typeof D=="object"&&D!==null&&D.$$typeof===i}function P(D){var q={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(Ee){return q[Ee]})}var V=/\/+/g;function S(D,q){return typeof D=="object"&&D!==null&&D.key!=null?P(""+D.key):q.toString(36)}function $e(D,q,Ee,we,Se){var Ae=typeof D;(Ae==="undefined"||Ae==="boolean")&&(D=null);var Me=!1;if(D===null)Me=!0;else switch(Ae){case"string":case"number":Me=!0;break;case"object":switch(D.$$typeof){case i:case e:Me=!0}}if(Me)return Me=D,Se=Se(Me),D=we===""?"."+S(Me,0):we,Fe(Se)?(Ee="",D!=null&&(Ee=D.replace(V,"$&/")+"/"),$e(Se,q,Ee,"",function(jt){return jt})):Se!=null&&(x(Se)&&(Se=A(Se,Ee+(!Se.key||Me&&Me.key===Se.key?"":(""+Se.key).replace(V,"$&/")+"/")+D)),q.push(Se)),1;if(Me=0,we=we===""?".":we+":",Fe(D))for(var xe=0;xe<D.length;xe++){Ae=D[xe];var ze=we+S(Ae,xe);Me+=$e(Ae,q,Ee,ze,Se)}else if(ze=M(D),typeof ze=="function")for(D=ze.call(D),xe=0;!(Ae=D.next()).done;)Ae=Ae.value,ze=we+S(Ae,xe++),Me+=$e(Ae,q,Ee,ze,Se);else if(Ae==="object")throw q=String(D),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.");return Me}function _t(D,q,Ee){if(D==null)return D;var we=[],Se=0;return $e(D,we,"","",function(Ae){return q.call(Ee,Ae,Se++)}),we}function Nt(D){if(D._status===-1){var q=D._result;q=q(),q.then(function(Ee){(D._status===0||D._status===-1)&&(D._status=1,D._result=Ee)},function(Ee){(D._status===0||D._status===-1)&&(D._status=2,D._result=Ee)}),D._status===-1&&(D._status=0,D._result=q)}if(D._status===1)return D._result.default;throw D._result}var Je={current:null},X={transition:null},ue={ReactCurrentDispatcher:Je,ReactCurrentBatchConfig:X,ReactCurrentOwner:Ve};function ne(){throw Error("act(...) is not supported in production builds of React.")}return Ie.Children={map:_t,forEach:function(D,q,Ee){_t(D,function(){q.apply(this,arguments)},Ee)},count:function(D){var q=0;return _t(D,function(){q++}),q},toArray:function(D){return _t(D,function(q){return q})||[]},only:function(D){if(!x(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},Ie.Component=z,Ie.Fragment=t,Ie.Profiler=o,Ie.PureComponent=fe,Ie.StrictMode=s,Ie.Suspense=y,Ie.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ue,Ie.act=ne,Ie.cloneElement=function(D,q,Ee){if(D==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+D+".");var we=Z({},D.props),Se=D.key,Ae=D.ref,Me=D._owner;if(q!=null){if(q.ref!==void 0&&(Ae=q.ref,Me=Ve.current),q.key!==void 0&&(Se=""+q.key),D.type&&D.type.defaultProps)var xe=D.type.defaultProps;for(ze in q)je.call(q,ze)&&!k.hasOwnProperty(ze)&&(we[ze]=q[ze]===void 0&&xe!==void 0?xe[ze]:q[ze])}var ze=arguments.length-2;if(ze===1)we.children=Ee;else if(1<ze){xe=Array(ze);for(var jt=0;jt<ze;jt++)xe[jt]=arguments[jt+2];we.children=xe}return{$$typeof:i,type:D.type,key:Se,ref:Ae,props:we,_owner:Me}},Ie.createContext=function(D){return D={$$typeof:h,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},D.Provider={$$typeof:u,_context:D},D.Consumer=D},Ie.createElement=I,Ie.createFactory=function(D){var q=I.bind(null,D);return q.type=D,q},Ie.createRef=function(){return{current:null}},Ie.forwardRef=function(D){return{$$typeof:m,render:D}},Ie.isValidElement=x,Ie.lazy=function(D){return{$$typeof:w,_payload:{_status:-1,_result:D},_init:Nt}},Ie.memo=function(D,q){return{$$typeof:v,type:D,compare:q===void 0?null:q}},Ie.startTransition=function(D){var q=X.transition;X.transition={};try{D()}finally{X.transition=q}},Ie.unstable_act=ne,Ie.useCallback=function(D,q){return Je.current.useCallback(D,q)},Ie.useContext=function(D){return Je.current.useContext(D)},Ie.useDebugValue=function(){},Ie.useDeferredValue=function(D){return Je.current.useDeferredValue(D)},Ie.useEffect=function(D,q){return Je.current.useEffect(D,q)},Ie.useId=function(){return Je.current.useId()},Ie.useImperativeHandle=function(D,q,Ee){return Je.current.useImperativeHandle(D,q,Ee)},Ie.useInsertionEffect=function(D,q){return Je.current.useInsertionEffect(D,q)},Ie.useLayoutEffect=function(D,q){return Je.current.useLayoutEffect(D,q)},Ie.useMemo=function(D,q){return Je.current.useMemo(D,q)},Ie.useReducer=function(D,q,Ee){return Je.current.useReducer(D,q,Ee)},Ie.useRef=function(D){return Je.current.useRef(D)},Ie.useState=function(D){return Je.current.useState(D)},Ie.useSyncExternalStore=function(D,q,Ee){return Je.current.useSyncExternalStore(D,q,Ee)},Ie.useTransition=function(){return Je.current.useTransition()},Ie.version="18.3.1",Ie}var Cm;function Cd(){return Cm||(Cm=1,zh.exports=$E()),zh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var km;function HE(){if(km)return Ea;km=1;var i=Cd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,y,v){var w,R={},M=null,B=null;v!==void 0&&(M=""+v),y.key!==void 0&&(M=""+y.key),y.ref!==void 0&&(B=y.ref);for(w in y)s.call(y,w)&&!u.hasOwnProperty(w)&&(R[w]=y[w]);if(m&&m.defaultProps)for(w in y=m.defaultProps,y)R[w]===void 0&&(R[w]=y[w]);return{$$typeof:e,type:m,key:M,ref:B,props:R,_owner:o.current}}return Ea.Fragment=t,Ea.jsx=h,Ea.jsxs=h,Ea}var Pm;function qE(){return Pm||(Pm=1,jh.exports=HE()),jh.exports}var U=qE(),Ye=Cd(),pu={},Bh={exports:{}},Kt={},$h={exports:{}},Hh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nm;function WE(){return Nm||(Nm=1,(function(i){function e(X,ue){var ne=X.length;X.push(ue);e:for(;0<ne;){var D=ne-1>>>1,q=X[D];if(0<o(q,ue))X[D]=ue,X[ne]=q,ne=D;else break e}}function t(X){return X.length===0?null:X[0]}function s(X){if(X.length===0)return null;var ue=X[0],ne=X.pop();if(ne!==ue){X[0]=ne;e:for(var D=0,q=X.length,Ee=q>>>1;D<Ee;){var we=2*(D+1)-1,Se=X[we],Ae=we+1,Me=X[Ae];if(0>o(Se,ne))Ae<q&&0>o(Me,Se)?(X[D]=Me,X[Ae]=ne,D=Ae):(X[D]=Se,X[we]=ne,D=we);else if(Ae<q&&0>o(Me,ne))X[D]=Me,X[Ae]=ne,D=Ae;else break e}}return ue}function o(X,ue){var ne=X.sortIndex-ue.sortIndex;return ne!==0?ne:X.id-ue.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var y=[],v=[],w=1,R=null,M=3,B=!1,Z=!1,Y=!1,z=typeof setTimeout=="function"?setTimeout:null,ae=typeof clearTimeout=="function"?clearTimeout:null,fe=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function Te(X){for(var ue=t(v);ue!==null;){if(ue.callback===null)s(v);else if(ue.startTime<=X)s(v),ue.sortIndex=ue.expirationTime,e(y,ue);else break;ue=t(v)}}function Fe(X){if(Y=!1,Te(X),!Z)if(t(y)!==null)Z=!0,Nt(je);else{var ue=t(v);ue!==null&&Je(Fe,ue.startTime-X)}}function je(X,ue){Z=!1,Y&&(Y=!1,ae(I),I=-1),B=!0;var ne=M;try{for(Te(ue),R=t(y);R!==null&&(!(R.expirationTime>ue)||X&&!P());){var D=R.callback;if(typeof D=="function"){R.callback=null,M=R.priorityLevel;var q=D(R.expirationTime<=ue);ue=i.unstable_now(),typeof q=="function"?R.callback=q:R===t(y)&&s(y),Te(ue)}else s(y);R=t(y)}if(R!==null)var Ee=!0;else{var we=t(v);we!==null&&Je(Fe,we.startTime-ue),Ee=!1}return Ee}finally{R=null,M=ne,B=!1}}var Ve=!1,k=null,I=-1,A=5,x=-1;function P(){return!(i.unstable_now()-x<A)}function V(){if(k!==null){var X=i.unstable_now();x=X;var ue=!0;try{ue=k(!0,X)}finally{ue?S():(Ve=!1,k=null)}}else Ve=!1}var S;if(typeof fe=="function")S=function(){fe(V)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,_t=$e.port2;$e.port1.onmessage=V,S=function(){_t.postMessage(null)}}else S=function(){z(V,0)};function Nt(X){k=X,Ve||(Ve=!0,S())}function Je(X,ue){I=z(function(){X(i.unstable_now())},ue)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(X){X.callback=null},i.unstable_continueExecution=function(){Z||B||(Z=!0,Nt(je))},i.unstable_forceFrameRate=function(X){0>X||125<X?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<X?Math.floor(1e3/X):5},i.unstable_getCurrentPriorityLevel=function(){return M},i.unstable_getFirstCallbackNode=function(){return t(y)},i.unstable_next=function(X){switch(M){case 1:case 2:case 3:var ue=3;break;default:ue=M}var ne=M;M=ue;try{return X()}finally{M=ne}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(X,ue){switch(X){case 1:case 2:case 3:case 4:case 5:break;default:X=3}var ne=M;M=X;try{return ue()}finally{M=ne}},i.unstable_scheduleCallback=function(X,ue,ne){var D=i.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?D+ne:D):ne=D,X){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=ne+q,X={id:w++,callback:ue,priorityLevel:X,startTime:ne,expirationTime:q,sortIndex:-1},ne>D?(X.sortIndex=ne,e(v,X),t(y)===null&&X===t(v)&&(Y?(ae(I),I=-1):Y=!0,Je(Fe,ne-D))):(X.sortIndex=q,e(y,X),Z||B||(Z=!0,Nt(je))),X},i.unstable_shouldYield=P,i.unstable_wrapCallback=function(X){var ue=M;return function(){var ne=M;M=ue;try{return X.apply(this,arguments)}finally{M=ne}}}})(Hh)),Hh}var xm;function GE(){return xm||(xm=1,$h.exports=WE()),$h.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vu=new kd("@firebase/auth");function L0(i,...e){Vu.logLevel<=Re.WARN&&Vu.warn(`Auth (${Eo}): ${i}`,...e)}function wu(i,...e){Vu.logLevel<=Re.ERROR&&Vu.error(`Auth (${Eo}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yT(i,e,t=!1){const{auth:s}=i;if(Cn(s.app))return Promise.reject(ns(s));const o="reauthenticate";try{const u=await Va(i,My(s,o,e,i),t);ge(u.idToken,s,"internal-error");const h=Ld(u.idToken);ge(h,s,"internal-error");const{sub:m}=h;return ge(i.uid===m,s,"user-mismatch"),po._forOperation(i,o,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&nr(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jh="webStorageSupport";class SI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=By,this._completeRedirectFn=KT,this._overrideRedirectResult=qT}async _openPopup(e,t,s,o){var h;kr((h=this.eventManagers[e._key()])==null?void 0:h.manager,"_initialize() not called before _openPopup()");const u=await ig(e,t,s,ld(),o);return _I(e,u,Ud())}async _openRedirect(e,t,s,o){await this._originValidation(e);const u=await ig(e,t,s,ld(),o);return CT(u),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:u}=this.eventManagers[t];return o?Promise.resolve(o):(kr(u,"If manager is not set, promise should be"),u)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await dI(e),s=new YT(e);return t.register("authEvent",o=>(ge(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:s.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Jh,{type:Jh},o=>{var h;const u=(h=o==null?void 0:o[0])==null?void 0:h[Jh];u!==void 0&&t(!!u),nr(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=tI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Dy()||Ry()||Md()}}const AI=SI;var sg="@firebase/auth",og="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CI(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function kI(i){fo(new ss("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:h,authDomain:m}=s.options;ge(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const y={apiKey:h,authDomain:m,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vy(i)},v=new sT(s,o,u,y);return hT(v,t),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),fo(new ss("auth-internal",e=>{const t=Zu(e.getProvider("auth").getImmediate());return(s=>new RI(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),gi(sg,og,CI(i)),gi(sg,og,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IS=new tt(ce.comparator);function Nr(){return IS}const S_=new tt(ce.comparator);function Ia(...i){let e=S_;for(const t of i)e=e.insert(t.key,t);return e}function A_(i){let e=S_;return i.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function ts(){return Pa()}function R_(){return Pa()}function Pa(){return new hs((i=>i.toString()),((i,e)=>i.isEqual(e)))}const SS=new tt(ce.comparator),AS=new yt(ce.comparator);function ke(...i){let e=AS;for(const t of i)e=e.add(t);return e}const RS=new yt(Ce);function CS(){return RS}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cc{constructor(e,t,s,o,u){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const o=new Map;return o.set(e,Qa.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new cc(ye.min(),o,new tt(Ce),Nr(),ke())}}class Qa{constructor(e,t,s,o,u){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new Qa(s,t,ke(),ke(),ke())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rf{constructor(e,t,s,o){this.targetId=e,this.fromCache=t,this.Ts=s,this.Es=o}static Is(e,t){let s=ke(),o=ke();for(const u of t.docChanges)switch(u.type){case 0:s=s.add(u.doc.key);break;case 1:o=o.add(u.doc.key)}return new rf(e,t.fromCache,s,o)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CA{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return gw()?8:JI(Ut())>0?6:4})()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,s,o){const u={result:null};return this.gs(e,t).next((h=>{u.result=h})).next((()=>{if(!u.result)return this.ps(e,t,o,s).next((h=>{u.result=h}))})).next((()=>{if(u.result)return;const h=new RA;return this.ys(e,t,h).next((m=>{if(u.result=m,this.As)return this.ws(e,t,h,m.size)}))})).next((()=>u.result))}ws(e,t,s,o){return s.documentReadCount<this.Vs?(no()<=Re.DEBUG&&te("QueryEngine","SDK will not create cache indexes for query:",ro(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),$.resolve()):(no()<=Re.DEBUG&&te("QueryEngine","Query:",ro(t),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.ds*o?(no()<=Re.DEBUG&&te("QueryEngine","The SDK decides to create cache indexes for query:",ro(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Xn(t))):$.resolve())}gs(e,t){if(Ag(t))return $.resolve(null);let s=Xn(t);return this.indexManager.getIndexType(e,s).next((o=>o===0?null:(t.limit!==null&&o===1&&(t=yd(t,null,"F"),s=Xn(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next((u=>{const h=ke(...u);return this.fs.getDocuments(e,h).next((m=>this.indexManager.getMinOffset(e,s).next((y=>{const v=this.Ss(t,m);return this.bs(t,v,h,y.readTime)?this.gs(e,yd(t,null,"F")):this.Ds(e,v,t,y)}))))})))))}ps(e,t,s,o){return Ag(t)||o.isEqual(ye.min())?$.resolve(null):this.fs.getDocuments(e,s).next((u=>{const h=this.Ss(t,u);return this.bs(t,h,s,o)?$.resolve(null):(no()<=Re.DEBUG&&te("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),ro(t)),this.Ds(e,h,t,WI(o,Oa)).next((m=>m)))}))}Ss(e,t){let s=new yt(I_(e));return t.forEach(((o,u)=>{ac(e,u)&&(s=s.add(u))})),s}bs(e,t,s,o){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const u=e.limitType==="F"?t.last():t.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}ys(e,t,s){return no()<=Re.DEBUG&&te("QueryEngine","Using full collection scan to execute query:",ro(t)),this.fs.getDocumentsMatchingQuery(e,t,Ei.min(),s)}Ds(e,t,s,o){return this.fs.getDocumentsMatchingQuery(e,s,o).next((u=>(t.forEach((h=>{u=u.insert(h.key,h)})),u)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ov{constructor(e){this.key=e}}class av{constructor(e){this.key=e}}class hR{constructor(e,t){this.query=e,this.Za=t,this.Xa=null,this.hasCachedResults=!1,this.current=!1,this.Ya=ke(),this.mutatedKeys=ke(),this.eu=I_(e),this.tu=new co(this.eu)}get nu(){return this.Za}ru(e,t){const s=t?t.iu:new Hg,o=t?t.tu:this.tu;let u=t?t.mutatedKeys:this.mutatedKeys,h=o,m=!1;const y=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,v=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(e.inorderTraversal(((w,R)=>{const M=o.get(w),B=ac(this.query,R)?R:null,Z=!!M&&this.mutatedKeys.has(M.key),Y=!!B&&(B.hasLocalMutations||this.mutatedKeys.has(B.key)&&B.hasCommittedMutations);let z=!1;M&&B?M.data.isEqual(B.data)?Z!==Y&&(s.track({type:3,doc:B}),z=!0):this.su(M,B)||(s.track({type:2,doc:B}),z=!0,(y&&this.eu(B,y)>0||v&&this.eu(B,v)<0)&&(m=!0)):!M&&B?(s.track({type:0,doc:B}),z=!0):M&&!B&&(s.track({type:1,doc:M}),z=!0,(y||v)&&(m=!0)),z&&(B?(h=h.add(B),u=Y?u.add(w):u.delete(w)):(h=h.delete(w),u=u.delete(w)))})),this.query.limit!==null)for(;h.size>this.query.limit;){const w=this.query.limitType==="F"?h.last():h.first();h=h.delete(w.key),u=u.delete(w.key),s.track({type:1,doc:w})}return{tu:h,iu:s,bs:m,mutatedKeys:u}}su(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,s,o){const u=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const h=e.iu.ya();h.sort(((w,R)=>(function(B,Z){const Y=z=>{switch(z){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return pe(20277,{Vt:z})}};return Y(B)-Y(Z)})(w.type,R.type)||this.eu(w.doc,R.doc))),this.ou(s),o=o??!1;const m=t&&!o?this._u():[],y=this.Ya.size===0&&this.current&&!o?1:0,v=y!==this.Xa;return this.Xa=y,h.length!==0||v?{snapshot:new vo(this.query,e.tu,u,h,e.mutatedKeys,y===0,v,!1,!!s&&s.resumeToken.approximateByteSize()>0),au:m}:{au:m}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Hg,mutatedKeys:this.mutatedKeys,bs:!1},!1)):{au:[]}}uu(e){return!this.Za.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach((t=>this.Za=this.Za.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Za=this.Za.delete(t))),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Ya;this.Ya=ke(),this.tu.forEach((s=>{this.uu(s.key)&&(this.Ya=this.Ya.add(s.key))}));const t=[];return e.forEach((s=>{this.Ya.has(s)||t.push(new av(s))})),this.Ya.forEach((s=>{e.has(s)||t.push(new ov(s))})),t}cu(e){this.Za=e.ks,this.Ya=ke();const t=this.ru(e.documents);return this.applyChanges(t,!0)}lu(){return vo.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Xa===0,this.hasCachedResults)}}const ff="SyncEngine";class dR{constructor(e,t,s){this.query=e,this.targetId=t,this.view=s}}class fR{constructor(e){this.key=e,this.hu=!1}}class pR{constructor(e,t,s,o,u,h){this.localStore=e,this.remoteStore=t,this.eventManager=s,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=h,this.Pu={},this.Tu=new hs((m=>T_(m)),oc),this.Eu=new Map,this.Iu=new Set,this.Ru=new tt(ce.comparator),this.Au=new Map,this.Vu=new tf,this.du={},this.mu=new Map,this.fu=_o.ar(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function mR(i,e,t=!0){const s=fv(i);let o;const u=s.Tu.get(e);return u?(s.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.lu()):o=await lv(s,e,t,!0),o}async function gR(i,e){const t=fv(i);await lv(t,e,!0,!1)}async function lv(i,e,t,s){const o=await LA(i.localStore,Xn(e)),u=o.targetId,h=i.sharedClientState.addLocalQueryTarget(u,t);let m;return s&&(m=await yR(i,e,u,h==="current",o.resumeToken)),i.isPrimaryClient&&t&&J_(i.remoteStore,o),m}async function yR(i,e,t,s,o){i.pu=(R,M,B)=>(async function(Y,z,ae,fe){let Te=z.view.ru(ae);Te.bs&&(Te=await Fg(Y.localStore,z.query,!1).then((({documents:k})=>z.view.ru(k,Te))));const Fe=fe&&fe.targetChanges.get(z.targetId),je=fe&&fe.targetMismatches.get(z.targetId)!=null,Ve=z.view.applyChanges(Te,Y.isPrimaryClient,Fe,je);return Kg(Y,z.targetId,Ve.au),Ve.snapshot})(i,R,M,B);const u=await Fg(i.localStore,e,!0),h=new hR(e,u.ks),m=h.ru(u.documents),y=Qa.createSynthesizedTargetChangeForCurrentChange(t,s&&i.onlineState!=="Offline",o),v=h.applyChanges(m,i.isPrimaryClient,y);Kg(i,t,v.au);const w=new dR(e,t,h);return i.Tu.set(e,w),i.Eu.has(t)?i.Eu.get(t).push(e):i.Eu.set(t,[e]),v.snapshot}async function _R(i,e,t){const s=ve(i),o=s.Tu.get(e),u=s.Eu.get(o.targetId);if(u.length>1)return s.Eu.set(o.targetId,u.filter((h=>!oc(h,e)))),void s.Tu.delete(e);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(o.targetId),s.sharedClientState.isActiveQueryTarget(o.targetId)||await Td(s.localStore,o.targetId,!1).then((()=>{s.sharedClientState.clearQueryState(o.targetId),t&&of(s.remoteStore,o.targetId),Ad(s,o.targetId)})).catch(Io)):(Ad(s,o.targetId),await Td(s.localStore,o.targetId,!0))}async function vR(i,e){const t=ve(i),s=t.Tu.get(e),o=t.Eu.get(s.targetId);t.isPrimaryClient&&o.length===1&&(t.sharedClientState.removeLocalQueryTarget(s.targetId),of(t.remoteStore,s.targetId))}async function ER(i,e,t){const s=CR(i);try{const o=await(function(h,m){const y=ve(h),v=Qe.now(),w=m.reduce(((B,Z)=>B.add(Z.key)),ke());let R,M;return y.persistence.runTransaction("Locally write mutations","readwrite",(B=>{let Z=Nr(),Y=ke();return y.xs.getEntries(B,w).next((z=>{Z=z,Z.forEach(((ae,fe)=>{fe.isValidDocument()||(Y=Y.add(ae))}))})).next((()=>y.localDocuments.getOverlayedDocuments(B,Z))).next((z=>{R=z;const ae=[];for(const fe of m){const Te=OS(fe,R.get(fe.key).overlayedDocument);Te!=null&&ae.push(new ds(fe.key,Te,m_(Te.value.mapValue),Zn.exists(!0)))}return y.mutationQueue.addMutationBatch(B,v,ae,m)})).next((z=>{M=z;const ae=z.applyToLocalDocumentSet(R,Y);return y.documentOverlayCache.saveOverlays(B,z.batchId,ae)}))})).then((()=>({batchId:M.batchId,changes:A_(R)})))})(s.localStore,e);s.sharedClientState.addPendingMutation(o.batchId),(function(h,m,y){let v=h.du[h.currentUser.toKey()];v||(v=new tt(Ce)),v=v.insert(m,y),h.du[h.currentUser.toKey()]=v})(s,o.batchId,t),await Ja(s,o.changes),await fc(s.remoteStore)}catch(o){const u=hf(o,"Failed to persist write");t.reject(u)}}async function uv(i,e){const t=ve(i);try{const s=await DA(t.localStore,e);e.targetChanges.forEach(((o,u)=>{const h=t.Au.get(u);h&&(be(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?h.hu=!0:o.modifiedDocuments.size>0?be(h.hu,14607):o.removedDocuments.size>0&&(be(h.hu,42227),h.hu=!1))})),await Ja(t,s,e)}catch(s){await Io(s)}}function Gg(i,e,t){const s=ve(i);if(s.isPrimaryClient&&t===0||!s.isPrimaryClient&&t===1){const o=[];s.Tu.forEach(((u,h)=>{const m=h.view.va(e);m.snapshot&&o.push(m.snapshot)})),(function(h,m){const y=ve(h);y.onlineState=m;let v=!1;y.queries.forEach(((w,R)=>{for(const M of R.Sa)M.va(m)&&(v=!0)})),v&&df(y)})(s.eventManager,e),o.length&&s.Pu.H_(o),s.onlineState=e,s.isPrimaryClient&&s.sharedClientState.setOnlineState(e)}}async function wR(i,e,t){const s=ve(i);s.sharedClientState.updateQueryState(e,"rejected",t);const o=s.Au.get(e),u=o&&o.key;if(u){let h=new tt(ce.comparator);h=h.insert(u,Ft.newNoDocument(u,ye.min()));const m=ke().add(u),y=new cc(ye.min(),new Map,new tt(Ce),h,m);await uv(s,y),s.Ru=s.Ru.remove(u),s.Au.delete(e),pf(s)}else await Td(s.localStore,e,!1).then((()=>Ad(s,e,t))).catch(Io)}async function TR(i,e){const t=ve(i),s=e.batch.batchId;try{const o=await xA(t.localStore,e);hv(t,s,null),cv(t,s),t.sharedClientState.updateMutationState(s,"acknowledged"),await Ja(t,o)}catch(o){await Io(o)}}async function IR(i,e,t){const s=ve(i);try{const o=await(function(h,m){const y=ve(h);return y.persistence.runTransaction("Reject batch","readwrite-primary",(v=>{let w;return y.mutationQueue.lookupMutationBatch(v,m).next((R=>(be(R!==null,37113),w=R.keys(),y.mutationQueue.removeMutationBatch(v,R)))).next((()=>y.mutationQueue.performConsistencyCheck(v))).next((()=>y.documentOverlayCache.removeOverlaysForBatchId(v,w,m))).next((()=>y.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(v,w))).next((()=>y.localDocuments.getDocuments(v,w)))}))})(s.localStore,e);hv(s,e,t),cv(s,e),s.sharedClientState.updateMutationState(e,"rejected",t),await Ja(s,o)}catch(o){await Io(o)}}function cv(i,e){(i.mu.get(e)||[]).forEach((t=>{t.resolve()})),i.mu.delete(e)}function hv(i,e,t){const s=ve(i);let o=s.du[s.currentUser.toKey()];if(o){const u=o.get(e);u&&(t?u.reject(t):u.resolve(),o=o.remove(e)),s.du[s.currentUser.toKey()]=o}}function Ad(i,e,t=null){i.sharedClientState.removeLocalQueryTarget(e);for(const s of i.Eu.get(e))i.Tu.delete(s),t&&i.Pu.yu(s,t);i.Eu.delete(e),i.isPrimaryClient&&i.Vu.Gr(e).forEach((s=>{i.Vu.containsKey(s)||dv(i,s)}))}function dv(i,e){i.Iu.delete(e.path.canonicalString());const t=i.Ru.get(e);t!==null&&(of(i.remoteStore,t),i.Ru=i.Ru.remove(e),i.Au.delete(t),pf(i))}function Kg(i,e,t){for(const s of t)s instanceof ov?(i.Vu.addReference(s.key,e),SR(i,s)):s instanceof av?(te(ff,"Document no longer in limbo: "+s.key),i.Vu.removeReference(s.key,e),i.Vu.containsKey(s.key)||dv(i,s.key)):pe(19791,{wu:s})}function SR(i,e){const t=e.key,s=t.path.canonicalString();i.Ru.get(t)||i.Iu.has(s)||(te(ff,"New document in limbo: "+t),i.Iu.add(s),pf(i))}function pf(i){for(;i.Iu.size>0&&i.Ru.size<i.maxConcurrentLimboResolutions;){const e=i.Iu.values().next().value;i.Iu.delete(e);const t=new ce(Ke.fromString(e)),s=i.fu.next();i.Au.set(s,new fR(t)),i.Ru=i.Ru.insert(t,s),J_(i.remoteStore,new fi(Xn(Qd(t.path)),s,"TargetPurposeLimboResolution",nc.ce))}}async function Ja(i,e,t){const s=ve(i),o=[],u=[],h=[];s.Tu.isEmpty()||(s.Tu.forEach(((m,y)=>{h.push(s.pu(y,e,t).then((v=>{var w;if((v||t)&&s.isPrimaryClient){const R=v?!v.fromCache:(w=t==null?void 0:t.targetChanges.get(y.targetId))==null?void 0:w.current;s.sharedClientState.updateQueryState(y.targetId,R?"current":"not-current")}if(v){o.push(v);const R=rf.Is(y.targetId,v);u.push(R)}})))})),await Promise.all(h),s.Pu.H_(o),await(async function(y,v){const w=ve(y);try{await w.persistence.runTransaction("notifyLocalViewChanges","readwrite",(R=>$.forEach(v,(M=>$.forEach(M.Ts,(B=>w.persistence.referenceDelegate.addReference(R,M.targetId,B))).next((()=>$.forEach(M.Es,(B=>w.persistence.referenceDelegate.removeReference(R,M.targetId,B)))))))))}catch(R){if(!So(R))throw R;te(sf,"Failed to update sequence numbers: "+R)}for(const R of v){const M=R.targetId;if(!R.fromCache){const B=w.vs.get(M),Z=B.snapshotVersion,Y=B.withLastLimboFreeSnapshotVersion(Z);w.vs=w.vs.insert(M,Y)}}})(s.localStore,u))}async function AR(i,e){const t=ve(i);if(!t.currentUser.isEqual(e)){te(ff,"User change. New user:",e.toKey());const s=await G_(t.localStore,e);t.currentUser=e,(function(u,h){u.mu.forEach((m=>{m.forEach((y=>{y.reject(new oe(H.CANCELLED,h))}))})),u.mu.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,s.removedBatchIds,s.addedBatchIds),await Ja(t,s.Ns)}}function RR(i,e){const t=ve(i),s=t.Au.get(e);if(s&&s.hu)return ke().add(s.key);{let o=ke();const u=t.Eu.get(e);if(!u)return o;for(const h of u){const m=t.Tu.get(h);o=o.unionWith(m.view.nu)}return o}}function fv(i){const e=ve(i);return e.remoteStore.remoteSyncer.applyRemoteEvent=uv.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=RR.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=wR.bind(null,e),e.Pu.H_=uR.bind(null,e.eventManager),e.Pu.yu=cR.bind(null,e.eventManager),e}function CR(i){const e=ve(i);return e.remoteStore.remoteSyncer.applySuccessfulWrite=TR.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=IR.bind(null,e),e}class Qu{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=hc(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,t){return null}Mu(e,t){return null}vu(e){return NA(this.persistence,new CA,e.initialUser,this.serializer)}Cu(e){return new W_(nf.Vi,this.serializer)}Du(e){return new bA}async terminate(){var e,t;(e=this.gcScheduler)==null||e.stop(),(t=this.indexBackfillerScheduler)==null||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Qu.provider={build:()=>new Qu};class kR extends Qu{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,t){be(this.persistence.referenceDelegate instanceof Gu,46915);const s=this.persistence.referenceDelegate.garbageCollector;return new dA(s,e.asyncQueue,t)}Cu(e){const t=this.cacheSizeBytes!==void 0?Qt.withCacheSize(this.cacheSizeBytes):Qt.DEFAULT;return new W_((s=>Gu.Vi(s,t)),this.serializer)}}class Rd{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>Gg(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=AR.bind(null,this.syncEngine),await oR(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new lR})()}createDatastore(e){const t=hc(e.databaseInfo.databaseId),s=BA(e.databaseInfo);return GA(e.authCredentials,e.appCheckCredentials,s,t)}createRemoteStore(e){return(function(s,o,u,h,m){return new QA(s,o,u,h,m)})(this.localStore,this.datastore,e.asyncQueue,(t=>Gg(this.syncEngine,t,0)),(function(){return zg.v()?new zg:new FA})())}createSyncEngine(e,t){return(function(o,u,h,m,y,v,w){const R=new pR(o,u,h,m,y,v);return w&&(R.gu=!0),R})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await(async function(o){const u=ve(o);te(us,"RemoteStore shutting down."),u.Ia.add(5),await Ya(u),u.Aa.shutdown(),u.Va.set("Unknown")})(this.remoteStore),(e=this.datastore)==null||e.terminate(),(t=this.eventManager)==null||t.terminate()}}Rd.provider={build:()=>new Rd};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LR="ComponentProvider",Yg=new Map;function MR(i,e,t,s,o){return new nS(i,e,t,o.host,o.ssl,o.experimentalForceLongPolling,o.experimentalAutoDetectLongPolling,yv(o.experimentalLongPollingOptions),o.useFetchStreams,o.isUsingEmulator,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+i.stack),e}class Xa extends pc{constructor(e,t,s,o){super(e,t,s,o),this.type="firestore",this._queue=new ey,this._persistenceKey=(o==null?void 0:o.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new ey(e),this._firestoreClient=void 0,await e}}}function UR(i,e){const t=typeof i=="object"?i:my(),s=typeof i=="string"?i:ju,o=Nd(t,"firestore").getImmediate({identifier:s});if(!o._initialized){const u=aw("firestore");u&&bR(o,...u)}return o}function mf(i){if(i._terminated)throw new oe(H.FAILED_PRECONDITION,"The client has already been terminated.");return i._firestoreClient||jR(i),i._firestoreClient}function jR(i){var s,o,u,h;const e=i._freezeSettings(),t=MR(i._databaseId,((s=i._app)==null?void 0:s.options.appId)||"",i._persistenceKey,(o=i._app)==null?void 0:o.options.apiKey,e);i._componentsProvider||(u=e.localCache)!=null&&u._offlineComponentProvider&&((h=e.localCache)!=null&&h._onlineComponentProvider)&&(i._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),i._firestoreClient=new PR(i._authCredentials,i._appCheckCredentials,i._queue,t,i._componentsProvider&&(function(y){const v=y==null?void 0:y._online.build();return{_offline:y==null?void 0:y._offline.build(v),_online:v}})(i._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vv{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new oe(H.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new kt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tr{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new oe(H.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new oe(H.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Ce(this._lat,e._lat)||Ce(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:tr._jsonSchemaVersion}}static fromJSON(e){if(Ga(e,tr._jsonSchema))return new tr(e.latitude,e.longitude)}}tr._jsonSchemaVersion="firestore/geoPoint/1.0",tr._jsonSchema={type:dt("string",tr._jsonSchemaVersion),latitude:dt("number"),longitude:dt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zR=/^__.*__$/;class BR{constructor(e,t,s){this.data=e,this.fieldMask=t,this.fieldTransforms=s}toMutation(e,t){return this.fieldMask!==null?new ds(e,this.data,this.fieldMask,t,this.fieldTransforms):new Ka(e,this.data,t,this.fieldTransforms)}}function wv(i){switch(i){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw pe(40011,{dataSource:i})}}class gf{constructor(e,t,s,o,u,h){this.settings=e,this.databaseId=t,this.serializer=s,this.ignoreUndefinedProperties=o,u===void 0&&this.Ac(),this.fieldTransforms=u||[],this.fieldMask=h||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new gf({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),s=this.i({path:t,arrayElement:!1});return s.mc(e),s}fc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),s=this.i({path:t,arrayElement:!1});return s.Ac(),s}gc(e){return this.i({path:void 0,arrayElement:!0})}yc(e){return Ju(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.mc(this.path.get(e))}mc(e){if(e.length===0)throw this.yc("Document fields must not be empty");if(wv(this.dataSource)&&zR.test(e))throw this.yc('Document fields cannot begin and end with "__"')}}class $R{constructor(e,t,s){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=s||hc(e)}I(e,t,s,o=!1){return new gf({dataSource:e,methodName:t,targetDoc:s,path:kt.emptyPath(),arrayElement:!1,hasConverter:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function HR(i){const e=i._freezeSettings(),t=hc(i._databaseId);return new $R(i._databaseId,!!e.ignoreUndefinedProperties,t)}function qR(i,e,t,s,o,u={}){const h=i.I(u.merge||u.mergeFields?2:0,e,t,o);Av("Data must be an object, but it was:",h,s);const m=Iv(s,h);let y,v;if(u.merge)y=new Pn(h.fieldMask),v=h.fieldTransforms;else if(u.mergeFields){const w=[];for(const R of u.mergeFields){const M=yf(e,R,t);if(!h.contains(M))throw new oe(H.INVALID_ARGUMENT,`Field '${M}' is specified in your field mask but missing from your input data.`);KR(w,M)||w.push(M)}y=new Pn(w),v=h.fieldTransforms.filter((R=>y.covers(R.field)))}else y=null,v=h.fieldTransforms;return new BR(new mn(m),y,v)}function Tv(i,e){if(Sv(i=Yt(i)))return Av("Unsupported field value:",e,i),Iv(i,e);if(i instanceof Ev)return(function(s,o){if(!wv(o.dataSource))throw o.yc(`${s._methodName}() can only be used with update() and set()`);if(!o.path)throw o.yc(`${s._methodName}() is not currently supported inside arrays`);const u=s._toFieldTransform(o);u&&o.fieldTransforms.push(u)})(i,e),null;if(i===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),i instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.yc("Nested arrays are not supported");return(function(s,o){const u=[];let h=0;for(const m of s){let y=Tv(m,o.gc(h));y==null&&(y={nullValue:"NULL_VALUE"}),u.push(y),h++}return{arrayValue:{values:u}}})(i,e)}return(function(s,o){if((s=Yt(s))===null)return{nullValue:"NULL_VALUE"};if(typeof s=="number")return kS(o.serializer,s);if(typeof s=="boolean")return{booleanValue:s};if(typeof s=="string")return{stringValue:s};if(s instanceof Date){const u=Qe.fromDate(s);return{timestampValue:Wu(o.serializer,u)}}if(s instanceof Qe){const u=new Qe(s.seconds,1e3*Math.floor(s.nanoseconds/1e3));return{timestampValue:Wu(o.serializer,u)}}if(s instanceof tr)return{geoPointValue:{latitude:s.latitude,longitude:s.longitude}};if(s instanceof gn)return{bytesValue:b_(o.serializer,s._byteString)};if(s instanceof gt){const u=o.databaseId,h=s.firestore._databaseId;if(!h.isEqual(u))throw o.yc(`Document reference is for database ${h.projectId}/${h.database} but should be for database ${u.projectId}/${u.database}`);return{referenceValue:ef(s.firestore._databaseId||o.databaseId,s._key.path)}}if(s instanceof xn)return(function(h,m){const y=h instanceof xn?h.toArray():h;return{mapValue:{fields:{[f_]:{stringValue:p_},[zu]:{arrayValue:{values:y.map((w=>{if(typeof w!="number")throw m.yc("VectorValues must only contain numeric values.");return Yd(m.serializer,w)}))}}}}}})(s,o);if(H_(s))return s._toProto(o.serializer);throw o.yc(`Unsupported field value: ${$d(s)}`)})(i,e)}function Iv(i,e){const t={};return a_(i)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):cs(i,((s,o)=>{const u=Tv(o,e.dc(s));u!=null&&(t[s]=u)})),{mapValue:{fields:t}}}function Sv(i){return!(typeof i!="object"||i===null||i instanceof Array||i instanceof Date||i instanceof Qe||i instanceof tr||i instanceof gn||i instanceof gt||i instanceof Ev||i instanceof xn||H_(i))}function Av(i,e,t){if(!Sv(t)||!s_(t)){const s=$d(t);throw s==="an object"?e.yc(i+" a custom object"):e.yc(i+" "+s)}}function yf(i,e,t){if((e=Yt(e))instanceof vv)return e._internalPath;if(typeof e=="string")return GR(i,e);throw Ju("Field path arguments must be of type string or ",i,!1,void 0,t)}const WR=new RegExp("[~\\*/\\[\\]]");function GR(i,e,t){if(e.search(WR)>=0)throw Ju(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,i,!1,void 0,t);try{return new vv(...e.split("."))._internalPath}catch{throw Ju(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,i,!1,void 0,t)}}function Ju(i,e,t,s,o){const u=s&&!s.isEmpty(),h=o!==void 0;let m=`Function ${e}() called with invalid data`;t&&(m+=" (via `toFirestore()`)"),m+=". ";let y="";return(u||h)&&(y+=" (found",u&&(y+=` in field ${s}`),h&&(y+=` in document ${o}`),y+=")"),new oe(H.INVALID_ARGUMENT,m+i+y)}function KR(i,e){return i.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rv extends QR{constructor(e){super(),this.firestore=e}convertBytes(e){return new gn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new gt(this.firestore,null,t)}}const ny="@firebase/firestore",ry="4.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function e1(i){i=vi(i,gt);const e=vi(i.firestore,Xa),t=mf(e);return DR(t,i._key).then((s=>r1(e,i,s)))}function t1(i){i=vi(i,mc);const e=vi(i.firestore,Xa),t=mf(e),s=new Rv(e);return JR(i._query),VR(t,i._query).then((o=>new ho(e,s,i,o)))}function kv(i,e,t){i=vi(i,gt);const s=vi(i.firestore,Xa),o=XR(i.converter,e,t),u=HR(s);return Pv(s,[qR(u,"setDoc",i._key,o,i.converter!==null,t).toMutation(i._key,Zn.none())])}function n1(i){return Pv(vi(i.firestore,Xa),[new Jd(i._key,Zn.none())])}function Pv(i,e){const t=mf(i);return OR(t,e)}function r1(i,e,t){const s=t.docs.get(e._key),o=new Rv(i);return new rs(i,o,e._key,s,new Aa(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){OI(Eo),fo(new ss("firestore",((s,{instanceIdentifier:o,options:u})=>{const h=s.getProvider("app").getImmediate(),m=new Xa(new bI(s.getProvider("auth-internal")),new jI(h,s.getProvider("app-check-internal")),rS(h,o),h);return u={useFetchStreams:t,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),gi(ny,ry,e),gi(ny,ry,"esm2020")})();var i1="firebase",s1="12.12.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gi(i1,s1,"app");const o1={apiKey:"AIzaSyBN-jgFWi10Onb0atB7ty24IhfRSMMxulU",authDomain:"lista-de-compras-pwa-64fac.firebaseapp.com",projectId:"lista-de-compras-pwa-64fac",storageBucket:"lista-de-compras-pwa-64fac.appspot.com",messagingSenderId:"922020197463",appId:"1:922020197463:web:41e9aa3c04bf76c7941f12"},Nv=py(o1),xa=DI(Nv);vT(xa,jy);const xv=new Ir;xv.setCustomParameters({prompt:"select_account"});const ja=UR(Nv);function Dv(){const[i,e]=Ye.useState(null),[t,s]=Ye.useState(!0),o=async m=>{if(m)try{await kv(Yu(ja,"users",m.uid),{nome:m.displayName||"Usuário",email:m.email||"",foto:m.photoURL||"",ultimoLogin:new Date().toISOString()},{merge:!0})}catch(y){console.error("Erro ao salvar usuário:",y)}};return Ye.useEffect(()=>{const m=TT(xa,async y=>{e(y||null),y&&await o(y),s(!1)});return()=>m()},[]),{usuario:i,loading:t,entrarComGoogle:async()=>{try{await zT(xa,xv)}catch(m){console.error("Erro login Google:",m)}},sair:async()=>{try{await by(xa)}catch(m){console.error("Erro logout:",m)}}}}function a1(i){const[e,t]=Ye.useState(null),[s,o]=Ye.useState(!0),u=i==null?void 0:i.uid;return Ye.useEffect(()=>{if(!u){t(null),o(!1);return}(async()=>{o(!0);try{const m=Yu(ja,"users",u,"lista","dados"),y=await e1(m);if(y.exists()){const v=y.data();t({modo:String(v.modo||"planejamento").toLowerCase().trim(),estabelecimento:v.estabelecimento||"",tema:v.tema||"claro",itens:(v.itens||[]).map(w=>({...w,precoUnitario:Number(w.precoUnitario||0),quantidade:Number(w.quantidade||1)}))})}else t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]})}catch(m){console.error(m),t({modo:"planejamento",estabelecimento:"",tema:"claro",itens:[]})}finally{o(!1)}})()},[u]),Ye.useEffect(()=>{if(!u||!e||s)return;const h=setTimeout(async()=>{try{const m=Yu(ja,"users",u,"lista","dados");await kv(m,{modo:e.modo,estabelecimento:e.estabelecimento,itens:e.itens,tema:e.tema||"claro"})}catch(m){console.error(m)}},300);return()=>clearTimeout(h)},[e,u,s]),{lista:e,setLista:t,loading:s}}function l1(i){const[e,t]=Ye.useState([]),[s,o]=Ye.useState(!0);return Ye.useEffect(()=>{if(!(i!=null&&i.uid))return;(async()=>{try{o(!0);const m=FR(ja,"users",i.uid,"compras"),v=(await t1(m)).docs.map(w=>({id:w.id,...w.data()}));v.sort((w,R)=>new Date(R.data)-new Date(w.data)),t(v)}catch(m){console.error("Erro histórico:",m)}finally{o(!1)}})()},[i==null?void 0:i.uid]),{historico:e,carregando:s,deletarCompra:async h=>{try{await n1(Yu(ja,"users",i.uid,"compras",h)),t(m=>m.filter(y=>y.id!==h))}catch(m){console.error("Erro ao deletar compra:",m)}}}}/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u1=i=>i.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),c1=i=>i.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,s)=>s?s.toUpperCase():t.toLowerCase()),iy=i=>{const e=c1(i);return e.charAt(0).toUpperCase()+e.slice(1)},Vv=(...i)=>i.filter((e,t,s)=>!!e&&e.trim()!==""&&s.indexOf(e)===t).join(" ").trim(),h1=i=>{for(const e in i)if(e.startsWith("aria-")||e==="role"||e==="title")return!0};/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f1=Ye.forwardRef(({color:i="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:s,className:o="",children:u,iconNode:h,...m},y)=>Ye.createElement("svg",{ref:y,...d1,width:e,height:e,stroke:i,strokeWidth:s?Number(t)*24/Number(e):t,className:Vv("lucide",o),...!u&&!h1(m)&&{"aria-hidden":"true"},...m},[...h.map(([v,w])=>Ye.createElement(v,w)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dr=(i,e)=>{const t=Ye.forwardRef(({className:s,...o},u)=>Ye.createElement(f1,{ref:u,iconNode:e,className:Vv(`lucide-${u1(iy(i))}`,`lucide-${i}`,s),...o}));return t.displayName=iy(i),t};/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p1=[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]],m1=Dr("circle-check-big",p1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g1=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]],y1=Dr("clock",g1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _1=[["line",{x1:"12",x2:"12",y1:"2",y2:"22",key:"7eqyqh"}],["path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6",key:"1b0p4s"}]],v1=Dr("dollar-sign",_1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E1=[["rect",{x:"3",y:"5",width:"6",height:"6",rx:"1",key:"1defrl"}],["path",{d:"m3 17 2 2 4-4",key:"1jhpwq"}],["path",{d:"M13 6h8",key:"15sg57"}],["path",{d:"M13 12h8",key:"h98zly"}],["path",{d:"M13 18h8",key:"oe0vm4"}]],w1=Dr("list-todo",E1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T1=[["path",{d:"m16 17 5-5-5-5",key:"1bji2h"}],["path",{d:"M21 12H9",key:"dn1m92"}],["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}]],I1=Dr("log-out",T1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S1=[["path",{d:"M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z",key:"1a0edw"}],["path",{d:"M12 22V12",key:"d0xqtd"}],["polyline",{points:"3.29 7 12 12 20.71 7",key:"ousv84"}],["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}]],A1=Dr("package",S1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R1=[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]],Ov=Dr("shopping-cart",R1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C1=[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]],gc=Dr("trash-2",C1);/**
 * @license lucide-react v0.514.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k1=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],P1=Dr("user",k1);function N1({estabelecimento:i,aoDefinirEstabelecimento:e,aoLimpar:t,usuario:s,aoLogout:o,tema:u,aoDefinirTema:h}){const m=u||"claro";return U.jsx("header",{className:"w-full bg-emerald-600 text-white shadow-lg",children:U.jsx("div",{className:"w-full px-4 pt-6 pb-6",children:U.jsxs("div",{className:"mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",children:[U.jsxs("div",{className:"flex items-center gap-3",children:[U.jsx("div",{className:"rounded-2xl bg-emerald-700 p-3 shadow-md",children:U.jsx(Ov,{className:"text-white",size:30})}),U.jsxs("div",{children:[U.jsx("h1",{className:"text-2xl sm:text-3xl font-bold leading-tight",children:"Lista de Compras"}),U.jsx("p",{className:"text-xs sm:text-sm text-emerald-100",children:"Organize suas compras"})]})]}),U.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-3 sm:ml-auto",children:[U.jsx("button",{onClick:()=>{const y=m==="escuro"?"claro":"escuro";h==null||h(y)},className:"rounded-xl bg-emerald-700 p-3 transition hover:bg-emerald-800",title:"Tema",children:m==="escuro"?"☀️":"🌙"}),U.jsx("div",{className:"flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-white bg-emerald-700 shadow",children:s!=null&&s.photoURL?U.jsx("img",{src:s.photoURL,alt:"Usuário",className:"h-full w-full object-cover",referrerPolicy:"no-referrer"}):U.jsx(P1,{size:20})}),U.jsx("button",{onClick:o,className:"rounded-xl bg-emerald-700 p-3 transition hover:bg-emerald-800",title:"Sair",children:U.jsx(I1,{size:20})}),U.jsx("button",{onClick:t,className:"rounded-xl bg-emerald-700 p-3 transition hover:bg-emerald-800",title:"Limpar lista",children:U.jsx(gc,{size:20})})]})]})})})}function x1({modo:i,aoAlternar:e}){return U.jsx("div",{className:"bg-white rounded-xl shadow-md p-2 mb-4",children:U.jsxs("div",{className:"flex gap-2",children:[U.jsxs("button",{onClick:()=>e("planejamento"),className:`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${i==="planejamento"?"bg-emerald-500 text-white shadow-md":"bg-gray-100 text-gray-600 hover:bg-gray-200"}`,children:[U.jsx(w1,{size:20})," ",U.jsx("span",{children:"Planejamento"})," "]}),U.jsxs("button",{onClick:()=>e("feira"),className:`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${i==="feira"?"bg-emerald-500 text-white shadow-md":"bg-gray-100 text-gray-600 hover:bg-gray-200"}`,children:[U.jsx(Ov,{size:20})," ",U.jsx("span",{children:"Na Feira"})," "]})]})})}function D1({aoAdicionar:i}){const[e,t]=Ye.useState(""),[s,o]=Ye.useState(1);function u(h){h.preventDefault();const m=e.trim().slice(0,80),y=Math.max(1,Math.min(999,Number(s)||1));m&&(i({nome:m,quantidade:y}),t(""),o(1))}return U.jsxs("form",{onSubmit:u,className:"mb-4 flex gap-2",children:[U.jsx("input",{type:"text",maxLength:80,value:e,onChange:h=>t(h.target.value),placeholder:"Produto",className:"flex-1 rounded border p-2"}),U.jsx("input",{type:"number",min:"1",max:"999",value:s,onChange:h=>o(h.target.value),className:"w-20 rounded border p-2"}),U.jsx("button",{className:"rounded bg-green-500 px-4 text-white",children:"+"})]})}function V1({item:i,onAtualizar:e,onRemover:t,onToggleComprado:s}){const[o,u]=Ye.useState(i.quantidade||1),[h,m]=Ye.useState("");Ye.useEffect(()=>{i.quantidade!==void 0&&u(i.quantidade),i.precoUnitario!==void 0&&i.precoUnitario!==null&&m(String(Math.round(i.precoUnitario*100)))},[i.quantidade,i.precoUnitario]);const y=Y=>(Number(Y||0)/100).toLocaleString("pt-BR",{minimumFractionDigits:2}),v=Y=>{const z=Y.target.value.replace(/\D/g,"");m(z)},w=()=>{const Y=Number(h||0);e(i.id,{precoUnitario:Y/100})},R=Y=>{const z=Number(Y.target.value);u(z),e(i.id,{quantidade:z||1})},M=Number(h||0)/100,Z=(o*M).toLocaleString("pt-BR",{minimumFractionDigits:2});return U.jsx("div",{className:"rounded-lg border p-4 shadow-sm transition-all",children:U.jsxs("div",{className:"flex flex-wrap items-center gap-3 md:flex-nowrap",children:[U.jsx("input",{type:"checkbox",checked:i.comprado,onChange:()=>s(i.id),className:"h-5 w-5 accent-emerald-500"}),U.jsx("span",{className:"flex-1 font-medium",children:i.nome}),U.jsxs("div",{className:"flex items-center gap-2",children:[U.jsx("input",{type:"number",min:"1",value:o,onChange:R,className:"w-16 rounded border px-2 py-1 text-center"}),U.jsx("span",{children:"×"}),U.jsx("span",{children:"R$"}),U.jsx("input",{type:"text",inputMode:"numeric",value:h?y(h):"",onChange:v,onBlur:w,className:"w-24 rounded border px-2 py-1 text-right",placeholder:"0,00"})]}),U.jsxs("div",{className:"min-w-[110px] text-right",children:[U.jsx("span",{className:"block text-xs text-gray-500",children:"Total"}),U.jsxs("span",{className:"font-bold",children:["R$ ",Z]})]}),U.jsx("button",{onClick:()=>t(i.id),className:"text-red-500",children:U.jsx(gc,{size:18})})]})})}function O1({itens:i,modo:e,aoRemover:t,aoAtualizar:s,aoAlternarComprado:o}){return i.length?U.jsx("div",{className:"space-y-4",children:i.map(u=>U.jsx("div",{children:e==="feira"?U.jsx(V1,{item:u,onAtualizar:s,onRemover:t,onToggleComprado:o}):U.jsx("div",{className:"rounded-lg border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm",children:U.jsxs("div",{className:"flex items-center justify-between gap-3",children:[U.jsxs("div",{className:"flex flex-1 items-center gap-3",children:[U.jsxs("div",{className:"flex items-center gap-3",children:[U.jsx("input",{type:"checkbox",checked:u.comprado,onChange:()=>o(u.id),className:"h-5 w-5 accent-emerald-500"}),U.jsx("p",{className:`font-medium ${u.comprado?"text-gray-400 dark:text-gray-500 line-through":"text-gray-800 dark:text-gray-100"}`,children:u.nome})]}),U.jsxs("div",{className:"ml-6 flex items-center gap-2",children:[U.jsx("label",{className:"text-sm text-gray-500 dark:text-gray-400",children:"Quantidade:"}),U.jsx("input",{type:"number",min:"1",value:u.quantidade,onChange:h=>s(u.id,{quantidade:Number(h.target.value)||1}),className:"w-20 rounded border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-2 py-1 text-center text-gray-900 dark:text-white focus:border-emerald-500 focus:outline-none"})]})]}),U.jsx("button",{onClick:()=>t(u.id),className:"rounded-lg p-2 text-red-500 transition-colors hover:bg-red-50 dark:hover:bg-slate-700 hover:text-red-700",title:"Remover item",children:U.jsx(gc,{size:18})})]})})},u.id))}):U.jsx("div",{className:"rounded-lg bg-white dark:bg-slate-800 p-6 text-center shadow",children:U.jsx("p",{className:"text-gray-500 dark:text-gray-300",children:"Nenhum item adicionado ainda."})})}function L1(i){return Number(i||0).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function M1({totais:i,modo:e}){const{total:t=0,quantidadeItens:s=0,itensComprados:o=0}=i||{},u=s>0?o/s*100:0;return U.jsxs("div",{className:"bg-white rounded-xl shadow-md p-4 mt-4",children:[U.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-5 gap-4",children:[U.jsxs("div",{className:"bg-emerald-50 rounded-lg p-3 col-span-2 md:col-span-1",children:[U.jsxs("div",{className:"flex items-center gap-2 text-emerald-600 mb-1",children:[U.jsx(v1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Total"})]}),U.jsx("p",{className:"text-2xl font-bold text-emerald-700",children:L1(t)}),U.jsx("p",{className:"text-xs text-emerald-500 mt-1",children:"Valor total da compra"})]}),U.jsxs("div",{className:"bg-blue-50 rounded-lg p-3",children:[U.jsxs("div",{className:"flex items-center gap-2 text-blue-600 mb-1",children:[U.jsx(A1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Itens"})]}),U.jsx("p",{className:"text-2xl font-bold text-blue-700",children:s})]}),U.jsxs("div",{className:"bg-green-50 rounded-lg p-3",children:[U.jsxs("div",{className:"flex items-center gap-2 text-green-600 mb-1",children:[U.jsx(m1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Comprados"})]}),U.jsx("p",{className:"text-2xl font-bold text-green-700",children:o})]}),U.jsxs("div",{className:"bg-orange-50 rounded-lg p-3",children:[U.jsxs("div",{className:"flex items-center gap-2 text-orange-600 mb-1",children:[U.jsx(y1,{size:18}),U.jsx("span",{className:"text-sm font-medium",children:"Restantes"})]}),U.jsx("p",{className:"text-2xl font-bold text-orange-700",children:s-o})]})]}),s>0&&U.jsxs("div",{className:"mt-4",children:[U.jsxs("div",{className:"flex justify-between text-sm text-gray-600 mb-2",children:[U.jsx("span",{children:"Progresso"}),U.jsxs("span",{children:[Math.round(u),"%"]})]}),U.jsx("div",{className:"w-full bg-gray-200 rounded-full h-3",children:U.jsx("div",{className:"bg-emerald-500 h-3 rounded-full transition-all duration-500",style:{width:`${u}%`}})}),U.jsxs("p",{className:"text-xs text-gray-500 mt-2 text-center",children:[o," de ",s," itens"]})]})]})}function b1(){const{usuario:i,entrarComGoogle:e,sair:t}=Dv();return i?U.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-500 to-green-700 p-4",children:U.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm text-center",children:[U.jsx("img",{src:i.photoURL,alt:"Usuário",className:"w-20 h-20 rounded-full mx-auto border-4 border-emerald-500"}),U.jsx("h2",{className:"mt-4 text-lg font-bold text-gray-800",children:i.displayName}),U.jsx("p",{className:"text-sm text-gray-500",children:"Bem-vindo de volta 👋"}),U.jsx("button",{onClick:t,className:"mt-6 w-full bg-red-500 hover:bg-red-600 text-white py-2 rounded-xl transition",children:"Sair"})]})}):U.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-500 to-green-700 p-4",children:U.jsxs("div",{className:"bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm text-center",children:[U.jsx("div",{className:"text-5xl mb-4",children:"🛒"}),U.jsx("h1",{className:"text-2xl font-bold text-gray-800",children:"Lista de Compras"}),U.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Organize suas compras com facilidade"}),U.jsxs("button",{onClick:e,className:"mt-6 w-full flex items-center justify-center gap-2 bg-white border hover:bg-gray-50 text-gray-700 font-medium py-2 rounded-xl shadow transition",children:[U.jsx("img",{src:"https://www.svgrepo.com/show/475656/google-color.svg",className:"w-5 h-5",alt:"Google"}),"Entrar com Google"]})]})})}function F1({historico:i,carregando:e,deletarCompra:t}){const[s,o]=Ye.useState(null);return e?U.jsx("div",{className:"mt-6 text-center text-gray-600 dark:text-gray-300",children:"Carregando histórico..."}):i!=null&&i.length?U.jsx("div",{className:"mt-6 space-y-4",children:i.map(u=>{var m;const h=Number(u.total||0);return U.jsxs("div",{className:"rounded-xl bg-white dark:bg-slate-800 p-4 shadow",children:[U.jsxs("div",{className:"flex items-start justify-between",children:[U.jsxs("div",{className:"flex-1 cursor-pointer",onClick:()=>o(s===u.id?null:u.id),children:[U.jsx("h3",{className:"font-bold text-gray-900 dark:text-white",children:u.estabelecimento}),U.jsx("p",{className:"text-sm text-gray-500 dark:text-gray-400",children:new Date(u.data).toLocaleDateString("pt-BR")}),U.jsxs("p",{className:"font-bold text-green-600 dark:text-green-400",children:["R$ ",h.toFixed(2)]}),U.jsx("p",{className:"mt-1 text-xs text-gray-400 dark:text-gray-500",children:"Clique para ver os detalhes"})]}),U.jsx("button",{onClick:()=>t(u.id),className:"text-red-500 hover:text-red-700",children:U.jsx(gc,{size:18})})]}),s===u.id&&U.jsxs("div",{className:"mt-3 space-y-2 border-t border-gray-200 dark:border-slate-700 pt-3",children:[U.jsxs("div",{className:"flex justify-between text-xs text-gray-500 dark:text-gray-400",children:[U.jsx("span",{children:"Item"}),U.jsx("span",{children:"Total"})]}),(m=u.itens)==null?void 0:m.map(y=>{const v=Number(y.quantidade||0)*Number(y.precoUnitario||0);return U.jsxs("div",{className:"flex justify-between text-sm text-gray-700 dark:text-gray-200",children:[U.jsxs("span",{children:[y.quantidade,"x ",y.nome]}),U.jsxs("span",{children:["R$ ",v.toFixed(2)]})]},y.id)}),U.jsxs("div",{className:"flex justify-between border-t border-gray-200 dark:border-slate-700 pt-2 font-bold text-gray-900 dark:text-white",children:[U.jsx("span",{children:"Total"}),U.jsxs("span",{children:["R$ ",h.toFixed(2)]})]})]})]},u.id)})}):U.jsx("div",{className:"mt-6 text-center text-gray-500 dark:text-gray-400",children:"Nenhuma compra encontrada"})}function U1(){const{usuario:i,loading:e}=Dv(),{lista:t,setLista:s}=a1(i||null),{historico:o,carregando:u,deletarCompra:h}=l1(i||null),[m,y]=Ye.useState("compras"),[v,w]=Ye.useState("claro");Ye.useEffect(()=>{t!=null&&t.tema&&w(t.tema)},[t==null?void 0:t.tema]),Ye.useEffect(()=>{document.documentElement.classList.toggle("dark",v==="escuro")},[v]);const R=async()=>{await by(xa)};if(e)return U.jsx("div",{className:"flex min-h-screen items-center justify-center",children:U.jsx("p",{children:"Carregando..."})});if(!i)return U.jsx(b1,{});if(!t||!s)return U.jsx("div",{className:"flex min-h-screen items-center justify-center",children:U.jsx("p",{children:"Carregando lista..."})});const M=Array.isArray(t.itens)?t.itens:[],B=z=>{s(ae=>({...ae,itens:(ae.itens||[]).filter(fe=>fe.id!==z)}))},Z=(z,ae)=>{s(fe=>({...fe,itens:(fe.itens||[]).map(Te=>Te.id===z?{...Te,...ae}:Te)}))},Y=z=>{s(ae=>({...ae,itens:(ae.itens||[]).map(fe=>fe.id===z?{...fe,comprado:!fe.comprado}:fe)}))};return U.jsxs("div",{className:"min-h-screen bg-gray-50 dark:bg-slate-900",children:[U.jsx(N1,{usuario:i,estabelecimento:t.estabelecimento||"",aoDefinirEstabelecimento:z=>s(ae=>({...ae,estabelecimento:z})),aoLimpar:()=>s(z=>({...z,itens:[]})),aoLogout:R,tema:v,aoDefinirTema:z=>{w(z),s(ae=>({...ae,tema:z}))}}),U.jsxs("main",{className:"mx-auto max-w-4xl space-y-6 px-4 py-6",children:[U.jsxs("div",{className:"flex gap-2",children:[U.jsx("button",{onClick:()=>y("compras"),className:`flex-1 rounded-lg p-3 font-semibold ${m==="compras"?"bg-emerald-600 text-white":"bg-white text-gray-700 dark:bg-slate-800 dark:text-white"}`,children:"Compras"}),U.jsx("button",{onClick:()=>y("historico"),className:`flex-1 rounded-lg p-3 font-semibold ${m==="historico"?"bg-emerald-600 text-white":"bg-white text-gray-700 dark:bg-slate-800 dark:text-white"}`,children:"Histórico"})]}),m==="compras"&&U.jsxs(U.Fragment,{children:[U.jsx(x1,{modo:t.modo,aoAlternar:z=>s(ae=>({...ae,modo:z}))}),U.jsx(D1,{aoAdicionar:z=>s(ae=>({...ae,itens:[...ae.itens||[],{id:crypto.randomUUID(),nome:z.nome||"",quantidade:Number(z.quantidade||1),precoUnitario:0,comprado:!1}]}))}),U.jsx(O1,{itens:M,modo:t.modo,aoRemover:B,aoAtualizar:Z,aoAlternarComprado:Y}),U.jsx(M1,{totais:{total:M.reduce((z,ae)=>z+(ae.quantidade||0)*(ae.precoUnitario||0),0),quantidadeItens:M.length,itensComprados:M.filter(z=>z.comprado).length}})]}),m==="historico"&&U.jsx(F1,{historico:o,carregando:u,deletarCompra:h})]})]})}const Lv=document.getElementById("root");if(!Lv)throw new Error("Elemento #root não encontrado no index.html");const j1=XE.createRoot(Lv);j1.render(U.jsx(U1,{}));
